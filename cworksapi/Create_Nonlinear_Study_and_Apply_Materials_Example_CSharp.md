...
// 3. Applies user-defined material to the first assembly
component

//    and
SOLIDWORKS material to the remaining components.
...
            swApp.OpenDoc6("C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2019\\samples\\Simulation Examples\\Nonlinear\\nl\_pipe\_holder.sldasm", (int)swDocumentTypes\_e.swDocASSEMBLY, (int)swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", ref errors, ref warnings);
...
            Study = (CWStudy)StudyMngr.CreateNewStudy("Nonlinear", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeNonlinear, (int)swsMeshType\_e.swsMeshTypeSolid, out errCode);
