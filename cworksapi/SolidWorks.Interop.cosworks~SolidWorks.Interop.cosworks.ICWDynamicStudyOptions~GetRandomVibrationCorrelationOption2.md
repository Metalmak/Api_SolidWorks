...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWDynamicStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions.html) : GetRandomVibrationCorrelationOption2 Method (ICWDynamicStudyOptions) |
...
*NCorrelation*
:   Correlation type as defined in [swsRandomVibrationCorrelationOption\_e](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.swsRandomVibrationCorrelationOption_e.html)
...
See CWDynamicStudyOptions::GetRandomVibrationCorrelationOption2.
