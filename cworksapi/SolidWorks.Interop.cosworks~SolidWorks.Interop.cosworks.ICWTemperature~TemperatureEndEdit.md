...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWTemperature Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTemperature.html) : TemperatureEndEdit Method (ICWTemperature) |
...
Error as defined in [swsTemperatureEndEditError\_e](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.swsTemperatureEndEditError_e.html)

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See CWTemperature::TemperatureEndEdit.
...
You must call [ICWTemperature::TemperatureBeginEdit](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.ICWTemperature~TemperatureBeginEdit.html) to start editing the temperature. To end editing the temperature, you must call this method. Changes are not applied unless you call both methods.
