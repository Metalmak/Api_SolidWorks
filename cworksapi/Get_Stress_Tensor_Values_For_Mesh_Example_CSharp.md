...
namespace GetStressTensorValues\_CSharp.csproj
{
...
            Stress = (object[])CWResult.**GetStressTensorValuesForAllNodesOfElement**(10, (int)swsStrengthUnit\_e.swsStrengthUnitPascal, 1, out errCode);
            if (errCode != 0)
            {
                ErrorMsg(swApp, "Error getting stress tensor values as defined in swsNodalResultsOfElementError\_e: " + errCode);
            }
            else
            {
