...
' 4. Open *public\_documents***\samples\Simulation Examples\actuator.sldasm**.
' 5. Click the **Ready** study tab.
' 6. In the Simulation Study tree, expand the Parts folder and multi-select
'    **actuator\_casing-1** and **actuator\_piston-1**.
'
' Postconditions:
...
   ' Apply a SOLIDWORKS material to selected
components
   returnValue = SolidMgr.**SetLibraryMaterialToSelectedEntities**("solidworks
