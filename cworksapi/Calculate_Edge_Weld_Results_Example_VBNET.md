...
' 4. Runs the analysis.
' 5. Gets the
edge weld results for **Edge Weld Connector-1**.
...
        Study.**ActivateConfiguration** StudyMngr.**ActiveStudy** = 0
...
        EdgeResult = CWFeatObj.**GetEdgeWeldResults**(ConnectorName, swsUnit\_e.swsUnitSI, PassFail, errCode)
