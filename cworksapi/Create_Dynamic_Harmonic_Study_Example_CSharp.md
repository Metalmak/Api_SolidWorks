...
namespace CreateDynHarmStudy\_CSharp.csproj
{
...
            //Open document
            Part = swApp.**OpenDoc6**("C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2018\\samples\\tutorial\\api\\lineardynamic.SLDPRT", (int)swDocumentTypes\_e.swDocPART, (int) swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", ref longstatus, ref longwarnings);
            if (Part == null)
...
            sStudyName = "Dynamic\_Harmonic";
            Study = StudyMngr.**CreateNewStudy3**(sStudyName, (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeDynamic, (int)swsDynamicAnalysisSubType\_e.swsDynamicAnalysisSubTypeHarmonic, out errCode);
...
// automatic
            errCode = DynStudyOptions.**SetUseSoftSpring3**(0);
...
            boolstatus
= ResultOptions.**S****etSaveStressAndReactionsOptions2**(-1,
0);
...
            CWBaseExcitationU = LBCMgr.**AddUniformBaseExcitation2**((int)swsBaseExcitationType\_e.swsBaseExcitationType\_Acceleration, CWBaseExcitationEntity, (int)swsAccelerationUnit\_e.swsAccelerationUnit\_InchesPerSquareSec, -1, 2.3, -1, 3.4, -1, 4.5, out errCode);
            if (errCode != 0)
...
            Debug.Print(" Units as defined in swsAccelerationUnit\_e: " + CWBaseExcitationU.**Unit**);
...
            Debug.Print("     Units as defined in swsPhaseAngleUnit\_e: " + CWBaseExcitationU.**PhaseAngleUnit**);
...
            Debug.Print("  Units in swsUnitSystem\_e units: " + CWDistribMass.**Units**);
            Debug.Print("");
...
defined in swsRunAnalysisError\_e:" + errCode);
...
            forces2 = (object[])CWFeatObj5.**GetReactionForcesAndMomentsWithSelections**(59, null, (int)swsForceUnit\_e.swsForceUnitNOrNm, (DispArray1), out selectedAndModelReactionFM, out selectedOnlyReactionFM, out errCode);
...
            Debug.Print("  {xcoord\_force, ycoord\_force, zcoord\_force, resultant\_force, ");
            Debug.Print("   xcoord\_moment, ycoord\_moment, zcoord\_moment, resultant\_moment}:");
