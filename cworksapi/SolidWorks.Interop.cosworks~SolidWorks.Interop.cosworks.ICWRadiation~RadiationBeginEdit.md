...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWRadiation Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWRadiation.html) : RadiationBeginEdit Method (ICWRadiation) |
...
See CWRadiation::RadiationBeginEdit.
...
To start editing radiation, you must call this method. You must call [ICWRadiation::RadiationEndEdit](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.ICWRadiation~RadiationEndEdit.html) to end editing radiation. Changes are not applied unless you call both methods.
