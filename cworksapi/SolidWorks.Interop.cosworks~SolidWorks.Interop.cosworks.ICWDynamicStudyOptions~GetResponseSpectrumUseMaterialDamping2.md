...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWDynamicStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions.html) : GetResponseSpectrumUseMaterialDamping2 Method (ICWDynamicStudyOptions) |
...
Obsolete. Superseded by [ICWDynamicStudyOptions::GetResponseSpectrumUseMaterialDamping3](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~GetResponseSpectrumUseMaterialDamping3.html).
...
See CWDynamicStudyOptions::GetResponseSpectrumUseMaterialDamping2.
