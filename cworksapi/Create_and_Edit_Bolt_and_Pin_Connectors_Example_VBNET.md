...
        Dim
CWBolt As CWBoltConnector

        Dim
CWPin As CWPinConnector
...
        Dim
pDisp1 As Object = Nothing

        Dim
pDisp2 As Object = Nothing
...
        Dim
DispArray1 As Object() = {pDisp1}

        Dim
DispArray2 As Object() = {pDisp2}
...
        CWBolt
= LBCMgr.AddBoltConnector(swsBoltType\_e.swsBoltTypeStandardOrCounterboreNut,
...
        CWPin
= LBCMgr.GetLoadsAndRestraints(0,
errCode)

        'Edit
Pin Connector-1 connection
