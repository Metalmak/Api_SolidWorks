...
namespace AddCentrifugalForce\_CSharp.csproj
{
...
            Study = StudyMngr.**CreateNewStudy3**("Static1", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeStatic, 0, out errCode);
            if (Study == null)
...
            restraint = LBCMgr.**AddRestraint**((int)swsRestraintType\_e.swsRestraintTypeFixed, (DispArray3), null, out errCode);
            if (errCode != 0)
...
            CWCentrifugalLoad.**Unit** = (int)swsUnitSystem\_e.swsUnitSystemSI;
            CWCentrifugalLoad.**CFForceEndEdit**();

Debug.Print("");
            Debug.Print("Centrifugal force:");
            Debug.Print("  Units as defined in swsUnitSystem\_e: " + CWCentrifugalLoad.**Unit**);
...
            if (errCode != 0)
                ErrorMsg(swApp, "Analysis failed with error as defined in swsRunAnalysisError\_e: " + errCode);
...
            CWPlot = CWResult.**CreatePlot**((int)swsPlotResultTypes\_e.swsResultStress, (int)swsStaticResultNodalStressComponentTypes\_e.swsStaticNodalStress\_VON, (int)swsUnit\_e.swsUnitSI, false, out errCode);
            if (errCode != 0)
