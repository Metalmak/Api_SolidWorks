...
' 3. Copy *public\_documents***\samples\tutorial\api\tjoint.sldprt** to another name
and replace
'    *file\_name* in the code with the new name.
...
As Double = 1.4769 'mm
    Const MeshTol
As Double = 0.073847 'mm

    Set SwApp = Application.SldWorks
    If SwApp Is Nothing Then Exit Sub

    fileName = "C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2018\samples\tutorial\api\*file\_name*.sldprt"
    Set Part = SwApp.**OpenDoc6**(fileName, swDocPART, 1, "", errors,
warnings)
...
    'Set baseline of Trend Tracker to current
results
