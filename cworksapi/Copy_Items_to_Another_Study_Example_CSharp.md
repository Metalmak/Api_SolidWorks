...
namespace CopyItems\_CSharp.csproj
{
...
            const string fileName = "C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2017\\Simulation Examples\\Contact\\slider\_locker\_mechanism.sldasm";
...
            swApp.**OpenDoc6**(fileName, (int)swDocumentTypes\_e.swDocASSEMBLY, (int)swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", ref errors, ref warnings);
...
            // Create mesh
            errCode = Study.**CreateMesh**((int)swsLinearUnit\_e.swsLinearUnitMillimeters, 20, 1);
