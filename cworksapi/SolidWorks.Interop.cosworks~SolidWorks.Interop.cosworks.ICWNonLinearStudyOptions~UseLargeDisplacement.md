...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWNonLinearStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWNonLinearStudyOptions.html) : UseLargeDisplacement Property (ICWNonLinearStudyOptions) |
...
Obsolete. Superseded by [ICWNonLinearStudyOptions::UseLargeDisplacement2](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWNonLinearStudyOptions~UseLargeDisplacement2.html).
...
See CWNonLinearStudyOptions::UseLargeDisplacement.
