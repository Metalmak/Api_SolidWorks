...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWResults Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWResults.html) : GetStressForEntities3 Method (ICWResults) |
...
*NPlyNumber*
:   Ply number to show the stress; available only when the model uses composite shells
...
See CWResults::GetStressForEntities3.
