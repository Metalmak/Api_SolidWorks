...
namespace AddGravityLoad\_CSharp.csproj
{
...
            Debug.Print("     Reverse? (true=yes, false=no) " + Gravity.**ReverseDirectionAlongPlaneDir1\_2**);
            Debug.Print("  Direction 2: " + yval);
            Debug.Print("     Reverse? (true=yes, false=no) " + Gravity.**ReverseDirectionAlongPlaneDir2\_2**);
            Debug.Print("  Normal direction: " + zval);
            Debug.Print("     Reverse? (true=yes, false=no) " + Gravity.**ReverseDirectionNormalToPlane2**);
            Debug.Print("  Units as defined in swsUnitSystem\_e: " + Gravity.**Unit**);
