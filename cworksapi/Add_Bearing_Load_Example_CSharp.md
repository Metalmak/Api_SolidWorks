...
namespace AddBearingLoad\_CSharp.csproj
{
...
            Debug.Print("  Unit system as defined in swsUnit\_e: " + CWBearingLoad.**BearingLoadUnit**);
            Debug.Print("  Distribution type as
defined in swsBearingLoadDistributionType\_e: " + CWBearingLoad.**DistributionType**);
...
            Debug.Print( "          Temperature source as defined in swsThermalOption\_e: " + StaticOptions.**ThermalResults**);
