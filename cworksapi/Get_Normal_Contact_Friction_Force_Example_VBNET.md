...
"156,234,147,174,100,22,171,108,78,58,87,35,53,30,206,187,131,94,166,173,168,82,22,133,162,208,55,31,117,43,208,127,4,44,198,219,200,40,210,179,189,24,88,197,164,43,255,49,126,106,13,203,158,99,136,246,11,23,144,126,96,0,0,0,0,0,0,0,0"
        selection1 = selection1 &
",Type=1"
        'Store
...
        sModelName =
"beam\_boltconnection.sldasm"        'Model
name
...
        Part = swApp.**OpenDoc6**("public\_documents\samples\tutorial\api\beam\_boltconnection.SLDASM",
...
        Force = CWFeatObj.**GetContactForcesAndFriction**(1,
Nothing,
(DispArray1), swsNForceType\_e.swsNForceTypeNormal, 0, errCode)
        If
errCode <> 0 Then
ErrorMsg(SwApp, "Failed to get contact
force result") :
GoTo Lastline

        Debug.Print("  x, y, z, and
