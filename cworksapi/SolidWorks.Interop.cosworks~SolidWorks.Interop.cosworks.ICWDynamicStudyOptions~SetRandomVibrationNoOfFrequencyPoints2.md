<!-- source: cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~SetRandomVibrationNoOfFrequencyPoints2.html -->
...
| SetRandomVibrationNoOfFrequencyPoints2 Method (ICWDynamicStudyOptions) | |
...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWDynamicStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions.html) : SetRandomVibrationNoOfFrequencyPoints2 Method (ICWDynamicStudyOptions) |
...
Sets the number of frequency points in the random vibration dynamic study.

# ![](dotnetimages/collapse.gif).NET Syntax

| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function SetRandomVibrationNoOfFrequencyPoints2( _    ByVal NPoints As System.Integer _ ) As System.Integer ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As ICWDynamicStudyOptions Dim NPoints As System.Integer Dim value As System.Integer   value = instance.SetRandomVibrationNoOfFrequencyPoints2(NPoints) ``` | |

| C# |  |
| --- | --- |
| ``` System.int SetRandomVibrationNoOfFrequencyPoints2(     System.int NPoints ) ``` | |
...
See CWDynamicStudyOptions::SetRandomVibrationNoOfFrequencyPoints2.
