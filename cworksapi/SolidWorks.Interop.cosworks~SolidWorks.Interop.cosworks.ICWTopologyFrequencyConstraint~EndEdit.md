...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWTopologyFrequencyConstraint Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTopologyFrequencyConstraint.html) : EndEdit Method (ICWTopologyFrequencyConstraint) |
...
See CWTopologyFrequencyConstraint::EndEdit.
...
To begin editing this frequency constraint, call [ICWTopologyFrequencyConstraint::BeginEdit](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTopologyFrequencyConstraint~BeginEdit.html).
