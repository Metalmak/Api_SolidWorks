...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWRemoteLoad Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWRemoteLoad.html) : GetMomentOrRotationValues2 Method (ICWRemoteLoad) |
...
*BInclude*
:   -1 or true to get moment or rotation values, 0 or false to not (see **Remarks**)
