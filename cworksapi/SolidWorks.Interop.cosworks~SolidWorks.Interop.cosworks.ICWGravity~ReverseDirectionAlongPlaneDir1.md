...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWGravity Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWGravity.html) : ReverseDirectionAlongPlaneDir1 Property (ICWGravity) |
...
Obsolete. Superseded by [ICWGravity::ReverseDirectionAlongPlaneDir1\_2](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWGravity~ReverseDirectionAlongPlaneDir1_2.html).
...
See CWGravity::ReverseDirectionAlongPlaneDir1.
