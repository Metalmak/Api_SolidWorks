...
        Study = StudyMngr.**CreateNewStudy3**(sStudyName, swsAnalysisStudyType\_e.swsAnalysisStudyTypeDynamic, swsDynamicAnalysisSubType\_e.swsDynamicAnalysisSubTypeTransient, errCode)
...
        CWFeatObj6 = LBCMgr.**AddInitialConditionForDynamicStudy2**(swsDynamicInitialConditionType\_e.swsDynamicInitialConditionType\_Displacement, swsSelectionType\_e.swsSelectionFaceEdgeVertexPoint, (DispArray1), CWBaseExcitationEntity, swsLinearUnit\_e.swsLinearUnitMillimeters, 0, 0, 0, 0, -1, 10.0#, errCode)
...
        forces2 = CWFeatObj5.**GetReactionForcesAndMomentsWithSelections**(31, Nothing, swsForceUnit\_e.swsForceUnitNOrNm, (DispArray1), selectedAndModelReactionFM, selectedOnlyReactionFM, errCode)
