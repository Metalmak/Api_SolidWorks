...
namespace AddCyclicSymmetricRestraint\_CSharp.csproj
{
...
            Axis1 = SelectByPID(Part, "selection1", PIDCollection);
// axis of revolution
            Face1 = SelectByPID(Part, "selection2", PIDCollection);
// first face
            Face2 = SelectByPID(Part, "selection3", PIDCollection);
// second face
...
            if (errCode != 0)
                ErrorMsg(swApp, "Adding cyclic symmetry restraint failed with error as defined in swsCyclicRestraintError\_e: " + errCode);
