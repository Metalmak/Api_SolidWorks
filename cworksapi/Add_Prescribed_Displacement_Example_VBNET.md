...
        Part = swApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2019\samples\Simulation Examples\Thermal\computer\_chip.sldasm", swDocumentTypes\_e.swDocASSEMBLY, 2, "", longstatus, longwarnings)
        If Part Is Nothing Then ErrorMsg(SwApp, "Failed to open computer\_chip.sldasm")
...
        Study = StudyMngr.**CreateNewStudy3**("Static\_solid\_new", swsAnalysisStudyType\_e.swsAnalysisStudyTypeStatic, 0, errCode)
