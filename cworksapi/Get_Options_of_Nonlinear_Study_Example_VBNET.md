...
        swApp.**OpenDoc6**(docName, swDocumentTypes\_e.swDocPART, swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", errors, warnings)
...
            If (studyType = swsAnalysisStudyType\_e.swsAnalysisStudyTypeNonlinear) Then
