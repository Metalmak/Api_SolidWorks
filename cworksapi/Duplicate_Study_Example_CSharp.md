...
// 3. Open *pubic\_documents***\Simulation Examples\tutor1.sldprt.**
...
namespace DuplicateSimStudy\_CSharp.csproj
{
...
            //Duplicate study
            Study = StudyMngr.**DuplicateStudy**("Ready", "DuplicateReady", "Default", 1, out errCode);
            if (Study == null)
