...
    Dim SolidBody       As
CosmosWorksLib.CWSolidBody
    Dim ShellMgr        As
CosmosWorksLib.CWShellManager
    Dim ShellMat        As
CosmosWorksLib.CWMaterial
    Dim LBCMgr
As CosmosWorksLib.CWLoadsAndRestraintsManager
    Dim CWContactMgr    As
CosmosWorksLib.CWContactManager
    Dim CWFeatObj       As
CosmosWorksLib.CWResults
...
    Set Study = StudyMngr.**CreateNewStudy3**("Static\_Mixed6",
...
swsRemoteLoadType\_e: " & CWRemoteLoad.**LoadType**
    Debug.Print "Force unit as defined in swsForceUnit\_e: " &
CWRemoteLoad.**ForceOrTranslationUnit**
    Debug.Print "Location unit as defined in swsLinearUnit\_e: " &
CWRemoteLoad.**LocationUnit**
    Debug.Print "Moment unit as defined in swsMomentUnit\_e: " &
...
    CWRemoteLoad.**GetLocationValues**
...
    CWRemoteLoad.**GetMomentOrRotationValues2**
...
with error as defined in swsRunAnalysisError\_e: " & errCode
