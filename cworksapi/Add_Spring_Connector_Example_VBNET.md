...
        Part = swApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2019\samples\Simulation Examples\Verification\frequency\_8.sldasm", swDocumentTypes\_e.swDocASSEMBLY, swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", longstatus, longwarnings)
...
        If StudyMngr Is Nothing Then ErrorMsg(swApp, "Failed to get the
...
        springConnector = lrMngr.**AddSpringConnector**(swsSpringConnectorType\_e.swsSpringConnectoryTypeFlatParallelFaces, (varArray1), (varArray2), errCode)

        springConnector.**SpringConnectorBeginEdit**()
        springConnector.**Unit** = swsUnit\_e.swsUnitEnglish
