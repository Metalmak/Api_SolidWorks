...
namespace
GetConnectorForces\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            iSolverType = (int)swsSolverType\_e.swsSolverTypeDirectSparse;
            //Solver type
...
VerifyLong(swApp, (int)swsMeshState\_e.swsMeshStateExistsAndCurrent, CWMesh.**MeshState**,
"Mesh is not
