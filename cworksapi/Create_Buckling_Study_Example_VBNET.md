...
        Study = StudyMngr.**CreateNewStudy3**("Buckling1", swsAnalysisStudyType\_e.swsAnalysisStudyTypeBuckling, 0, errCode)
...
        restraint = LBCMgr.**AddRestraint**(swsRestraintType\_e.swsRestraintTypeFixed, (DispArray2), Nothing, errCode)
        If errCode <> 0 Then ErrorMsg(SwApp, "Failed to add a restraint")

        'Add a pressure load
        CWPressureLoad = LBCMgr.**AddPressure**(swsPressureType\_e.swsPressureTypeNormal, (DispArray3), Nothing, errCode)
