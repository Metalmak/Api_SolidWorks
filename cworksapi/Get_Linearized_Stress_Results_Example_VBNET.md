...
'
' Postconditions:
'  1. Gets the following stress values linearized
along Stress Classification Lines
...
Dim ReferenceGeometryDispatchObj2
As
Feature
...
values = CWPlot.**GetLinearizedStressValuesAlongSCL**(5, 0.29224, -1.08E-19,
