...
//    use **[pidcollector.exe](GettingStarted-swsimulationapi.html)** or IModelDocExtension::GetPersistReference3.
...
namespace GetThermalValues\_CSharp.csproj
{
...
            Temp = (object[])CWResult.**GetThermalValuesAtPoints**((int)swsThermalComponent\_e.swsThermalComponentTEMP, nStep, null, (varArray7), (int)swsTemperatureUnit\_e.swsTemperatureUnitKelvin, out errCode);
...
            // Get heat energy values for the specified vertex
at solution step 60
