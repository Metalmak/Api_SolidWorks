...
//  5. Edits
simultaneously both component contacts.
...
namespace EditMultipleCompContacts\_CSharp.csproj
{
...
            Debug.Print("");
            errCode = multCCEM.**SetContactType**((int)swsContactType\_e.swsContactTypeFreeOrInsulated);
