...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLinkageRod Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLinkageRod.html) : SetJointTypeAtEnd2 Method (ICWLinkageRod) |
...
See CWLinkageRod::SetJointTypeAtEnd2.
...
If End 2 is a vertex, then you cannot set NJointType with swsJointType\_e.swsPivot.
