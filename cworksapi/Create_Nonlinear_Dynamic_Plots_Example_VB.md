...
    Set CWCFf = CWResult.**CreatePlot**(swsResultDisplacementOrAmplitude, swsStaticDisplacement\_URES, swsUnitSI, False, errCode)
...
    'Create stress plot
    Set CWCFf = CWResult.**CreatePlot**(swsResultStress, swsStaticNodalStress\_VON, swsUnitSI, False, errCode)
...
    Set CWCFf = CWResult.**CreatePlot**(swsResultStrain, swsStaticElementalStrain\_ESTRN, swsUnitSI, True, errCode)
    If errCode <> 0 Then ErrorMsg SwApp, "Failure to create
plot"
