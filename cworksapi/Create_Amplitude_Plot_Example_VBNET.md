...
        CWCFf = CWResult.**CreatePlot**(swsPlotResultTypes\_e.swsResultDisplacementOrAmplitude, swsFrequencyBucklingResultDisplacementComponentTypes\_e.swsFrequencyBucklingDisplacement\_URES, swsUnit\_e.swsUnitSI, False, errCode)
