...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWTopologyDemoldControl Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTopologyDemoldControl.html) : SetReverseDirection Method (ICWTopologyDemoldControl) |
...
Obsolete. Superseded by [ICWTopologyDemoldControl::SetReverseDirection2](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTopologyDemoldControl~SetReverseDirection2.html).
...
See CWTopologyDemoldControl::SetReverseDirection.
