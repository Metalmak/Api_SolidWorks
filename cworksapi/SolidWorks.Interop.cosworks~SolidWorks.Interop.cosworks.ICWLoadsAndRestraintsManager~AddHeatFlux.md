...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLoadsAndRestraintsManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraintsManager.html) : AddHeatFlux Method (ICWLoadsAndRestraintsManager) |
...
*ErrorCode*
:   Error as defined in [swsHeatFluxError\_e](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.swsHeatFluxError_e.html)
...
See CWLoadsAndRestraintsManager::AddHeatFlux.
