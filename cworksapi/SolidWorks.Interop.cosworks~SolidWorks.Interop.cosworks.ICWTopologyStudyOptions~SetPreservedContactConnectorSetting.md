...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWTopologyStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTopologyStudyOptions.html) : SetPreservedContactConnectorSetting Method (ICWTopologyStudyOptions) |
...
*NPreservedContactConnectorSetting*
:   Preserved contacts and connectors setting as defined in [swsTopologyPreservedContactConnectorOption\_e](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.swsTopologyPreservedContactConnectorOption_e.html)
...
See CWTopologyStudyOptions::SetPreservedContactConnectorSetting.
