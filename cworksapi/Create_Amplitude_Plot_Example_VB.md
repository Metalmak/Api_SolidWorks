...
'    **Tools > Simulation > Options > Default Options >
Frequency/Buckling Study
'    Results** settings.
...
    Set CWCFf = CWResult.**CreatePlot**(swsResultDisplacementOrAmplitude, swsFrequencyBucklingDisplacement\_URES, swsUnitSI, False, errCode)
