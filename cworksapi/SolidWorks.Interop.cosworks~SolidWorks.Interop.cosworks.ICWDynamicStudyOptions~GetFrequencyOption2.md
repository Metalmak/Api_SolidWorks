...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWDynamicStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions.html) : GetFrequencyOption2 Method (ICWDynamicStudyOptions) |
...
*DValue*
:   * Number of frequencies, if NOption = swsFrequencyStudyOption\_e.swsFrequencyStudyOptionNumberFrequencies

    * Upper-bound frequency, if NOption = swsFrequencyStudyOption\_e.swsFrequencyStudyOptionUserUpperBoundFrequency
...
See CWDynamicStudyOptions::GetFrequencyOption2
