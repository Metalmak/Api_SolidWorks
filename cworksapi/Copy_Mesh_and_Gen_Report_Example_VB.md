...
' 3. Open *public\_documents***\samples\Simulation Examples\Verification\buckling2.sldprt**.
'
' Postconditions:
...
    If (n < 0.95 \* NoOfElements2) Or (n > 1.05
\* NoOfElements2) Then
...
    'Copy mesh from the first study to the second
study
...
    'Generate Report
    errCode = Study.**GenerateReport**("C:\temp",
"report", False)
