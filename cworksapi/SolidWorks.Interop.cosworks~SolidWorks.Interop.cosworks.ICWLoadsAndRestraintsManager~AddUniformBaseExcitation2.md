...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLoadsAndRestraintsManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraintsManager.html) : AddUniformBaseExcitation2 Method (ICWLoadsAndRestraintsManager) |
...
*BDir1*
:   -1 or true to add excitation along plane direction 1, 0 or false to not; valid only if DirectionEntity is a face, plane, or unspecified

*DVal1*
:   Excitation along plane direction 1; valid only if BDir1 = -1 and DirectionEntity is a face, plane, or unspecified (see **Remarks**)

*BDir2*
:   -1 or true to add excitation along plane direction 2; 0 or false to not; valid only if DirectionEntity is a face, plane, or unspecified

*DVal2*
:   Excitation along plane direction 2; valid only if BDir2 = -1 and DirectionEntity is a face, plane, or unspecified (see **Remarks**)

*BDir3*
:   -1 or true to add excitation along normal to the plane or along an edge; 0 or false to not; valid only if DirectionEntity is a face, edge plane, or unspecified
