...
namespace AddPrescribedDisp\_CSharp.csproj
{
...
            Part = swApp.**OpenDoc6**("C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2017\\Simulation Examples\\Thermal\\computer\_chip.sldasm", (int)swDocumentTypes\_e.swDocASSEMBLY, 2, "", ref longstatus, ref longwarnings);
            if (Part == null)
                ErrorMsg(swApp, "Failed to open computer\_chip.sldasm");
...
            Study = StudyMngr.**CreateNewStudy3**("Static\_solid\_new", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeStatic, 0, out errCode);
            if (Study == null)
