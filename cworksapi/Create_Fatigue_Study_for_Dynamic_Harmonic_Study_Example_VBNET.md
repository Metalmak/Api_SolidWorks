...
        Study = StudyMngr.**CreateNewStudy3**("HarmonicFatigue", swsAnalysisStudyType\_e.swsAnalysisStudyTypeFatigue, 2, errCode)
...
        FatigueEvent = FatigueOptions.**AddFatigueEventForHarmonic**("Sample\_Harmonic", 0, 15, 100000, 150000, errCode)
...
        If errCode <> 0 Then ErrorMsg(SwApp, "Failed to get minimum and maximum fatigue. Error code as defined in swsResultsError\_e: " & errCode)
