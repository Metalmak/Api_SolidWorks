...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWPlot Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWPlot.html) : ShowAvgResultsAcrossBoundaryForParts Method (ICWPlot) |
...
*BAvgResultsAcrossBoundaryForParts*
:   True to show average results at the common nodes between two components in the assembly, false to not
...
See CWPlot::ShowAvgResultsAcrossBoundaryForParts.
