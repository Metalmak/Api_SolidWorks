...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWTopologyStudyManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWTopologyStudyManager.html) : GetDisplacementConstraint Method (ICWTopologyStudyManager) |
...
*SConstraintName*
:   Name of the displacement constraint to retrieve
...
See CWTopologyStudyManager::GetDisplacementConstraint.
