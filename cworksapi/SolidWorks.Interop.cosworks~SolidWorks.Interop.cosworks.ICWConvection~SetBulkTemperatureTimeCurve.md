...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWConvection Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWConvection.html) : SetBulkTemperatureTimeCurve Method (ICWConvection) |
...
See CWConvection::SetBulkTemperatureTimeCurve.
