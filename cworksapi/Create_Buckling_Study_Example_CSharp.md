...
namespace CreateBucklingStudy\_CSharp.csproj
{
...
            Study = StudyMngr.**CreateNewStudy3**("Buckling1", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeBuckling, 0, out errCode);
            if (Study == null)
...
            Debug.Print("    Temperature source as defined in swsThermalOption\_e: " + bsOptions.**ThermalResults**);
...
            restraint = LBCMgr.**AddRestraint**((int)swsRestraintType\_e.swsRestraintTypeFixed, (DispArray2), null, out errCode);
            if (errCode != 0)
                ErrorMsg(swApp, "Failed to add a restraint");

            //Add a pressure load
            CWPressureLoad = LBCMgr.**AddPressure**((int)swsPressureType\_e.swsPressureTypeNormal, (DispArray3), null, out errCode);
            if (errCode != 0)
