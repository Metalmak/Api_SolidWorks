...
the study manager"
    Set Study = StudyMngr.**CreateNewStudy3**("Buckling1", swsAnalysisStudyType\_e.swsAnalysisStudyTypeBuckling, 0, errCode)
...
in swsThermalOption\_e: " & bsOptions.**ThermalResults**
