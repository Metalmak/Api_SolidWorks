...
Examples****\Dynamics\ac\_unit.sldasm**.
...
namespace HarmonicFatigue\_CSharp.csproj
{
...
            Study = StudyMngr.**CreateNewStudy3**("HarmonicFatigue", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeFatigue, 2, out errCode);
            if (Study == null)
...
            FatigueEvent = FatigueOptions.**AddFatigueEventForHarmonic**("Sample\_Harmonic", 0, 15, 100000, 150000, out errCode);
...
            if (errCode != 0)
                ErrorMsg(swApp, "Failed to get minimum and maximum fatigue. Error code as defined in swsResultsError\_e: " + errCode);
