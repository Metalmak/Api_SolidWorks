...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLoadCaseManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadCaseManager.html) : RenameLoadCaseCombination Method (ICWLoadCaseManager) |
...
*SCombinationName*
:   Current name of load case combination

*SNewCombinationName*
:   New name of load case combination
...
See CWLoadCaseManager::RenameLoadCaseCombination.
