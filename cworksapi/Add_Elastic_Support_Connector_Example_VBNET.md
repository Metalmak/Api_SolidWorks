...
        Part = swApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2019\samples\Simulation Examples\shaft.sldasm", swDocumentTypes\_e.swDocASSEMBLY, swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", longstatus, longwarnings)
...
        Debug.Print("  Suppression state as defined in swsSuppressionState\_e: " & lr.**State**)
        Debug.Print("  Type of fixture as defined in swsLoadsAndRestraintsType\_e: " & lr.**Type**)
...
        Debug.Print("  Units as defined in swsUnit\_e: " & elasticSupport.**Unit**)
...
        If CWResult Is Nothing Then ErrorMsg(SwApp, "Failed to get the
CWResults object")
