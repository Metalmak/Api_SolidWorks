...
0) ' save stresses and reactions for all stress components
    'Solution step set #1
...
    DampingOptions.**ComputeFromMaterialDamping2** = 0 ' do not
use material damping ratios
...
    Set CWBaseExcitationU = LBCMgr.**AddUniformBaseExcitation2**(swsBaseExcitationType\_Acceleration,
CWBaseExcitationEntity, swsAccelerationUnit\_InchesPerSquareSec, -1, 2.3, -1, 3.4,
-1, 4.5, errCode)
...
    CWBaseExcitationU.**GetExcitationDirections2**
bdir1, bdir2, bdir3
...
dval2, dval3
    CWBaseExcitationU.**GetExcitationReverseDirections2**
bdir1, bdir2, bdir3, bang
    Debug.Print " Excitation values..."
    Debug.Print " Units as defined in swsAccelerationUnit\_e: " &
CWBaseExcitationU.**Unit**
    Debug.Print "   Direction 1: " & dval1
    Debug.Print "     Reversed? (-1=true) "
& bdir1
...
    Debug.Print "     Reversed? (-1=true) "
& bdir3
    Debug.Print "   Phase angle (-1 if not set): " &
CWBaseExcitationU.**PhaseAngle**
    Debug.Print "     Reversed? (-1=true) " &
bang
    Debug.Print "     Units as defined in
swsPhaseAngleUnit\_e: " & CWBaseExcitationU.**PhaseAngleUnit**
...
    Debug.Print "  Units in swsUnitSystem\_e units: " &
CWDistribMass.**Units**
    Debug.Print ""
