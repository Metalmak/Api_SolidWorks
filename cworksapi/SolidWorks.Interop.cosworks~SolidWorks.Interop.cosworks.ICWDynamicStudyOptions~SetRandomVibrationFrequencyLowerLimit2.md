<!-- source: cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~SetRandomVibrationFrequencyLowerLimit2.html -->
...
| SetRandomVibrationFrequencyLowerLimit2 Method (ICWDynamicStudyOptions) | |
...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWDynamicStudyOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions.html) : SetRandomVibrationFrequencyLowerLimit2 Method (ICWDynamicStudyOptions) |
...
Sets the lower limit of the operating frequency of the random vibration dynamic study

# ![](dotnetimages/collapse.gif).NET Syntax

| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function SetRandomVibrationFrequencyLowerLimit2( _    ByVal DLowerLimit As System.Double _ ) As System.Integer ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As ICWDynamicStudyOptions Dim DLowerLimit As System.Double Dim value As System.Integer   value = instance.SetRandomVibrationFrequencyLowerLimit2(DLowerLimit) ``` | |

| C# |  |
| --- | --- |
| ``` System.int SetRandomVibrationFrequencyLowerLimit2(     System.double DLowerLimit ) ``` | |
...
See CWDynamicStudyOptions::SetRandomVibrationFrequencyLowerLimit2.
