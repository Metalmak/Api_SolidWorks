<!-- source: cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints_members.html -->
...
| ICWLoadsAndRestraints Interface Members | |
...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) : ICWLoadsAndRestraints Interface |

The following tables list the members exposed by [ICWLoadsAndRestraints](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints.html).

# ![](dotnetimages/collapse.gif)Public Properties

|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [EntityCount](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~EntityCount.html) | Gets the number of entities in this load or restraint. |
| ![ Property](dotnetimages/Property.gif) | [Name](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~Name.html) | Gets the name of load or restraint. |
| ![ Property](dotnetimages/Property.gif) | [State](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~State.html) | Gets the suppression state of the load or restraint. |
| ![ Property](dotnetimages/Property.gif) | [Type](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~Type.html) | Gets the type of the load or restraint. |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetDirection](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~GetDirection.html) | Gets the direction of this load or restraint. |
| ![ Method](dotnetimages/Method.gif) | [GetEntityAt](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~GetEntityAt.html) | Gets the entity at the specified index in this load or restraint. |
| ![ Method](dotnetimages/Method.gif) | [GetReferenceGeometry](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~GetReferenceGeometry.html) | Gets the entity used for reference geometry in this load or restraint. |
| ![ Method](dotnetimages/Method.gif) | [SuppressUnSuppress](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints~SuppressUnSuppress.html) | Suppresses or unsuppresses the load or restraint depending on its [state](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.ICWLoadsAndRestraints~State.html). |
