...
        swApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2019\samples\Simulation Examples\shaft.sldasm", swDocumentTypes\_e.swDocASSEMBLY, swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", longstatus, longwarnings)
...
        CWContactSet = ContactMgr.**CreateContactSet2**(swsContactType\_e.swsContactTypeBonded, 0, (varArray3), (varArray4), errCode)
        If errCode <> 0 Then ErrorMsg(swApp, "No CWContactSet object")

        CWContactSet = ContactMgr.**CreateContactSet2**(swsContactType\_e.swsContactTypeBonded, 0, (varArray3), (varArray5), errCode)
        If errCode <> 0 Then ErrorMsg(swApp, "No CWContactSet object")
...
        errCode = multCSEM.**SetContactType**(swsContactType\_e.swsContactTypeFreeOrInsulated)
