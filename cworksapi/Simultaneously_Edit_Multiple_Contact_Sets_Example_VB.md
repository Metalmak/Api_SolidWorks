...
    SwApp.**OpenDoc6** "C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2019\samples\Simulation Examples\shaft.sldasm",
...
    Set pDisp1 = Part.**Extension**.**GetObjectByPersistReference3**((var8),
longstatus)
...
    Set pDisp2 = Part.**Extension**.**GetObjectByPersistReference3**((var9),
longstatus)
...
    Set pDisp3 = Part.**Extension**.**GetObjectByPersistReference3**((var10),
longstatus)
...
    Set CWContactSet = ContactMgr.**CreateContactSet2**(swsContactTypeBonded,
0, (varArray3), (varArray4), errCode)
    If errCode <> 0 Then ErrorMsg SwApp, "No CWContactSet object"

    Set CWContactSet = ContactMgr.**CreateContactSet2**(swsContactTypeBonded,
0, (varArray3), (varArray5), errCode)
    If errCode <> 0 Then ErrorMsg SwApp, "No CWContactSet object"
...
    errCode = multCSEM.**AddContactSet**("Contact
Set-1")
...
    errCode = multCSEM.**SetAsDefaultContactSet**("Contact
Set-1")
