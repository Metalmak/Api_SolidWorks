...
longwarnings As Long, errCode As Long, lDocType As Long
    Dim i As Long
...
    sModelName = "beam\_boltconnection.sldasm"
'Model name
...
    Set Part = SwApp.OpenDoc6("*public\_documents***\samples\tutorial\api\beam\_boltconnection.SLDASM**",
lDocType, 1, "", longstatus, longwarnings)
...
results object": GoTo Lastline

        DispArray1 =
Array(SelectByPID(Part, "selection1", PIDCollection))

        Force = CWFeatObj.**GetContactForcesAndFriction**(1,
Nothing, (DispArray1), swsNForceType\_e.swsNForceTypeNormal, 0, errCode)
        If errCode <> 0 Then ErrorMsg SwApp,
"Failed to get contact force result": GoTo Lastline

        Debug.Print ("
x, y, z, and resultant contact forces:")
