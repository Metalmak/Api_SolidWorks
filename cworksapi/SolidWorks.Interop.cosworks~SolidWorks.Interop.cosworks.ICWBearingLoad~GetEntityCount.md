<!-- source: cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWBearingLoad~GetEntityCount.html -->
...
| GetEntityCount Method (ICWBearingLoad) | |
...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWBearingLoad Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWBearingLoad.html) : GetEntityCount Method (ICWBearingLoad) |
...
Gets the number of entities for the bearing load.
...
See CWBearingLoad::GetEntityCount.
