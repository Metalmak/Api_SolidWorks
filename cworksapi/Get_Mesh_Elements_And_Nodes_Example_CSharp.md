...
// 3. Open public\_documents**\Simulation Examples\tutor1.sldprt**.
...
namespace GetMeshElementsAndNodes\_CSharp.csproj
{
...
with error code as defined in swsRunAnalysisError\_e: "
+
errCode);
