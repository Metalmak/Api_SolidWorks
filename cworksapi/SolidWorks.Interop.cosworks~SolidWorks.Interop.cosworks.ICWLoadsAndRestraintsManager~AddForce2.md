...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLoadsAndRestraintsManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraintsManager.html) : AddForce2 Method (ICWLoadsAndRestraintsManager) |
...
Obsolete. Superseded by [ICWloadsAndRestraintsManager::AddForce3](SOLIDWORKS.Interop.cosworks~SOLIDWORKS.Interop.cosworks.ICWLoadsAndRestraintsManager~AddForce3.html).
...
See CWLoadsAndRestraintsManager::AddForce2.
