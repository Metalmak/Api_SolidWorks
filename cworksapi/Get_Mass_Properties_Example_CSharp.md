...
namespace GetMassProperties\_CSharp.csproj
{
...
            swApp.OpenDoc6(docName, (int)swDocumentTypes\_e.swDocASSEMBLY, (int)swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", ref errors, ref warnings);
...
            Debug.Print("  Type as defined in swsAnalysisStudyType\_e: " + studyType);
...
            Debug.Print("    Moment of inertia (kilograms \* meters
squared): ");
...
            Debug.Print( "       Axis1\_x: " + paiObj[0]);
            Debug.Print( "       Axis1\_y: " + paiObj[1]);
            Debug.Print( "       Axis1\_z: " + paiObj[2]);
            Debug.Print( "       Axis2\_x: " + paiObj[3]);
            Debug.Print( "       Axis2\_y: " + paiObj[4]);
            Debug.Print( "       Axis2\_z: " + paiObj[5]);
            Debug.Print( "       Axis3\_x: " + paiObj[6]);
            Debug.Print( "       Axis3\_y: " + paiObj[7]);
            Debug.Print( "       Axis3\_z: " + paiObj[8]);
