...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLoadCaseManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadCaseManager.html) : DeleteLoadCaseCombination Method (ICWLoadCaseManager) |
...
*SCombinationName*
:   Name of load case combination to delete
...
See CWLoadCaseManager::DeleteLoadCaseCombination.
