...
//    \* **Fatigue\_StudyAPIVariable** (variable amplitude fatigue study)
...
namespace
CreateFatigueStudy\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
(int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeFatigue,
0, out
errCode);
            if
(Study == null)
...
            Debug.Print("  Shell
face option as defined in swsShellFace\_e: "
...
            Debug.Print("  Event
interaction type as defined in swsFatigueEventInteraction\_e: "
...
            Debug.Print("  Mean
stress correction option as defined in swsFatigueMeanStressCorrectionType\_e:
...
            Debug.Print("");
            Debug.Print("Creating
variable amplitude fatigue study Fatigue\_StudyAPIVariable...");
...
dsamplingrate);
            Debug.Print("  Type
of load history curve as defined in swsFatigueLoadHistoryCurveType\_e: "
+ ntype);
