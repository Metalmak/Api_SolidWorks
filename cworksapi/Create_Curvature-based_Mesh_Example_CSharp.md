...
            const
string
fileName = "C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2017\\Simulation Examples\\bikeframe.sldprt";
...
            CwMesh.**GetDefaultMaxAndMinElementSize**((int)swsLinearUnit\_e.swsLinearUnitMillimeters,
out
maxElementSize, out
minElementSize);

            // Create mesh
            errCode = Study.**CreateMesh**((int)swsLinearUnit\_e.swsLinearUnitMillimeters,
20, 1);
            Debug.Print("Error
code: " + errCode);
