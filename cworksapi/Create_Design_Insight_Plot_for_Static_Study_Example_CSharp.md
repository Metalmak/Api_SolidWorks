...
namespace CreateDesignInsight\_CSharp.csproj
{
...
            CWCFf = CWResult.**CreatePlot**((int)swsPlotResultTypes\_e.swsResultDesignInsight, 0, (int)swsUnit\_e.swsUnitSI, false, out errCode);
            if (CWCFf == null)
