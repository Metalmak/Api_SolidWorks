...
// 3. Open
*public\_documents***\samples\Simulation Examples****\tutor1.sldprt.**
...
namespace ConvertStudy\_CSharp.csproj
{
...
            //Convert study
            Study = StudyMngr.**ConvertStudy**("Ready", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeStatic, "LinDynHarmonic", (int)swsAnalysisStudyType\_e.swsAnalysisStudyTypeDynamic, "Default", (int)swsDynamicAnalysisSubType\_e.swsDynamicAnalysisSubTypeHarmonic, out errCode);
            if (Study == null)
