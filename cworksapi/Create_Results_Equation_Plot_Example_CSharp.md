...
// 3. Add a breakpoint to the line that begins with
"EqnResultMinMax = ".
// 4. Add a breakpoint to the line that begins with "EqnResultEntire = ".
// 5. Open *public\_documents***\samples\Simulation
...
namespace CreateResultsEquationPlot\_CSharp.csproj
{
...
            PostPlot = CWResult.**CreateResultsEquationPlot**(sEqtn, sTitle, false, (int)swsUnit\_e.swsUnitSI, 1, (int)swsShellFace\_e.swsShellFace\_Top, out errCode);
