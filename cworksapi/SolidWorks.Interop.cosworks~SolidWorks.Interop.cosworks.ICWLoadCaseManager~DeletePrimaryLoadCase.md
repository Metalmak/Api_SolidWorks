...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWLoadCaseManager Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadCaseManager.html) : DeletePrimaryLoadCase Method (ICWLoadCaseManager) |
...
*SLoadCaseName*
:   Name of primary load case to delete
...
See CWLoadCaseManager::DeletePrimaryLoadCase.
