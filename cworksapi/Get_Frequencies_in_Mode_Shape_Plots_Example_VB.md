...
    Set Part = SwApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2019\samples\Simulation Examples\Dynamics\ac\_unit.sldasm", swDocASSEMBLY, 1,
...
    ModeShapeNumber = 2
    TimeorFrequency = CWResult.**GetTimeOrFrequencyAtEachStep2**(0,
errorCode)
    MsgBox ("Frequency for mode shape 2: " &
TimeorFrequency(ModeShapeNumber - 1))
