...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWPlot Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWPlot.html) : ShowNormalizeValuesFrom0To1 Method (ICWPlot) |
...
*BNormalizeValuesFrom0To1*
:   True to normalize values from 0 to 1, false to not
...
See CWPlot::ShowNormalizeValuesFrom0To1.
