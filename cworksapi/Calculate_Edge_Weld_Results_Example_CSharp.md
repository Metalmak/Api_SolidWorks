...
            Part = (ModelDoc2)swApp.**OpenDoc6**(fileName, (int)swDocumentTypes\_e.swDocPART, 1, "", ref errors, ref warnings);
...
            EdgeResult = (object[])Results.**GetEdgeWeldResults**(ConnectorName, (int)swsUnit\_e.swsUnitSI, out PassFail, out errCode);
