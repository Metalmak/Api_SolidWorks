...
        'Convert study
        Study = StudyMngr.**ConvertStudy**("Ready", swsAnalysisStudyType\_e.swsAnalysisStudyTypeStatic, "LinDynHarmonic", swsAnalysisStudyType\_e.swsAnalysisStudyTypeDynamic, "Default", swsDynamicAnalysisSubType\_e.swsDynamicAnalysisSubTypeHarmonic, errCode)
