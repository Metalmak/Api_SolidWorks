...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWCompositeShellOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWCompositeShellOptions.html) : PlyRelativeAngle Property (ICWCompositeShellOptions) |
...
Obsolete. Superseded by [ICWCompositeShellOptions::PlyRelativeAngle2](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWCompositeShellOptions~PlyRelativeAngle2.html).
...
See CWCompositeShellOptions::PlyRelativeAngle.
