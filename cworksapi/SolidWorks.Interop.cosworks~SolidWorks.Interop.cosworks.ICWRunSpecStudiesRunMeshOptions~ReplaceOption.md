...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWRunSpecStudiesRunMeshOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWRunSpecStudiesRunMeshOptions.html) : ReplaceOption Method (ICWRunSpecStudiesRunMeshOptions) |
...
*NRunMeshOption*
:   New run and mesh option as defined in [swsRunStudiesRunMeshOptions\_e](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.swsRunStudiesRunMeshOptions_e.html)
...
See CWRunSpecStudiesRunMeshOptions::ReplaceOption.
