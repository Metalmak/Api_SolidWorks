...
        Temp = CWResult.**GetThermalValuesAtPoints**(swsThermalComponent\_e.swsThermalComponentTEMP, nStep, Nothing, (varArray7), swsTemperatureUnit\_e.swsTemperatureUnitKelvin, errCode)
