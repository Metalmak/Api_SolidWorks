...
|  |
| --- |
| [SolidWorks.Interop.cosworks Namespace](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks_namespace.html) > [ICWDampingOptions Interface](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDampingOptions.html) : GetRayleighDampingCoefficients Method (ICWDampingOptions) |
...
See CWDampingOptions::GetRayleighDampingCoefficients.
