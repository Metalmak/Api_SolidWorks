...
namespace LoadCaseManager\_CSharp.csproj
{
...
        public void Main()
        {
            Part = swApp.**OpenDoc6**("C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2017\\Simulation Examples\\Tutor1.sldprt", (int)swDocumentTypes\_e.swDocPART, 1, "", ref longstatus, ref longwarnings);
            if (Part == null)
...
CWCFf = CWResult.**CreatePlot**((int)swsPlotResultTypes\_e.swsResultDisplacementOrAmplitude, (int)swsStaticResultDisplacementComponentTypes\_e.swsStaticDisplacement\_URES, (int
swsUnit\_e.swsUnitSI, false, out errCode);
