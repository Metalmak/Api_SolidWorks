...
    boolstatus = Part.**Extension**.**SketchBoxSelect**("0.000000",
"0.000000", "0.000000", "0.000000", "0.000000", "0.000000")
    boolstatus = Part.**Extension**.**SelectByID2**("Surface-Trim1",
"SURFACEBODY", -5.33802776919856E-02, 3.81973755003173E-03, 0.025111145036476,
True, 0, Nothing, 0)

    Set Obj1 = SelMgr.**GetSelectedObject6**(1,
-1)
...
swsFOSNonCompositeCriterion\_VonMisesHencky
    CompositeFailureCriterion =
swsFOSCompositeCriterion\_Tsai\_Hill
    PlyNum = 0 ' Across all plies
    ShellFace = swsFOS\_ShellFaceOption\_TopFace
    ShellFaceOption = swsFOS\_NormalShellFaceOption\_Top
    MinFOSVal = 1
    swFactorOfSafetyDist = swsFOS\_DistributionOpt\_AreaBelowFOS
...
    FosVal = CWResult.**GetMinMaxFactorOfSafety2**(True,
Nothing, swsFOSNonCompositeCriterion\_Automatic, swsFOS\_ShellFaceOption\_TopFace,
0, errCode)
    Debug.Print "  Non-composite shell:"
    Debug.Print "    Minimum FOS: " & FosVal(0)
    Debug.Print "    Maximum FOS: " & FosVal(1)

    ' For non-composite shells and detail
settings
    FosVal = CWResult.**GetMinMaxFactorOfSafetyWithDetailSettings2**(True,
(varArray1), swsFOSNonCompositeCriterion\_VonMisesHencky, True, 1000,
swsStrengthUnitPSI, swsFactorOfSafetyStressLimitOption\_YieldStrength, 0,
swsFactorOfSafetyStressLimitOption\_UltimateStrength, 0, 1, 1, False,
ShellFaceOption, 0, errCode)
...
    FosVal = CWResult.**GetFactorOfSafetyForComposites**(bIsCompositeOption,
(varArray1), NonCompositeCriterion, CompositeFailureCriterion, PlyNum, ShellFace,
ShellFaceOption, swFactorOfSafetyDist, MinFOSVal, errCode)
...
Sub ErrorMsg(SwApp As SldWorks.SldWorks, Message As
String, EndTest As Boolean)
