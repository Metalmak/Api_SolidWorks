...
' 4. Open *public\_documents***\samples\tutorial\api\weldment\_box3.sldprt**.
...
    ' Get the selected beams' forces and
stresses
...
        Set selBeams(k) = swSelMgr.**GetSelectedObject6**(k
+ 1, -1)
    Next k

    ReDim Preserve selBeams(nbrSelectedBeams -
1)
    varArray = selBeams
...
    ' Print beam segment number, beam end1
force moment,
...
    arrBeamForces = Results.**GetBeamStressForEntities**(beamForce,
nbrSteps, (varArray), unit, errCode)
