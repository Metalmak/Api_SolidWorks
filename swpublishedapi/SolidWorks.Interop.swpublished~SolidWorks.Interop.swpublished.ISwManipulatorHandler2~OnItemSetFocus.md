...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [ISwManipulatorHandler2 Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.ISwManipulatorHandler2.html) : OnItemSetFocus Method (ISwManipulatorHandler2) |
...
*handleIndex*
:   ID of item on which to set focus
...
See SwManipulatorHandler2::OnItemSetFocus.
