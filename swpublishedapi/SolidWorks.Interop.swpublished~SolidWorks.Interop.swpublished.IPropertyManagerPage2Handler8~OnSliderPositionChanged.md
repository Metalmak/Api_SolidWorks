...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [IPropertyManagerPage2Handler8 Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.IPropertyManagerPage2Handler8.html) : OnSliderPositionChanged Method (IPropertyManagerPage2Handler8) |
...
Obsolete. Superseded by [IPropertyManagerPage2Handler9::OnSliderPositionChanged](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.IPropertyManagerPage2Handler9~OnSliderPositionChanged.html).
...
See PropertyManagerPage2Handler8::OnSliderPositionChanged.
...
* IPropertyManagerPage2Handler8::OnSliderPositionChanged to receive notifications every time the position of the slider changes because the slider is being dragged.
