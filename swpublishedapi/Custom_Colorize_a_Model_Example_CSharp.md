...
// 3. Change the namespace to match the name of your C#
project.

// 4. Ensure that **PMPHandler.cs** is implementing a compatible
interface.

// 5. Compile and run the project.

// 6. In SOLIDWORKS open *public\_documents***\samples\tutorial\api\wrench.sldasm**.
...
// 2. The Value is displayed and refreshed as the cursor moves
over the model.
...
    [Guid("918fec9b-55d0-4e7c-bc6a-5eacc88c29d8"),
ComVisible(true)]
    [SwAddin(
        Description = "SwColor
description",
