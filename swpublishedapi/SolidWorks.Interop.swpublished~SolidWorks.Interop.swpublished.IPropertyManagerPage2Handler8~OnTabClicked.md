...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [IPropertyManagerPage2Handler8 Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.IPropertyManagerPage2Handler8.html) : OnTabClicked Method (IPropertyManagerPage2Handler8) |
...
*Id*
:   ID of the clicked tab (see Remarks)

Obsolete. Superseded by [IPropertyManagerPage2Handler9::OnTabClicked](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.IPropertyManagerPage2Handler9~OnTabClicked.html).
...
See PropertyManagerPage2Handler8::OnTabClicked.
