...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [ISwQuickTip Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.ISwQuickTip.html) : ShowInDrawingDoc Property (ISwQuickTip) |
...
Gets whether to show an add-in's Quick Tips in SOLIDWORKS drawing documents.
...
See SwQuickTip::ShowInDrawingDoc.
