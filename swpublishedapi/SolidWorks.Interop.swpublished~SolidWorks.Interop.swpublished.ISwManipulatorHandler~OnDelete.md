...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [ISwManipulatorHandler Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.ISwManipulatorHandler.html) : OnDelete Method (ISwManipulatorHandler) |
...
Obsolete. Superseded by [ISwManipulatorHandler2::OnDelete](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.ISwManipulatorHandler2~OnDelete.html).
...
See SwManipulatorHandler::OnDelete.
