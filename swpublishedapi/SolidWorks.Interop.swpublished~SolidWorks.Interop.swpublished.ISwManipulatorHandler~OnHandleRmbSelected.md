...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [ISwManipulatorHandler Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.ISwManipulatorHandler.html) : OnHandleRmbSelected Method (ISwManipulatorHandler) |
...
Obsolete. Superseded by [ISwManipulatorHandler2::OnHandleRmbSelected](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.ISwManipulatorHandler2~OnHandleRmbSelected.html).
...
See SwManipulatorHandler::OnHandleRmbSelected.
