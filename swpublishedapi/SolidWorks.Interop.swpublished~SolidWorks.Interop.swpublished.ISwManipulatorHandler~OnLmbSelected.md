...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [ISwManipulatorHandler Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.ISwManipulatorHandler.html) : OnLmbSelected Method (ISwManipulatorHandler) |
...
Obsolete. Superseded by [ISwManipulatorHandler2::OnHandleLmbSelected](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.ISwManipulatorHandler2~OnHandleLmbSelected.html).
...
See SwManipulatorHandler::OnLmbSelected.
