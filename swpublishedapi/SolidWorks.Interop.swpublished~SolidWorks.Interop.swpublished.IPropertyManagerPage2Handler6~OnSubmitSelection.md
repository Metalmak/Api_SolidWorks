...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [IPropertyManagerPage2Handler6 Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.IPropertyManagerPage2Handler6.html) : OnSubmitSelection Method (IPropertyManagerPage2Handler6) |
...
Obsoleted. Superseded by [IPropertyManagerPage2Handler7::OnSubmitSelection](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.IPropertyManagerPage2Handler7~OnSubmitSelection.html).
...
See PropertyManagerPage2Handler6::OnSubmitSelection.
