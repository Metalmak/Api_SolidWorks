...
|  |
| --- |
| [SolidWorks.Interop.swpublished Namespace](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished_namespace.html) > [IPropertyManagerPage2Handler8 Interface](SolidWorks.Interop.swpublished~SolidWorks.Interop.swpublished.IPropertyManagerPage2Handler8.html) : OnGainedFocus Method (IPropertyManagerPage2Handler8) |
...
Obsolete. Superseded by [IPropertyManagerPage2Handler9::OnGainedFocus](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.IPropertyManagerPage2Handler9~OnGainedFocus.html).
...
See PropertyManagerPage2Handler8::OnGainedFocus.
