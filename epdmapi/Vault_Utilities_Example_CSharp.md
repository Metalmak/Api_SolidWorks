...
//    a. Click **File > New > Project > Visual
C# > Windows Forms Application**.
//    b. Type **VaultUtilities\_CSharp** in **Name**.
//    c. Click **Browse** and navigate to the folder where to create
//       the project.
//    d. Click **OK**.
//    e. Click **Show All Files** in the Solution Explorer toolbar and expand
//       **Form1.cs** in the Solution Explorer.
//    f. Replace the code in **Form1.cs** with [this code](#Form1.cs).
//    g. To create the form,
replace the code in **Form1.Designer.cs** with [this code](#Form1.Designer.cs).
...
//
// Postconditions:
// 1. Displays the Vault
utilities dialog box.
//    a. Select a vault view.
//    b. Click **Verify
SOLIDWORKS PDM Professional 5.3**.
//
...
//       1. Displays a
message with the installed licenses.
//
2. Click **OK**.
//    d. Click **Add group**.
...
folder from which you deleted
//          a file in step 1i.
//       2. Click **OK**.
//       3. Displays a message with the status of
the folder restoration.
//       4. Click **OK**.
// 2. Close the Vault
utilities dialog box.
...
namespace VaultUtilities\_CSharp
{
...
        public void Form1\_Load(System.Object sender, System.EventArgs e)
        {
            try
            {
...
        private void Button5\_Click(System.Object sender, System.EventArgs e)
        {
...
        private void Button6\_Click(System.Object sender, System.EventArgs e)
        {
            //Get licenses
            try
            {
...
                    {
                        case EdmLicenseType.EdmLic\_Editor:
                            msg = msg + "Editor";
                            break;
                        case EdmLicenseType.EdmLic\_Contributor:
                            msg = msg + "Contributor";
                            break;
                        case EdmLicenseType.EdmLic\_Viewer:
                            msg = msg + "Viewer";
                            break;
                        case EdmLicenseType.EdmLic\_Processor:
                            msg = msg + "Processor";
                            break;
                        default:
...
        private void Button7\_Click(System.Object sender, System.EventArgs e)
        {
            //Add group, My Group
            try
            {
...
                userMgr = (IEdmUserMgr7)vault2.**CreateUtility**(EdmUtility.EdmUtil\_UserMgr);
...
                groups[0].**mlFlags** = (int)EdmGroupDataFlags.Edmgdf\_GetInterface;
                int[] members = new int[1];
                members[0] = admin.**ID**;
                groups[0].**moMembers** = members;
                EdmSysPerm[] perms = new EdmSysPerm[1];
                perms[0] = EdmSysPerm.EdmSysPerm\_ModifyToolbox;
...
        private void Button8\_Click(System.Object sender, System.EventArgs e)
        {
...
        private void Button9\_Click(System.Object sender, System.EventArgs e)
        {
            //Add user, Temp
            try
            {
...
                UserData[0].**mlFlags** = (int)EdmUserDataFlags.Edmudf\_GetInterface;
                UserData[0].**mlFlags** += (int)EdmUserDataFlags.Edmudf\_ForceAdd;

                EdmSysPerm[] perms = new EdmSysPerm[3];
                perms[0] = EdmSysPerm.EdmSysPerm\_EditUserMgr;
                perms[1] = EdmSysPerm.EdmSysPerm\_EditReportQuery;
                perms[2] = EdmSysPerm.EdmSysPerm\_MandatoryVersionComments;
...
        private void Button10\_Click(System.Object sender, System.EventArgs e)
        {
            //Remove user, Temp
            try
            {
...
        private void Button4\_Click(System.Object sender, System.EventArgs e)
        {
...
                pathList = vault2.**BrowseForFile**(this.Handle.ToInt32(), (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles);
                if (pathList == null)
                    return;
...
                if (srcFolder.**HasRightsEx**((int)EdmRightFlags.EdmRight\_Lock, file.**ID**))
                {
...
        private void Button1\_Click(System.Object sender, System.EventArgs e)
        {
            //Copy file
            try
            {
...
                int fileID = 0;
                fileID = destFolder.**CopyFile**(file.**ID**, srcFolder.**ID**, this.Handle.ToInt32(), "", (int)EdmCopyFlag.EdmCpy\_Simple);
...
        private void Button2\_Click(System.Object sender, System.EventArgs e)
        {
            //Delete file
            try
            {
...
                EdmStrLst5 pathList = default(EdmStrLst5);
                pathList = vault2.**BrowseForFile**(this.Handle.ToInt32(), (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles + (int)EdmBrowseFlag.EdmBws\_PermitMultipleSel, "", "", "", "", "Select Files to Delete");
                if (pathList == null)
                    return;
...
        private void Button3\_Click(System.Object sender, System.EventArgs e)
        {
            //Delete folder
            try
            {
...
            }
        }
    private void Button11\_Click(System.Object sender, System.EventArgs e)
        {
            //Restore
folder
            try
...
            this.Button1.Click +=new System.EventHandler(Button1\_Click);
            //
            //Button2
            //
...
            this.Button2.Click +=new System.EventHandler(Button2\_Click);
            //
            //Button3
            //
...
            this.Button3.Click +=new System.EventHandler(Button3\_Click);
            //
            //Button4
            //
...
            this.Button4.Click +=new System.EventHandler(Button4\_Click);
            //
            //Button5
            //
...
            this.Button5.Click +=new System.EventHandler(Button5\_Click);
            //
            //Button6
            //
...
            this.Button6.Click +=new System.EventHandler(Button6\_Click);
            //
            //Button7
            //
...
            this.Button7.Click +=new System.EventHandler(Button7\_Click);
            //
            //Button8
            //
...
            this.Button8.Click +=new System.EventHandler(Button8\_Click);
            //
            //Button9
            //
...
            this.Button9.Click +=new System.EventHandler(Button9\_Click);
            //
            //Button10
            //
...
            this.Button10.Click +=new System.EventHandler(Button10\_Click);
            //
            //Button11
            //
...
            this.Button11.Text = "Restore
deleted items";
            this.Button11.UseVisualStyleBackColor = true;
            this.Button11.Click +=new System.EventHandler(Button11\_Click);
            //
            //OpenFileDialog1
            //
