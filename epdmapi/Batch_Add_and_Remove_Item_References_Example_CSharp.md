...
Forms Application**.
//    b. Type **BatchAddItemRefs\_CSharp** in **Name**.
...
//     b. Observe that item 00000005 is linked to item
00000004.
...
namespace BatchAddItemRefs\_CSharp
{
...
        public void AddItemRefs\_Click(System.Object sender, System.EventArgs e)
        {
...
            search = (IEdmSearch7)vault.**CreateUtility**(EdmUtility.EdmUtil\_Search);
            search.**StartFolderID** = vault.**ItemRootFolderID**;
            search.**SetToken**(EdmSearchToken.Edmstok\_FindFolders, false);
            search.**SetToken**(EdmSearchToken.Edmstok\_FindFiles, true);
            search.**SetToken**(EdmSearchToken.Edmstok\_FindItems, true);
            search.**SetToken**(EdmSearchToken.Edmstok\_Recursive, true);
...
            addRefs[0].**mlEdmRefFlags** = (int)EdmRefFlags.EdmRef\_Item;
...
            batch = (IEdmBatchItemReferenceUpdate)vault.**CreateUtility**(EdmUtility.EdmUtil\_BatchItemReferenceUpdate);
...
            this.AddItemRefs.Click += new System.EventHandler(AddItemRefs\_Click);
            //
            //Form1
            //
