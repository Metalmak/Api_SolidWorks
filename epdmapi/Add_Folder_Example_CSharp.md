...
//    b. Type **AddFolder\_CSharp** in **Name**.
...
        public void AddFolder\_Click(System.Object sender, System.EventArgs e)
        {
...
                data.**SetUserRights**(usrMgr.**GetUser**("Engineer1").**ID**, (int)EdmRightFlags.EdmRight\_Read | (int)EdmRightFlags.EdmRight\_Lock);
                data.**SetGroupRights**(usrMgr.**GetUserGroup**("Administrators").**ID**, (int)EdmRightFlags.EdmRight\_All);
...
            this.AddFolder.Click +=new System.EventHandler(AddFolder\_Click);
            //
            //Form1
            //
