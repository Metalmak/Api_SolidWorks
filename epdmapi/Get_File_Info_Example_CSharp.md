...
//    b. Click **Browse**.
//       1. Locate and select
the file checked out in Preconditions step 5.
//       2. Click **Open**.
//    c. Click **Get information**.
//    d. Displays a message box with information
...
        public void GetInfo\_Click(System.Object sender, System.EventArgs e)
        {
...
                    msg = msg + "Locked on: " + aFile.**LockedOnComputer**
+ ", Vault View ID: " + aFile.**LockedOnViewID**;
                }
...
labelID = aFile.**CreateLabel**("File
label", "Label description shows in the history
dialog box");
...
            this.GetInfo.Click +=new System.EventHandler(GetInfo\_Click);
            //
            //OpenFileDialog
            //
