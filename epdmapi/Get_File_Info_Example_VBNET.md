...
'       1. Locate and select the file
checked out in Preconditions step 4.
'       2. Click **Open**.
...
    Public Sub GetInfo\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetInfo.Click
        Try
...
             msg =
msg & "File has cut list items? " &
hasCutListItems & vbLf
...
labelID = aFile.**CreateLabel**("File label", "Label description
shows in the history dialog box")
