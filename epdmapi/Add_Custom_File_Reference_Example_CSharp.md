...
//    g. Replace the code in **Form1.cs** with [this code](#Form1.cs).
//    h. Replace the code in **Form1.Designer.cs** with [this code](#Form1.Designer.cs).
...
// 5. In the
Add custom references dialog, click **Add custom file reference**.
...
        public void FileReferencesCSharp\_Load(System.Object sender, System.EventArgs e)
        {
...
        public void AddCustomFileReference\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                //Only create a new vault object
...
                IEdmAddCustomRefs addCustRefs = (IEdmAddCustomRefs)vault2.**CreateUtility**(EdmUtility.**EdmUtil\_AddCustomRefs**);
...
                    if (!file.**IsLocked**) {
                        file.**LockFile**(parentFolder.**ID**, this.Handle.ToInt32(), (int)EdmLockFlag.EdmLock\_Simple);
                    }
...
                    addCustRefs.**CreateTree**((int)EdmCreateReferenceFlags.Ecrf\_Nothing);
...
            this.BrowseButton.Click += new System.EventHandler(this.BrowseButton\_Click);
            //
            // CustRefListBox
            //
...
            this.AddCustomFileReference.Click += new System.EventHandler(this.AddCustomFileReference\_Click);
            //
            // Form1
            //
...
            this.Load += new System.EventHandler(this.FileReferencesCSharp\_Load);
