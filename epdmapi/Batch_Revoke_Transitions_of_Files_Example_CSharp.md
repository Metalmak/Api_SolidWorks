...
namespace BatchRevokeTransitions\_CSharp
{
...
                batchChanger = (IEdmBatchChangeState3)vault2.CreateUtility(EdmUtility.EdmUtil\_BatchChangeState);
...
        public void RevokeTransitions\_Click(System.Object sender, System.EventArgs e)
        {
...
                selList = (IEdmSelectionList6)batchChanger.**GetFileList**((int)EdmChangeStateFileListFlag.Ecsflf\_GetChanged);
...
            this.RevokeTransitions.Click +=new System.EventHandler(RevokeTransitions\_Click);
            //
            //OpenFileDialog1
            //
