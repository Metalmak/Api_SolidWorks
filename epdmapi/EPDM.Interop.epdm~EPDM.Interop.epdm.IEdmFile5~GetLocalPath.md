...
|  |
| --- |
| [EPDM.Interop.epdm Namespace](EPDM.Interop.epdm~EPDM.Interop.epdm_namespace.html) > [IEdmFile5 Interface](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile5.html) : GetLocalPath Method (IEdmFile5) |
...
* S\_OK: The method successfully executed.* E\_EDM\_FOLDER\_NOT\_FOUND: The folder ID is invalid.
