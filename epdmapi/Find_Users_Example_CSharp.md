...
//     b. Type **FindUser\_CSharp** in **Name**.
...
// Postconditions:
//  1. Displays the
Find Users dialog box.
//     a. Select a vault
view.
//     b. In
**Full name contains**, type a substring of the full name of a
//
...
        private void FindUsers\_Click(System.Object sender, System.EventArgs e)
...
poFind = (IEdmFindUser)vault2.**CreateUtility**(EdmUtility.EdmUtil\_FindUser);

//Search for a user with specified text in the full user name

poFind.**SetPropt**(EdmFindUserProp.Edmfup\_FullName, this.TextBox1.Text);
               string val = null;

val = (string)poFind.**GetPropt**(EdmFindUserProp.Edmfup\_FullName);
...
               UserInfo.**mlEdmUserDataExFlags** = (int)EdmUserDataExFlag.Edmudex\_All;
...
            this.FindUsers.Click += new System.EventHandler(this.FindUsers\_Click);
            //
            // VaultsComboBox
            //
