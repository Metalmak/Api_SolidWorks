...
        menuCallback = vault.**CreatePluginMenu2**(mnu.Handle.ToInt32(), 3, startID, selList, CreateMenuFlags.Cmf\_ContextMenu + CreateMenuFlags.Cmf\_IncludeAdminReactors, count)
