...
//    b. Type **BatchAddFolders\_CSharp** in **Name**.
...
//    b.
Type the name of a new folder to create in the root folder
//       of the vault.
//    c. Click
...
2. Click **OK**.
// 2. Repeat
steps 1b-c repeatedly to add more folders to the batch.
...
namespace BatchAddFolders\_CSharp
{
...
        private void AddFolders\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                {
                    batchAddFolders = (IEdmBatchAddFolders)vault2.**CreateUtility**(EdmUtility.EdmUtil\_BatchAddFolders);
                }

                batchAddFolders.**AddFolder**(vault2.**RootFolderID**, TextBox1.Text, i, (int)EdmBatchAddFolderFlag.Ebaff\_GetInterface, null, 0);
                i = i + 1;
...
        public void CreateFolders\_Click(System.Object sender, System.EventArgs e)
        {
...
                batchAddFolders.**Create**(this.Handle.ToInt32(), ref ppoRetFolders, (int)EdmBatchCreateFolderFlag.Ebcf\_Nothing);
...
            this.AddFolders.Click +=new System.EventHandler(AddFolders\_Click);
            //
            //CreateFolders
            //
...
            this.CreateFolders.Click +=new System.EventHandler(CreateFolders\_Click);
            //
            //TextBox1
            //
