...
'    d. Click **OK**.
'    e. Replace the code in **Module1.vb** with [this code](#Module1).
...
        menuCallback = vault.**CreatePluginMenu2**(mnu.Handle.ToInt32(), 3, startID, selList, CreateMenuFlags.Cmf\_ContextMenu, count)
        menuCallback.**GetItems**(EdmMenuFlags.EdmMenu\_Nothing, ppoRetItems)
...
        Dim TPM\_RETURNCMD As Integer
        TPM\_RETURNCMD = 256
        Dim cmdID As Integer
        frmParent = New Form
        cmdID = TrackPopupMenu(mnu.Handle, TPM\_RETURNCMD, frmParent.Left, frmParent.Top, 0, frmParent.Handle, 0)
