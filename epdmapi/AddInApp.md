...
* Added to a file vault through the  [Add-in Properties dialog](AdminDlg.htm).
...
* Programmed with hooks ([EdmCmdType](EPDM.Interop.epdm~EPDM.Interop.epdm.EdmCmdType.html))
