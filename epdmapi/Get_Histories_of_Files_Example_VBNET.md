...
'    b. Type **GetHistories\_VBNET** in **Name**.
...
'       Rolls back the selected file to its first
version.
'    i. Click **Get history**.
...
            historyUpdate = vault2.**CreateUtility**(EdmUtility.EdmUtil\_HistoryUpdate)
...
    Public Sub GetHistories\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetHistories.Click
        Try
...
           history = vault2.**CreateUtility**(EdmUtility.EdmUtil\_History)
...
            history.**GetSortedHistory**(ppoRethistory, EdmHistoryType.Edmhist\_FileVersion)
...
vbLf
                str = str & "Type
of history record as defined in EdmHistoryType: " & item.**meType** & vbLf
...
    Public Sub Rollback\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetHistories.Click
        Try
