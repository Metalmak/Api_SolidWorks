...
            batchUnlocker = vault2.**CreateUtility**(EdmUtility.EdmUtil\_BatchUnlock)
...
    Public Sub BatchUnlock\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BatchUnlock.Click
        Try
...
                batchUnlocker.**CreateTree**(Me.Handle.ToInt32(), EdmUnlockBuildTreeFlags.Eubtf\_ShowCloseAfterCheckinOption
+ EdmUnlockBuildTreeFlags.Eubtf\_MayUnlock)

                batchUnlocker.**Comment** = "Updates"
                fileList = batchUnlocker.**GetFileList**(EdmUnlockFileListFlag.Euflf\_GetUnlocked + EdmUnlockFileListFlag.Euflf\_GetUndoLocked + EdmUnlockFileListFlag.Euflf\_GetUnprocessed)
...
                    statuses = batchUnlocker.**GetStatus**(EdmUnlockStatusFlag.Eusf\_CloseAfterCheckinFlag)
