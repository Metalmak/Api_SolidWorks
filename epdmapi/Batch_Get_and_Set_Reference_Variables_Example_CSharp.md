...
Forms Application**.
//     b. Type **BatchGetSetRefVariables\_CSharp** in **Name**.
...
//     d. Select **Look for variable in reference specific
values**.
//     e. Click **OK**.
//  5. Open File Explorer on a vault view.
//  6. Ensure that an assembly and its referenced parts reside in the
vault.
...
// 12. Click **Save** on the Bill of Materials toolbar and close the vault
view.
...
//        1. In the Select Parent File
dialog, select the assembly file identified
//           in Preconditions
...
namespace BatchGetSetRefVariables\_CSharp
{
...
        public void Button1\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
        public void Button2\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
        public void Button3\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
            pathList = (IEdmStrLst5)vault.**BrowseForFile**(this.Handle.ToInt32(), (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles, "All Files (\*.\*)|\*.\*||", "", "", "", "Select Parent File:");
            if (pathList == null)
                return;
...
            pathList = vault.**BrowseForFile**(this.Handle.ToInt32(), (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles, "All Files (\*.\*)|\*.\*||", "", "", "", "Select Child File:");
            if (pathList == null)
                return;
...
            batch = (IEdmBatchRefVars)vault.**CreateUtility**(EdmUtility.EdmUtil\_BatchRefVars);
            EdmRefVar[] vars = null;
...
            //Let the user select the parent file
            IEdmStrLst5 pathList = default(IEdmStrLst5);
            pathList = vault.**BrowseForFile**(this.Handle.ToInt32(), (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles, "All Files (\*.\*)|\*.\*||", "", "", "", "Select Parent File:");
            if (pathList == null)
                return;
...
            varMgr = (IEdmVariableMgr6)vault.**CreateUtility**(EdmUtility.EdmUtil\_VariableMgr);
