...
'  5. Click **OK**.
'  6. Replace the code in **Form1.vb**with [this code](#Form).
...
On the Compile tab,
'     if **Target CPU** is set to **AnyCPU**, ensure
that **Prefer 32-bit** is cleared.)
...
'     structures.
' 11. Ensure that the vault contains one or more
checked-out files.
...
' 2. Select a vault.
' 3. Click **Log in, get client log, get
checked-out files in vault**.
...
    Public Sub TraverseFilesFolders\_Load(
...
    Public Sub TraverseFoldersButton\_Click(
ByVal sender As System.Object,
ByVal e As System.EventArgs) \_
