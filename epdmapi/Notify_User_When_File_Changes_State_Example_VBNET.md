...
'    a. Add PDM
Professional interop assembly as a reference (click **Browse** in the
...
transition.
' 3. Under *vault\_name*, right-click
**Add-ins** and click **New Add-in**.
'    a. Navigate to the
**bin\Debug** directory of your built project.
'    b. Click **EPDM.Interop.epdm.dll** and **StateChangeNotificationAddin.dll**'    c. Click **Open**.
'    d. Click **OK**.
' 4. Click **OK** after reading the SOLIDWORKS PDM Professional warning dialog.
' 5. Open File Explorer on a
view of *vault\_name* and:
'    a. Log in as Admin.
'    b. Create a new file in
the root directory of *vault\_name* and check it in.
...
                        topNode = cmdNode.**GetProperty**(EdmCmdNodeProp.EdmCmdNode\_IsTopNode)
