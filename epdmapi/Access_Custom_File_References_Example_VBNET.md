...
replace the code in **Form1.Designer.vb** with
...
    Public Sub AddCustomFileReference\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddCustomFileReference.Click
        Try
...
                file1.**LockFile**(parentFolder.**ID**, Me.Handle.ToInt32(), CInt(EdmLockFlag.EdmLock\_Simple))
            End If

            'Add the second file as a custom reference to
the first file
            addCustRefs = file1
...
            shownInBOM =
addCustRefs.**GetShowInBOM**(file2.**ID**, parentFolder.**ID**)
...
            'Display all of the custom references of the
first file
            ShowFileRefs()
