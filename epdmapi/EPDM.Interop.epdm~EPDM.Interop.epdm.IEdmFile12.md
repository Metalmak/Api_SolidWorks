...
| [See Also](#seealsobookmark)  [Members](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile12_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [EPDM.Interop.epdm Namespace](EPDM.Interop.epdm~EPDM.Interop.epdm_namespace.html) : IEdmFile12 Interface |
...
* extends [IEdmFile11](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile11.html) by providing the ability to get the local version of a file.* is extended by [IEdmFile13](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile13.html).
