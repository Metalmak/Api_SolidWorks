...
    Public Sub GetApprovedFiles\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetApprovedFiles.Click
        'Get approved files
        Try
...
            Dim wfmgr As IEdmWorkflowMgr6 = vault2.**CreateUtility**(EdmUtility.EdmUtil\_WorkflowMgr)
