...
//    f. Replace the code in **Form1.cs** with [this code](#Form1).
//    g. Replace the code in **Form1.Designer.cs** with [this code](#Designer).
...
//    E**mbed Interop Types** to **False** to handle methods that pass arrays of
//    structures.
...
        void UsersAndGroupsCSharp\_Load(System.Object sender, System.EventArgs e)
...
        private void TraverseUsersButton\_Click(System.Object sender, System.EventArgs e)
...
                UserMgr = vault1.**CreateUtility**(EdmUtility.EdmUtil\_UserMgr);
...
                UserMgr.**GetStatePermissions**(User.ID, EdmObjectType.EdmObject\_User, 0, out ppoPermissions);
                string str = null;
...
                    str = str + "meOwnerType (EdmObjectType.EdmObject\_User (7) or EdmObjectType.EdmObject\_UserGroup (8)): " + item.**meOwnerType** + "\n";
...
                UserMgr.**GetTransitionPermissions**(User.**ID**, EdmObjectType.EdmObject\_User, 0, out ppoTransitionPermissions);
...
        private void TraverseGroupsButton\_Click(System.Object sender, System.EventArgs e)
...
        private void TraverseGroupMembersButton\_Click(System.Object sender, System.EventArgs e)
...
        private void SendConsultationRequestButton\_Click(System.Object sender, System.EventArgs e)
