...
//    b. Type **BatchChangeFileStates\_CSharp** in **Name**.
...
namespace BatchChangeFileStates\_CSharp
{
...
        public void Transition\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                batchChanger = (IEdmBatchChangeState4)vault2.**CreateUtility**(EdmUtility.EdmUtil\_BatchChangeState);
...
        public void BatchChange\_Click(System.Object sender, System.EventArgs e)
        {
...
                selList = (IEdmSelectionList6)batchChanger.**GetFileList**((int)EdmChangeStateFileListFlag.Ecsflf\_GetActionUpdated + (int)EdmChangeStateFileListFlag.Ecsflf\_GetChanged + (int)EdmChangeStateFileListFlag.Ecsflf\_GetUnprocessed);
...
            this.Transition.Click += new System.EventHandler(this.Transition\_Click);
            //
            //File1List
            //
...
            this.BatchChange.Click += new System.EventHandler(this.BatchChange\_Click);
            //
            //OpenFileDialog1
            //
