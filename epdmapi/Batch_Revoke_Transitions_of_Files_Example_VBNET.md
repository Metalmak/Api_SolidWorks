...
'     The selected file's
No Approval Required transition is revoked.
'  4. Close the Revoke
...
    Public Sub RevokeTransitions\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RevokeTransitions.Click
        Try
...
            selList = batchChanger.**GetFileList**(EdmChangeStateFileListFlag.Ecsflf\_GetChanged)
