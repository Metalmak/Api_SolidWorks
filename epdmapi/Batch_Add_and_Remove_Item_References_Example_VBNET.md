...
' Postconditions:
'  1. The Add
Item Reference dialog box displays.
'     a. Select a vault view.
'     b. Click **Add
item reference**.
'  2. Click **OK** in the BatchAddItemRefs dialog
box.
...
    Public Sub AddItemRefs\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddItemRefs.Click
        Try
...
        search = vault.**CreateUtility**(EdmUtility.EdmUtil\_Search)
...
        addRefs(0).**mlEdmRefFlags** = EdmRefFlags.EdmRef\_Item
...
        batch = vault.**CreateUtility**(EdmUtility.EdmUtil\_BatchItemReferenceUpdate)
