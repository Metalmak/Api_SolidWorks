...
'       2. Click **OK**.
'    c. Click **Get SOLIDWORKS
Professional PDM licenses**.
'       1. Displays a
...
            userMgr = vault2.**CreateUtility**(EdmUtility.EdmUtil\_UserMgr)
...
            groups(0).**mlFlags** = EdmGroupDataFlags.Edmgdf\_GetInterface
...
                EdmUserDataFlags.Edmudf\_GetInterface
            UserData(0).**mlFlags** += \_
                EdmUserDataFlags.Edmudf\_ForceAdd
...
            pathList = vault2.**BrowseForFile**(Me.Handle.ToInt32(), EdmBrowseFlag.EdmBws\_ForOpen + EdmBrowseFlag.EdmBws\_PermitVaultFiles)
...
            If srcFolder.**HasRightsEx**(EdmRightFlags.EdmRight\_Lock, file.**ID**) Then
...
            fileID = destFolder.**CopyFile**(file.**ID**, srcFolder.**ID**, Me.Handle.ToInt32(), "", EdmCopyFlag.EdmCpy\_Simple)
...
                                     EdmBrowseFlag.EdmBws\_ForOpen + \_
                                     EdmBrowseFlag.EdmBws\_PermitVaultFiles + \_
                                     EdmBrowseFlag.EdmBws\_PermitMultipleSel, \_
                                     "", "", "", "", \_
