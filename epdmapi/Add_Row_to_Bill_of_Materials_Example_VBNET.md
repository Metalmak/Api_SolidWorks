...
' 4. Verify the new row in the
named BOM of the assembly in *vault\_name* view.
...
            bomView.**InsertRow**(ppoRows(0), EdmBomInsertRowOption.EdmBomInsertRowOption\_BelowRow, ppoNewRow)
            ppoNewRow.**SetVar**(ppoColumns(0).**mlVariableID**, ppoColumns(0).**meType**, "*vault\_name*\temp", "", EdmBomSetVarOption.EdmBomSetVarOption\_Both, errMsg)
