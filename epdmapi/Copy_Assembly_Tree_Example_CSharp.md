...
//    b. Type **CopyTree\_CSharp** in **Name**.
...
//       2. Click **OK**.
//    d. Click **Copy tree**.
//       The Copy Tree dialog shows the files to
copy.
//    e. Click **Copy**.
...
                copyTreeOptions.**mbsPrefix** = "Copy\_";
...
        private void BrowseDestFolder\_Click(object sender, EventArgs e)
        {
            try
            {
...
            this.BrowseAssembly.Click += new System.EventHandler(this.BrowseButton\_Click);
            //
            // ListBox
            //
...
            this.CopyTree.Click += new System.EventHandler(this.AddFiles\_Click);
            //
            // OpenFileDialog
            //
...
            this.BrowseDestFolder.Click += new System.EventHandler(this.BrowseDestFolder\_Click);
            //
            // listBox1
            //
