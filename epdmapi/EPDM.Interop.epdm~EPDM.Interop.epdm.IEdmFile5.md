<!-- source: epdmapi/EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile5.html -->
...
| IEdmFile5 Interface | |
| [See Also](#seealsobookmark)  [Members](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile5_members.html)   [Example](#ExampleBookmark) | |
...
* inherits from [IEdmObject5](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmObject5.html).* is extended by [IEdmFile6](EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmFile6.html) which provides the ability to move, rename, and categorize files.
