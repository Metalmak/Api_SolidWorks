...
If your Visual Studio project uses the [primary interop assembly](GettingStarted-epdmapi.html)
...
* Reference **EPDM.Interop.epdm.dll** and **EPDM.Interop.EPDMResultCode.dll** by:
  ...
  2. Selecting **Add
     Reference.**
  3. Selecting **Framework**
     in the left-side panel.
  4. Clicking **Browse** and navigating
...
* Change the version of .NET
  ...
  Frameworks 4.5 de-select **Prefer 32-bit**:

  + VB.NET:

    - In **Project >** *your\_project\_name*
      **Properties... > Application**,set **Target framework** to **.NET Framework 4.0 or later** (or keep your Visual Studio's default
      setting)
    - In **Project >** *your\_project\_name*
