...
    Private Sub ExecuteTemplateButton\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExecuteTemplateButton.Click
...
            templateMgr = vault1.**CreateUtility**(EdmUtility.EdmUtil\_TemplateMgr)
            Dim pos As IEdmPos5
...
                    If refreshFlag = EdmRefreshFlag.EdmRefresh\_FileList Then
...
                            Case EdmDataType.EdmData\_File
                                row = "Type=File, Path=" + data.**Get**(EdmDataPropertyType.EdmProp\_Path)
                            Case EdmDataType.EdmData\_Folder
                                row = "Type=Folder, path=" + data.**Get**(EdmDataPropertyType.EdmProp\_Path)
                            Case EdmDataType.EdmData\_Variable
                                row = "Type=Variable, Name=" + data.**Get**(EdmDataPropertyType.EdmProp\_Name) + ", Value=" + data.**Get**(EdmDataPropertyType.EdmProp\_Value)
                            Case EdmDataType.EdmData\_Link
                                row = "Type=Link, Name=" + data.**Get**(EdmDataPropertyType.EdmProp\_LinkPath)
                            Case Else
                                row = "No data"
                        End Select
