...
    Private Sub AddFolders\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddFolders.Click
...
                batchAddFolders = vault1.**CreateUtility**(EdmUtility.EdmUtil\_BatchAddFolders)
            End If

            batchAddFolders.**AddFolder**(vault2.**RootFolderID**, TextBox1.Text, i, EdmBatchAddFolderFlag.Ebaff\_GetInterface, Nothing, 0)
            i = i + 1
...
    Public Sub CreateFolders\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CreateFolders.Click
        Try
...
            batchAddFolders.**Create**(Me.Handle.ToInt32, ppoRetFolders, EdmBatchCreateFolderFlag.Ebcf\_Nothing)
