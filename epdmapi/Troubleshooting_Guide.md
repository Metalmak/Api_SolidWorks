...
from HRESULT: 0x80070057 (E\_INVALIDARG)" when my PDM API application
calls a method that passes an array of structures?](#Answer1)
...
interface?forum=csharpgeneral](http://social.msdn.microsoft.com/Forums/vstudio/en-US/1325d24c-db0f-43a1-9780-b68a843d816b/passing-an-array-of-structs-to-a-com-%20%20interface?forum=csharpgeneral).
...
6. Open the task manager and kill **edmserver.exe**, **viewserver.exe**
and **explorer.exe**.
