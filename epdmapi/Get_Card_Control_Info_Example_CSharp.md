...
//  3. Type **CardControlInfo\_CSharp** in **Name**.
...
//  7. Replace the code in **Form1.cs** with [this code](#Form1).
//  8. To create the form, replace the code in **Form1.Designer.cs** with [this code](#Form1.Designer).
...
//     a. Click a file
whose extension has a file data card in the vault.
//     b. Click **Open**.
//  5. Click **Get card information**.
//  6. A message box displays information about the selected
file's data card.
...
// 10. A message box displays information about each edit box
control in the
//     data card.
...
namespace CardControlInfo\_CSharp
{
...
            this.GetCardControls.Click += new System.EventHandler(GetCardControls\_Click);
            //
            //OpenFileDialog1
            //
