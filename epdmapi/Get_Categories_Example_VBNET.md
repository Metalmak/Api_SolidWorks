...
    Public Sub GetCategories\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetCategories.Click
        Try
...
            Categories = vault2.**CreateUtility**(EdmUtility.EdmUtil\_CategoryMgr)
