...
Forms Application**.
//    b. Type **BatchDeleteFiles\_CSharp** in **Name**.
...
//    a. If no errors occur, the selected file and **Folder1**
are moved
//       from the vault to the SOLIDWORKS PDM
recycling bin.
(To see the
//       SOLIDWORKS PDM recycling bin, right-click
your vault, click
//       **Properties**, and click **Deleted
Items**.)
//    b. If an error dialog box pops up, click **OK** to close
it.
...
namespace BatchDeleteFiles\_CSharp
{
...
                batchDeleter = (IEdmBatchDelete3)vault2.**CreateUtility**(EdmUtility.EdmUtil\_BatchDelete);
...
        public void BatchDelete\_Click(System.Object sender, System.EventArgs e)
        {
...
            this.BatchDelete.Click += new System.EventHandler(this.BatchDelete\_Click);
            //
            //OpenFileDialog1
            //
