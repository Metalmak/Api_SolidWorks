...
Add-ins
are stored in the file vault and are downloaded to
...
SOLIDWORKS
 PDM Professional provides a menu command that solves these two problems, **Debug Add-ins**.
...
5. Click **Start external program** and type
   the File Explorer executable's path. For example:
