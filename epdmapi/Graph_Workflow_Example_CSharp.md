...
//    b. Type **PaintWorkflowGraph\_CSharp** in **Name**.
...
//
// Postconditions:
// 1. Displays the Graph
a workflow dialog box.
...
namespace PaintWorkflowGraph\_CSharp
{
...
        public void GraphWorkflow\_Click(System.Object sender, System.EventArgs e)
        {
            //Graph workflow
            try
            {
...
                wfmgr = (IEdmWorkflowMgr6)vault.**CreateUtility**(EdmUtility.EdmUtil\_WorkflowMgr);
                pos = wfmgr.**GetFirstWorkflowPosition**();
                while (!pos.**IsNull**)
                {
                    wf = wfmgr.**GetNextWorkflow**(pos);
...
            this.GraphWorkflow.Click += new System.EventHandler(this.GraphWorkflow\_Click);
            //
            // ListBox1
            //
