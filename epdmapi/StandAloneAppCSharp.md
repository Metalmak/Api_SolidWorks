...
2. Click **File > New > Project** > **Visual C# > Windows Forms App
   ...
   2. Click **Browse** and navigate to the folder where to create the
      project.
   3. Click **OK**.
   4. Right-click the name of your project in the Solution Explorer and select
      **Add Reference**
...
3. Change the
   ...
   2. Click **Application**
      and keep suggested **Target framework** or change it to **.NET Framework 4.5**(or later).
   3. De-select **Prefer 32-bit**.
   4. Click **Yes**.
4. Right-click **Form1.cs**
