...
//  5. Type **SetRevision\_CSharp** in **Name**.
//  6. Click **OK**.
...
// 12. Replace the code in **Form1.cs** with [this code](#Form1).

// 13. Replace the code in **Form1.Designer.cs** with [this code](#Designer).
...
        private void SetRevision\_CSharp\_Load(System.Object sender, System.EventArgs e)
    {
...
    private void SetInitialRevisionButton\_Click(System.Object sender, System.EventArgs e)
    {
...
            PathList = vault.**BrowseForFile**(this.Handle.ToInt32(), (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitMultipleSel + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles, "SOLIDWORKS files " + "(\*.sldprt; \*.sldasm; \*.slddrw)|" + "\*.sldprt;\*.sldasm;\*.slddrw|" + "All Files (\*.\*)|\*.\*||", "", "", vault.RootFolderPath, "Select Files to Set Initial Revision on");
...
                RevMgr = (IEdmRevisionMgr2)((IEdmVault7)vault).**CreateUtility**(EdmUtility.EdmUtil\_RevisionMgr);
...
            this.SetInitialRevisionButton.Click += new System.EventHandler(this.SetInitialRevisionButton\_Click);
            //
            // Form1
            //
...
            this.Load += new System.EventHandler(this.SetRevision\_CSharp\_Load);
