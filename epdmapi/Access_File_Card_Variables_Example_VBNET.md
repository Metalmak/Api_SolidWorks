...
'
' Postconditions:
' 1. Displays the Access file
variables dialog box.
'    a. Select a vault view.
'    b. Click **Browse**.

'       1. Locate and click a file
in the vault.
'       2. Click **Open**.
'    c. Click **Get variables**.
'       1. Checks out the selected file in the root
folder of the vault.
...
    Public Sub GetVars\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetVars.Click
        Try
...
                aFile.**LockFile**(parentFolder.**ID**, Me.Handle.ToInt32(), EdmLockFlag.EdmLock\_Simple)
