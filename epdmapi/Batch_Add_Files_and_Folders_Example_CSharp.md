...
//     b. Type **BatchAddFiles\_CSharp** in **Name**.
...
// Postconditions:
//  1. The Batch
add files to vault dialog box displays.
...
outside the vault.
//        2. Click **Open**.
//     d. Click **Select file inside vault to copy to vaul**t.
...
message box.
//     Two new folders, **Folder1** and **Folder2**,
are created in the vault's
//     root directory. The first selected file is copied to
**Folder1**.
...
namespace BatchAddFiles\_CSharp
{
...
        public void CopyToVault\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                //If the user did
not click Open, exit this subroutine
                if (!(DialogResult == System.Windows.Forms.DialogResult.OK))
                {
                    return;
                }

                batchAdder = (IEdmBatchAdd2)vault2.**CreateUtility**(EdmUtility.EdmUtil\_BatchAdd);

                // Add Folder1 to the batch
                string newFolder = vault1.**RootFolderPath** + "\\Folder1";
                batchAdder.**AddFolderPath**(newFolder, 0, (int)EdmBatchAddFolderFlag.Ebaff\_Nothing);
...
            }
        }
        public void CopyFromVault\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                batchAdder.**AddFolder**(vault1.**RootFolderID**, "Folder2", 0, (int)EdmBatchAddFolderFlag.Ebaff\_Nothing);
...
        public void BatchAdd\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                batchAdder.**ShowDlg**(this.Handle.ToInt32(), (int)EdmAddFileDlgFlag.Eafdf\_Nothing, "Files and folders in the batch:", "Batch Items");
...
            this.BatchAdd.Click += new System.EventHandler(this.BatchAdd\_Click);
            //
            //CopyToVault
            //
...
            this.CopyToVault.Click += new System.EventHandler(this.CopyToVault\_Click);
            //
            //FileList1
            //
...
            this.CopyFromVault.Click += new System.EventHandler(this.CopyFromVault\_Click);
            //
            //FileList2
            //
