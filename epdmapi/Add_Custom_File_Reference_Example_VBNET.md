...
            Dim addCustRefs As IEdmAddCustomRefs = DirectCast(vault2.CreateUtility(EdmUtility.**EdmUtil\_AddCustomRefs**), IEdmAddCustomRefs)
...
                    file.**LockFile**(parentFolder.**ID**, Me.Handle.ToInt32(), CInt(EdmLockFlag.EdmLock\_Simple))
                End If
...
                addCustRefs.**CreateTree**(CInt(EdmCreateReferenceFlags.Ecrf\_Nothing))
