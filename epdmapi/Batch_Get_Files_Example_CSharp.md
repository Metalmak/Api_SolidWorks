...
Forms Application**.
//    b. Type **BatchGetFiles\_CSharp** in **Name**.
...
//        1. Click a
couple of files inside the vault.
//        2. Click **Open**.
...
namespace BatchGetFiles\_CSharp
{
...
                batchGetter = (IEdmBatchGet)vault2.**CreateUtility**(EdmUtility.EdmUtil\_BatchGet);
...
        public void BatchGet\_Click(System.Object sender, System.EventArgs e)
        {
...
                if ((batchGetter != null))
                {
                    batchGetter.**CreateTree**(this.Handle.ToInt32(), (int)EdmGetCmdFlags.Egcf\_Lock);

                    fileCount = batchGetter.**FileCount**;
                    fileList = (IEdmSelectionList6)batchGetter.**GetFileList**((int)EdmGetFileListFlag.Egflf\_GetLocked + (int)EdmGetFileListFlag.Egflf\_GetFailed + (int)EdmGetFileListFlag.Egflf\_GetRetrieved + (int)EdmGetFileListFlag.Egflf\_GetUnprocessed);
...
            this.BatchGet.Click += new System.EventHandler(this.BatchGet\_Click);
            //
            //OpenFileDialog1
            //
