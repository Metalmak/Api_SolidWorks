...
// 4. Type **CardVariables\_CSharp** in **Name**.
...
//       and click **OK**).
//    b. Add **Microsoft.VisualBasic**
and **System.Windows.Forms** as a references (click **Assemblies
> Framework** in the
//       left-side panel, click **System.Windows.Forms**
and **Microsoft.VisualBasic**, and click **OK**).
//    c. Click **Close**.
...
//    c. On the Build tab,
select **Any CPU**, de-select **Prefer 32-bit**, and
...
off >** *vault\_name*.
// 5. Open File Explorer on a view of *vault\_name* to:
//    a. Log in as Admin.
//    b. Create, check in,
and check out a file whose data card contains **Project Name**
//       and **Project Number**.
...
            poCmdMgr.**AddHook**(EdmCmdType.EdmCmd\_CardInput);
...
    readonly Microsoft.VisualBasic.CompilerServices.StaticLocalInitFlag static\_OnCmd\_VariableChangeInProgress\_Init = new Microsoft.VisualBasic.CompilerServices.StaticLocalInitFlag();

    //A data card variable value has changed
    bool static\_OnCmd\_VariableChangeInProgress;
...
                    lock (static\_OnCmd\_VariableChangeInProgress\_Init)
                    {
                        try
                        {
                            if (InitStaticVariableHelper(static\_OnCmd\_VariableChangeInProgress\_Init))
                            {
                                static\_OnCmd\_VariableChangeInProgress = false;
                            }
                        }
                        finally
                        {
                            static\_OnCmd\_VariableChangeInProgress\_Init.State = 1;
                        }
                    }
...
                        case "Project Name":
                            if (static\_OnCmd\_VariableChangeInProgress == true)
                            {
                                static\_OnCmd\_VariableChangeInProgress = false;
                                break;
                            }
...
                            {
                                static\_OnCmd\_VariableChangeInProgress = true;
