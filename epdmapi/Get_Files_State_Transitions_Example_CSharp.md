...
// 8.
Displays a message box showing whether the logged-in
user must
//    add comment when transitioning the selected file to one of
its next
//    possible states.
...
        void Form1\_Load(System.Object sender, System.EventArgs e)
        {
...
        public void GetTransitionButton\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                userMgr = (IEdmUserMgr10)vault2.**CreateUtility**(EdmUtility.EdmUtil\_UserMgr);
...
            this.GetTransitionButton.Click += new System.EventHandler(GetTransitionButton\_Click);
            //
            //OpenFileDialog1
            //
