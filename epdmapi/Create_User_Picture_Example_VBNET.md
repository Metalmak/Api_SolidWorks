...
'
' Postconditions:
' 1. Displays the Get Admin's picture
dialog box.
...
            poUserMgr = vault2.**CreateUtility**(EdmUtility.EdmUtil\_UserMgr)
...
        Dim poUserMgr As IEdmUserMgr8
        poUserMgr = poVault.**CreateUtility**(EdmUtility.EdmUtil\_UserMgr)
