...
//    f. Replace the code in **Form1.cs**
with [this code](#Form1).
//    g. To create the form, replace the code
in **Form1.Designer.cs** with
//       [this code](#Form1.Designer).
...
//    **Permit** in Task Host Configuration dialog.
(Right-click the SOLIDWORKS PDM
//    icon on the notification tool bar and select **Task Host
Configuration**.)
...
// 4. Click **Select Files** to select any files that are required for the
task.
// 5. Click **Run Task**.
//----------------------------------------------------------------------------
...
                TaskMgr = (IEdmTaskMgr)vault20.CreateUtility(EdmUtility.EdmUtil\_TaskMgr);
...
                (int)EdmBrowseFlag.EdmBws\_ForOpen + (int)EdmBrowseFlag.EdmBws\_PermitMultipleSel + (int)EdmBrowseFlag.EdmBws\_PermitVaultFiles,
...
                selection[counter].meType = EdmObjectType.EdmObject\_File;
            }
...
            this.button3.Click += new System.EventHandler(this.button3\_Click);
            //
            // label1
            //
