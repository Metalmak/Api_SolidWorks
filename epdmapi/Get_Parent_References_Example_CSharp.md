...
//    b. Type **GetParentReferences\_CSharp** in **Name**.
...
// 7. Displays the references of the
selected part.
// 8. Click **OK**.
// 9. Close the Get
parent references dialog.
...
namespace GetParentReferences\_CSharp
{
...
        public void GetParentReferences\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
                pos = @ref.**GetFirstParentPosition2**(0, false, (int)EdmRefFlags.EdmRef\_File + (int)EdmRefFlags.EdmRef\_Item + (int)EdmRefFlags.EdmRef\_Dynamic + (int)EdmRefFlags.EdmRef\_Static);
                while (!pos.**IsNull**)
                {
...
            this.GetParentReferences.Click +=new System.EventHandler(GetParentReferences\_Click);
            //
            //Form1
            //
...
            this.Load +=new System.EventHandler(Form1\_Load);
