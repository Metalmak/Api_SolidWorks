...
[https://msdn.microsoft.com/en-us/library/bb822049(v=vs.110).aspx](https://msdn.microsoft.com/en-us/library/bb822049%28v%3Dvs.110%29.aspx).
...
> 2. Right-clicking **References > EPDM.Interop.epdm**
>    in the Solution Explorer
>    and selecting **Properties**.
> 3. Setting **Embed Interop Types** to **False** in
>    Properties.
> 4. Right-clicking **References > EPDM.Interop.EPDMResultCode**
>    in the Solution Explorer
>    and selecting **Properties**.
> 5. Setting **Embed Interop Types** to **False** in
>    Properties.
...
> 3. Navigate to **C:\Program Files\Microsoft SDKs\Windows\v***x.x***\Bin**
>    in which the earlier .NET Framework version of **TlbImp.exe** is
>    installed.
> 4. Type **TlbImp.exe** *install\_dir***\EdmInterface.dll /sysarray /out:Interop.EdmLib.dll /namespace:EdmLib.**
...
* C++
  ...
  5. Configure **Module Definition File** to point to the add-in's *project\_name***.def**.
  6. Save the project.
