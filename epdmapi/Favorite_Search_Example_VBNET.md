...
'  7. Replace the code in **Form1.vb**with [this code](#Form).
'  8. To create the form, replace the code in **Form1****.Designer.vb** with [this code](#Designer).
...
'     finds at least one vault file whose extension  (e.g.,
sldprt)
'     has a file data card (e.g. Quick
Start Data Card) with a Description field.
...
'     (Right-click on **Admin Tool >** *vault\_name* **> Columns > Search Result Columns** and select **New Column Set**.
' 14. Click **Add** and select **Description** from
the Variable dropdown
' 15. Save the new column set with name, **MyFavoriteSearchResults**.
' 16. Double-click **Admin Tool >** *vault\_name* **> Cards > Search Cards > Complete Search**.
...
'  5. Displays search results, including the custom search column,
Description.
'  6. Close the dialog.
'----------------------------------------------------------------------------
...
DirectCast(VaultsComboBox.Items(0),
...
Public
Sub PerformSearch\_Click(ByVal
sender
As
System.Object,
...
Dim oSearchResult
As
IEdmSearchResult6 = oSearch.**GetFirstFavoriteResult**(TextBox1.Text,

True)

'get custom search result columns, if present

Do

'oSearchResult will have
default values like path or ID, even if custom columns do not exist
...
ListBox1.Items.Add(oColsInfo(i).mbsCaption &
...
oSearchResult = oSearch.**GetNextResult**()
'Get next result
...
Me.VaultsLabel.AutoSize =

True

Me.VaultsLabel.Location =
...
Me.VaultsComboBox.FormattingEnabled
=

True

Me.VaultsComboBox.Location =

New
System.Drawing.Point(39, 40)

Me.VaultsComboBox.Name =

"VaultsComboBox"

Me.VaultsComboBox.Size =
...
Me.PerformSearch.Location =

New
System.Drawing.Point(215, 101)

Me.PerformSearch.Name =

"PerformSearch"

Me.PerformSearch.Size =
...
Me.PerformSearch.Text =

"Perform Search"

Me.PerformSearch.UseVisualStyleBackColor
=
...
Me.ListBox1.HorizontalScrollbar =
...
Me.ListBox1.ScrollAlwaysVisible =
...
Friend
WithEvents VaultsLabel

As
System.Windows.Forms.Label

Friend
WithEvents VaultsComboBox

As
System.Windows.Forms.ComboBox

Friend
WithEvents PerformSearch
