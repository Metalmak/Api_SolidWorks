...
//    b. Type **AccessCustRef\_CSharp** in **Name**.
...
replace the code in **Form1.Designer.cs** with
//       [this code](#Form1.Designer.cs).
// 2. Add references to:
//    b. **EPDM.Interop.epdm.dll** (click **Browse** and browse to the top
folder
//       of your SOLIDWORKS PDM Professional installation, click
//    **EPDM.Interop.epdm.dll** > **Add**).
//    c. **EPDM.interop.EPDMResultCode.dll** (click
**Browse >**
...
// Postconditions:
// 1. Displays
the Add custom file reference dialog box.
//
...
namespace AccessCustRefs\_CSharp
{
...
                if (!file1.**IsLocked**)
                {
                    file1.**LockFile**(parentFolder.**ID**, this.Handle.ToInt32(), Convert.ToInt32(EdmLockFlag.EdmLock\_Simple));
                }
...
            this.AddCustomFileReference.Click +=new System.EventHandler(AddCustomFileReference\_Click);
            //
