...
'        3. **Browse for
add-in** button to **BrowseButton**.
'        4. List box to **AddinListBox**.
'        5. **Install add-in** button to **LoadAddin**.
'     g. Replace the code in **Form1.vb** with [this code](#form1).
'     h. Replace the code in **Form1.Designer.vb** with [this code](#form1designer).
...
'        A message box containing information
about each add-in installed in
...
    Public Sub LoadAddin\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoadAddin.Click
        Try
...
            AddinMgr.**AddAddIns**(fileList, EdmAddAddInFlags.EdmAddin\_AddAllFilesToOneAddIn, Nothing)
