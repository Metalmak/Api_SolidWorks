...
//    of your SOLIDWORKS PDM Professional installation, locate and
click
//    **EPDM.Interop.epdm.dll**, click **Open**, and click **Add**).
// 4. Right-click **EPDM.Interop.epdm** in References, click **Properties**,
and set
...
//    To inspect the
existing layouts:
//    a. Open the SOLIDWORKS PDM Professional
Administration tool.
//    b. Log into *vault\_name*.
//    c. Expand *vault\_name***> Bills of Materials.**//    d. Verify that layout, BOM, exists.
...
//    a. Open File Explorer on a *vault\_name* view.
//    b. Click the assembly.
//    c. Click the **Bill of Materials**
tab.
//    d. Click **BOM**.
//    e. If a named Bill of Materials does not exist in the BOM
list:
//       1. Click **Save > Save As** in
the tab toolbar.
...
//    a. Select a *vault\_name* view.
//    b. Click **Select file**.
//    c. In the Select File dialog:
//       1. Click the assembly specified in
Preconditions step 6.
//       2. Click **Open**.
//    d. Click **Get BOM Info**.
//       Displays message boxes containing:
//       \* Information about all named BOMs of the
assembly.
//       \* Version information for the named BOMs.
//       \* Information about all BOM layouts in
the vault.
//       \* Row and column information about a BOM
view in the BOM layout
//         for the selected assembly in
its @ configuration.
...
// 3. Verify that **c:\temp\SavedBOM.csv**
is created.
//----------------------------------------------------------------------------
...
        public void SelectFiles\_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
...
        public void GetBOM\_Click(System.Object sender, System.EventArgs e)
        {
...
                    bom = (IEdmBom)vault2.**GetObject**(EdmObjectType.EdmObject\_BOM, id);
                    str = "Named BOM: " + derivedBOMs[i].**mbsBomName** + "\r\n" + "Type
of BOM as defined in EdmBomType: " + derivedBOMs[i].**meType**
+ "\\n"
...
                bomMgr = (IEdmBomMgr2)vault2.**CreateUtility**(EdmUtility.EdmUtil\_BomMgr);
...
str = str + "  Logged-in user can see this
layout? " + canSeeLayout;
                    if (ppoRetLayout.**mbsLayoutName** == "BOM")
                    {
                        bomView = (IEdmBomView3)aFile.**GetComputedBOM**(ppoRetLayout.**mbsLayoutName**, 0, "@", (int)EdmBomFlag.EdmBf\_AsBuilt + (int)EdmBomFlag.EdmBf\_ShowSelected);
                    }
                    MessageBox.Show(str);
                    i = i + 1;
                }
...
        public void SaveBOM\_Click(System.Object sender, System.EventArgs e)
        {
...
            this.SelectFiles.Click += new System.EventHandler(this.SelectFiles\_Click);
            //
            // File1List
            //
...
            this.GetBOM.Click += new System.EventHandler(this.GetBOM\_Click);
            //
            // OpenFileDialog1
            //
...
            this.SaveBOM.Click += new System.EventHandler(this.SaveBOM\_Click);
            //
            // Form1
            //
