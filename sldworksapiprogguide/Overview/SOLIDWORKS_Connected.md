...
* SOLIDWORKS Connected opens **3D**EXPERIENCE
  ...
  ISldWorks::OpenDoc7 and
  IDocumentSpecification Remarks.
...
' 2. Use **3D**EXPERIENCE **3D**Search to find
**NonActiveSave.sldprt** on the **3D**EXPERIENCE
platform.
...
swApplicationType\_3DEXPERIENCE Then
...
' 5. Press F5 to reopen the
**3D**EXPERIENCE document.

' Postconditions: **NonActiveSave.sldprt** is re-opened from the
...
Also see the
IPLMObjectSpecification .NET examples.