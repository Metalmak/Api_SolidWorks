...
3. In the left panel of the New Project dialog, select:
   ...
   * Visual C#, scroll to the end of the middle panel, and select
     [SwCSharpAddin add-in template](Using_SolidWorks_C__Add-In_Wizard_to_Create_C__Add-In.htm).
   * Visual Basic, scroll to the end of the middle panel, and
     select
     [SwVBAddin
     add-in template](Using_SolidWorks_VB.NET_Add-In_Wizard_to_Create_VB.NET_Add-In.htm).
...
8. Notice that SwAddin uses or imports SolidWorksTools. The SOLIDWORKS
   API SDK installs **SolidWorksTools.dll** in *install\_dir*. The
