...
add-in wizard](SolidWorks_API_Add-Ins%2C_Project_Templates%2C_and_Wizards.htm).
...
>   [How to use the
>   Regsvr32 tool and troubleshoot Regsvr32 error messages](https://support.microsoft.com/en-us/kb/249873) for details.
>
> > Register the
> > add-in's CLSID in **HKEY\_LOCAL\_MACHINE\SOFTWARE\SOLIDWORKS\AddIns** and set
...
>   [Registering Assemblies with COM](https://msdn.microsoft.com/en-us/library/h627s4zy%28v%3Dvs.110%29.aspx) for details.
...
1. Call ISldWorks::SetAddinCallbackInfo
...
1. Calls ISwAddin::DisconnectFromSW,
