...
that your implementation of IPropertyManagerPage2Handler8
must know which page is currently in use and act accordingly within the
IPropertyManagerPage2Handler8::OnNextPage
and IPropertyManagerPage2Handler8::OnPreviousPage
callbacks.
