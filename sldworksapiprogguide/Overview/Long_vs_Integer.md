...
|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| **Programming Language** | 16-bit Data Type | | 32-bit Data Type | | 64-bit Data Type | |
| C# |  |  | int | Int32 | long | Int64 |
|  |  |  |  |  |  |  |
| Managed C++ |  |  | long | Int32 | LONGLONG (=\_\_int64) | Int64 |
|  |  |  | int | Int32 |  |  |
| Unmanaged C++ |  |  | long | N/A | LONGLONG (=\_\_int64) | N/A |
|  |  |  | int | N/A |  |  |
...
See
[VBA and SOLIDWORKS x64](VBA_and_SolidWorks_x64.htm) for more information about the LongPtr variable type
and VBA.