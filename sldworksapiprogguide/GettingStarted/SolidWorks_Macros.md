...
* Microsoft Visual
  ...
  + [SOLIDWORKS 2018 offers Visual Studio Tools for
    Applications (VSTA)](VSTA_2015.htm), impacting how VB.NET and C# macros are developed and
  ...
  + When debugging Microsoft VSTA macros with user-interface
    ...
    Options >
    System
    Options dialog) or set swUserPreferenceToggle\_e.swStopDebuggingVstaOnExit
...
1. Plan the user-interface actions before recording
   them.
2. [Record](Record_Solidworks_Macro.htm)
