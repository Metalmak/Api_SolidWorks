...
| DPDMDocManagerEvents\_AfterDeletingDocumentEventHandler Delegate (SolidWorks.Interop.swbrowser) | |
...
|  |
| --- |
| [SolidWorks.Interop.swbrowser Namespace](SolidWorks.Interop.swbrowser~SolidWorks.Interop.swbrowser_namespace.html) : DPDMDocManagerEvents\_AfterDeletingDocumentEventHandler Delegate (SolidWorks.Interop.swbrowser) |
...
*fileName*
:   Path and file name of document deleted
...
See AfterDeletingDocument Event (PDMDocManager).
