...
| DPDMDocManagerEvents\_AfterCopyingDocumentEventHandler Delegate (SolidWorks.Interop.swbrowser) | |
...
|  |
| --- |
| [SolidWorks.Interop.swbrowser Namespace](SolidWorks.Interop.swbrowser~SolidWorks.Interop.swbrowser_namespace.html) : DPDMDocManagerEvents\_AfterCopyingDocumentEventHandler Delegate (SolidWorks.Interop.swbrowser) |
...
See AfterCopyingDocument Event (PDMDocManager).
