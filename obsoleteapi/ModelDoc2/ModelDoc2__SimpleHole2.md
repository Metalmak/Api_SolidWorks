...
| Input: | (long) t1 | Termination type for first end as defined in the swEndConditions\_e |
| Input: | (long) t2 | Termination type for second end as defined in the swEndConditions\_e |
