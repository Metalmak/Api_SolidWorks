...
by ModelDoc2::FeatureExtruRefSurface2.
...
| Input: | (long) t1 | Termination type for first end as defined swEndConditions\_e |
| Input: | (long) t2 | Termination type for second end as defined swEndConditions\_e |
