...
This
method is obsolete and has been superseded by [ModelDoc2:InsertCutBlend4](ModelDoc2__InsertCutBlend4.htm).
...
| Input: | (double) tessToleranceFactor | Factor to control the number of intermediate sections used for loft with centerline; the default value is 1.0; the greater the variable, the more intermediate sections created |
...
|  |  |  |
| --- | --- | --- |
| Input: | (VARIANT\_BOOL) closed | TRUE for a closed loft, FALSE for an open loft |
| Input: | (Boolean) keepTangency | Controls whether the section curves are tangent |
