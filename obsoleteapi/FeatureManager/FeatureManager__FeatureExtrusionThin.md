...
by FeatureManager::FeatureExtrusionThin2.
...
| Input: | (VARIANT\_BOOL) dir | Reverse direction  TRUE if you want Direction1 to be opposite the default direction (see Remarks) |
...
| Input: | (VARIANT\_BOOL) addBends | TRUE to add auto bends (open profile base features only), FALSE to not |
