...
If this face is periodic and crosses the seam (0 and 360°
...
for the next trimmed surface, if one exists. See the packedDouble8
parameter to determine the number of surfaces for this face.
...
If your program calls both [Face::GetEdges](../Face/Face__GetEdges.htm)
and this method or to both [Face::EnumEdges](../Face/Face__EnumEdges.htm)
and this method, then this method
...
by comparing the number of edges on the face, [Face::GetEdgeCount](../Face/Face__GetEdgeCount.htm)
, with the number of trim (SP) curves on the face, PackedDouble1.
...
by comparing the value returned by Face::GetEdgeCount with PackedDouble1
