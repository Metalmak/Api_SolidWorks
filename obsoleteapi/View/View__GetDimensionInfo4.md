...
This
method is obsolete and has been superseded by [View::GetDimensionInfo5](View__GetDimensionInfo5.htm).
...
of doubles contained in the array will be (1 + dimensionCount
\* 51).
...
dimensionType =
will return 0 = Linear, 1 = Angular, 2 = Radial, 3 = Ordinate.
...
returned will be the diameter value; if FALSE, then the dimValue
