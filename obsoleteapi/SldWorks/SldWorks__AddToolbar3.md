...
| Input: | (long) Cookie | Resource ID of the toolbar; this is the same cookie you specified in SwAddin::ConnectToSW |
...
| Input: | (long) DocumentType | Bitwise values indicating what frame window types should have this toolbar's name added to its View, Toolbars menu; values from swDocTemplateTypes\_e |
...
* Adds the
  toolbar name to the View, Toolbars
  menu.
* Only creates
