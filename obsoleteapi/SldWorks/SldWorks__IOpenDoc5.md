...
This
method is obsolete and has been superseded by SldWorks::OpenDoc6.
...
| Input: | (long) type | Document type as defined in swDocumentTypes\_e enum |
...
have not been set using Tools, Options,
...
Interactively performing File,
Open immediately sets the current working directory to that of
...
any of the OpenDoc methods versus performing File,
Open interactively. Because of this, you might want to consider
