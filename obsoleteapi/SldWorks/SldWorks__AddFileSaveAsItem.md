...
by SldWorks::AddFileSaveAsItem2.

Description

This method adds a file type to the SolidWorks Save
As dialog window. When a file of the type specified is selected
...
| Input: | (long) Type | Type of document to save as defined in swDocumentTypes\_e |
