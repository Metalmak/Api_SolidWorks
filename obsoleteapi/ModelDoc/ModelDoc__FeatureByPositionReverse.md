...
This
method is obsolete and has been superseded by ModelDoc2::FeatureByPositionReverse.

Description

This method returns the nth
from last feature in the document.
...
|  |  |  |
| --- | --- | --- |
| Input: | (long) positionFromEnd | Number of feature from last in the FeatureManager design tree; 0  gives last in the FeatureManager design tree |
...
you should not assume that the last feature in the list is  always
the Annotations folder. In addition, because feature names are customizable,
you cannot assume that the first reference plane feature is named Plane1 or that the Annotations folder
is called Annotations. See Feature::GetTypeName
...
as 1. This allows you to obtain the newly created fillet feature,  which
...
design tree and access to subfeatures, see [ModelDoc::FirstFeature](ModelDoc__FirstFeature.htm)
