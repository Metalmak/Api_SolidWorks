...
This
method is obsolete and has been superseded by ModelDoc2::InsertRib2.
...
| Input: | (BOOL) isNormToSketch | TRUE if the rib will be normal to the sketch, FALSE if the rib will be parallel to the sketch |
...
| Input: | (double) draftAngle | Draft angle applied to the rib |
| Input: | (VARIANT\_BOOL) isNormToSketch | TRUE if the rib will be normal to the sketch, FALSE if the rib will be parallel to the sketch |
