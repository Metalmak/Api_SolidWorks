...
| Return: | (BOOL) accessGained | TRUE if the selections are successfully accessed, FALSE if not |
...
| Output: | (VARIANT\_BOOL) accessGained | TRUE if the selections were successfully accessed, TRUE if not |
