...
' 3. Substitute *part\_path\_and\_filename*with the filename
...
    Dim i As Integer
    Dim j As Integer
    Const docPath As String = "*part\_path\_and\_filename*"
...
        brokenStatus = dmExtRefOption.**BrokenStatus**refIDs = dmExtRefOption.**IDs**
