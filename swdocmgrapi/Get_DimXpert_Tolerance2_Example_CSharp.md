...
//
c. Click **Create Compound Plane** on the DimXpert pop-up toolbar.
...
//    d.
Click in the **Primary Datum** field; select face in front of

//       right hole.

//    e.
Click in the **Secondary Datum** field; select top face of block.
...
//    h.
Observe the following DimXpert annotations:  **Diameter1**,
...
//       i.   Select **Symmetry** from the
**Symbol** dropdown list.

//       ii.  Type
**A** for the Primary Datum.

//       iii.
Click the face in front of the right hole.

//       iv.  Click outside the part to place the annotation.

//       v.   Click **OK** to close the Geometric Tolerance Properties dialog.
