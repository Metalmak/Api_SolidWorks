...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetFileAvgTime](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument22~GetFileAvgTime.html) | Gets the amount of time it took to open this document the last time. |
| ![ Method](dotnetimages/Method.gif) | [IsCustomPropertyEditable](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument22~IsCustomPropertyEditable.html) | Gets whether the specified custom property is editable. |
