...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMConfiguration10 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetDisplayStates](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration10~GetDisplayStates.html) | Gets the names of the display states for this configuration. |
| ![ Method](dotnetimages/Method.gif) | [IsDirty](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration10~IsDirty.html) | Gets whether this configuration is dirty (i.e., needs to be updated). |
