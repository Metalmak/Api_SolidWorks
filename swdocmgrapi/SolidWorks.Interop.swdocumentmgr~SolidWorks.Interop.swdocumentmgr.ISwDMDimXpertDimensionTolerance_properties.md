<!-- source: swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance_properties.html -->
...
| ISwDMDimXpertDimensionTolerance Interface Properties | |
...
For a list of all members of this type, see [ISwDMDimXpertDimensionTolerance members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance_members.html).

# ![](dotnetimages/collapse.gif)Public Properties

|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [BlockToleranceDecimalPlaces](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance~BlockToleranceDecimalPlaces.html) | Gets the precision of the block tolerance of this DimXpert dimension tolerance. |
| ![ Property](dotnetimages/Property.gif) | [DimensionType](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance~DimensionType.html) | Gets the type of this DimXpert dimension tolerance. |
| ![ Property](dotnetimages/Property.gif) | [LimitsAndFitsCode](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertDimensionTolerance~LimitsAndFitsCode.html) | Gets the limits and fits code for this DimXpert dimension tolerance. |
