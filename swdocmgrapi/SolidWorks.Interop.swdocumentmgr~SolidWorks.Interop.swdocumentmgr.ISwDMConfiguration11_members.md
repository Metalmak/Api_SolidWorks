...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMConfiguration11 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [BOMPartNoSource](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11~BOMPartNoSource.html) | Gets or sets the source of the part number used in the bill of materials (BOM) for this configuration. |
| ![ Property](dotnetimages/Property.gif) | [ShowChildComponentsInBOM](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11~ShowChildComponentsInBOM.html) | Obsolete. Superseded by [ISwDMConfiguration15::ShowChildComponentsInBOM2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration15~ShowChildComponentsInBOM2.html). |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetReplacedComponents](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11~GetReplacedComponents.html) | Gets information about the components that were replaced by [ISwDMComponent6::Replace](SOLIDWORKS.Interop.swdocumentmgr~SOLIDWORKS.Interop.swdocumentmgr.ISwDMComponent6~Replace.html). |
| ![ Method](dotnetimages/Method.gif) | [IsSpeedPak](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11~IsSpeedPak.html) | Gets whether this configuration is a SpeedPak. |
