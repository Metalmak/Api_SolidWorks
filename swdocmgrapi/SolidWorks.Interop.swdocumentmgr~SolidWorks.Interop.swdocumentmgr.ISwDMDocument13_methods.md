...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMDocument13 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetAllExternalReferences4](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13~GetAllExternalReferences4.html) | Obsolete. Superseded by [ISwDMDocument13::GetAllExternalReferences5](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument21~GetAllExternalReferences5.html). |
| ![ Method](dotnetimages/Method.gif) | [GetCutListItems2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13~GetCutListItems2.html) | Obsolete. Superseded by [ISwDMConfiguration16::GetCutListItems](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration16~GetCutListItems.html). |
| ![ Method](dotnetimages/Method.gif) | [GetExternalDesignTable](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13~GetExternalDesignTable.html) | Gets the path to an external (i.e., linked) design table, if one exists. |
| ![ Method](dotnetimages/Method.gif) | [GetLastUpdateTimeStamp](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13~GetLastUpdateTimeStamp.html) | Gets the last update stamp for this document. |
| ![ Method](dotnetimages/Method.gif) | [GetSheetFormatPath](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13~GetSheetFormatPath.html) | Gets the path and filename of the sheet format used for the specified sheet. |
| ![ Method](dotnetimages/Method.gif) | [GetSheetProperties](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13~GetSheetProperties.html) | Gets the specified sheet's properties. |
