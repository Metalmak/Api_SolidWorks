<!-- source: swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12.html -->
...
| ISwDMConfiguration12 Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12_members.html) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMConfiguration12 Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISwDMConfiguration12     Inherits ISwDMConfiguration, ISwDMConfiguration10, ISwDMConfiguration11, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4, ISwDMConfiguration5, ISwDMConfiguration6, ISwDMConfiguration7, ISwDMConfiguration8, ISwDMConfiguration9  ``` | |
...
| C# |  |
| --- | --- |
| ``` public interface ISwDMConfiguration12 : ISwDMConfiguration, ISwDMConfiguration10, ISwDMConfiguration11, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4, ISwDMConfiguration5, ISwDMConfiguration6, ISwDMConfiguration7, ISwDMConfiguration8, ISwDMConfiguration9  ``` | |

| C++/CLI |  |
| --- | --- |
| ``` public interface class ISwDMConfiguration12 : public ISwDMConfiguration, ISwDMConfiguration10, ISwDMConfiguration11, ISwDMConfiguration2, ISwDMConfiguration3, ISwDMConfiguration4, ISwDMConfiguration5, ISwDMConfiguration6, ISwDMConfiguration7, ISwDMConfiguration8, ISwDMConfiguration9  ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See SwDMConfiguration12.

# ![](dotnetimages/collapse.gif)Remarks

* You can access an ISwDMConfiguration12 object by calling QueryInterface on an [ISwDMConfiguration](SOLIDWORKS.Interop.swdocumentmgr~SOLIDWORKS.Interop.swdocumentmgr.ISwDMConfiguration.html) object in C++ or by direct assignment in Visual Basic.

  * The ISwDMConfiguration object can be assigned to an ISwDMConfiguration12 variable, just like the SOLIDWORKS IModelDoc2 object can be assigned to a SOLIDWORKS IPartDoc variable.
