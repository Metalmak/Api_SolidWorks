...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMDocument19 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [Get3rdPartyStorage](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19~Get3rdPartyStorage.html) | Gets an IStream interface to the specified third-party storage of this model document. |
| ![ Method](dotnetimages/Method.gif) | [Get3rdPartyStorageStore](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19~Get3rdPartyStorageStore.html) | Gets the IStorage interface to the specified third-party storage store of this model document. |
| ![ Method](dotnetimages/Method.gif) | [GetSwDmSettingInteger](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19~GetSwDmSettingInteger.html) | Gets the specified document setting. |
| ![ Method](dotnetimages/Method.gif) | [GetSwDmSettingToggle](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19~GetSwDmSettingToggle.html) | Gets the specified document setting. |
| ![ Method](dotnetimages/Method.gif) | [Release3rdPartyStorage](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19~Release3rdPartyStorage.html) | Closes the specified third-party storage. |
| ![ Method](dotnetimages/Method.gif) | [Release3rdPartyStorageStore](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19~Release3rdPartyStorageStore.html) | Closes the specified third-party storage store. |
