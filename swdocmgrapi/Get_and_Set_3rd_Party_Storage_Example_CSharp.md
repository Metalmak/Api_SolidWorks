...
//     b. Click **Browse**
and navigate to the folder where to create
//        the
project.
//     c. Click **OK**.
...
//     c. Click **Browse**.
//     d. Click:
//   *install\_dir***\api\redist\SolidWorks.Interop.swdocumentmgr.dll**//     e. Click **Open.**//     f. Click **Add.**//     g. Click **Browse.**//     h. Click:
//**C:\Program
Files\Microsoft Visual Studio 11.0\Common7\IDE\Remote Debugger\x64\Microsoft.VisualStudio.OLE.Interop.dll**//     i. Click **Open**.//     j. Click  **Add.**//     k. Click **Close.**//  5. Click **Show All Files**
in the Solution Explorer toolbar and expand
//    **Form1.cs** in the
Solution Explorer.
//  6. Replace the code in **Form1.cs**
with [this code](#Form1).
//  7. Replace the code in **Form1.Designer.cs**
with [this code](#Form1Designer).
//  8. Substitute *your\_license\_key* with your SOLIDWORKS Document
...
//     b. Click **Open**.
//  3. Type **temp** in **StoreName**
and in both **StorageName** fields.
//  4. Type **Some third-party text** in both text boxes.
//  5. Click **Write**.
//  6. Click **Exit**.
//  7. Press F5.
//  8. In the dialog, click **Browse**.
//     a. Locate and click the document you clicked
in step 2a.
//     b. Click **Open**.
...
        string  sLicenseKey = "*your\_license\_key*";
        private void btnFile\_Click(System.Object sender, System.EventArgs e)
        {
...
    private void btnOpen\_Click(System.Object sender, System.EventArgs e)
    {
        OpenFile();
        if ((swDoc19 != null)) {
...
    private void btnSave\_Click(System.Object sender, System.EventArgs e)
    {
        OpenFile();
        if ((swDoc19 != null)) {
                if (txtStorageName.Text != string.Empty)
...
    private void btnExit\_Click(System.Object sender, System.EventArgs e)
    {
            this.Close();
    }
...
                IStream pIStream = default(IStream);
                int grfmode = 0;
                grfmode |= (int)STGM.SHARE\_EXCLUSIVE;
...
            SHARE\_DENY\_NONE = 0x00000040,
            SHARE\_DENY\_READ = 0x00000030,
            SHARE\_DENY\_WRITE = 0x00000020,
            SHARE\_EXCLUSIVE = 0x00000010,
            PRIORITY = 0x00040000,
...
            this.btnExit.Click += new System.EventHandler(this.btnExit\_Click);
            //
            // btnSave
            //
...
            this.btnSave.Click += new System.EventHandler(this.btnSave\_Click);
            //
            // btnOpen
            //
...
            this.btnOpen.Click += new System.EventHandler(this.btnOpen\_Click);
            //
            // btnFile
            //
...
            this.btnFile.Click += new System.EventHandler(this.btnFile\_Click);
            //
            // OpenFileDialog1
            //
