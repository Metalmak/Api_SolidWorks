...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMDocument10 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [PreviewPNGStreamName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~PreviewPNGStreamName.html) | Gets the name of the stream for the preview bitmap (.png) of this document. |
| ![ Property](dotnetimages/Property.gif) | [PreviewStreamName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~PreviewStreamName.html) | Gets the name of the stream for the preview bitmap (.bmp) of this configuration. |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetPreviewBitmap](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~GetPreviewBitmap.html) | Gets the preview bitmap (.bmp) for this document. |
| ![ Method](dotnetimages/Method.gif) | [GetPreviewPNGBitmap](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~GetPreviewPNGBitmap.html) | Gets the PNG preview bitmap (.png) for this document. |
| ![ Method](dotnetimages/Method.gif) | [GetSheets](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~GetSheets.html) | Gets the sheets in a drawing document. |
| ![ Method](dotnetimages/Method.gif) | [GetTable](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~GetTable.html) | Gets the specified table. |
| ![ Method](dotnetimages/Method.gif) | [GetTableNames](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~GetTableNames.html) | Gets the names of the tables in this document. |
| ![ Method](dotnetimages/Method.gif) | [GetViews](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10~GetViews.html) | Gets the views in this document. |
