...
'    c.
Click a face perpendicular to the face

'       selected in step 2 (not the
chamfer).
...
'    e.
Find the following in the DimXpert tree: **AngleBetween1**.
...
'       i.
Select **Straightness** from the **Symbol** dropdown

'            list.

'       ii.  In second row, select
**Profile of Line** from
