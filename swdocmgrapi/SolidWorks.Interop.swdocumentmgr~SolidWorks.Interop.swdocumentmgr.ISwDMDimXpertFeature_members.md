<!-- source: swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature_members.html -->
...
| ISwDMDimXpertFeature Interface Members | |
...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMDimXpertFeature Interface |

The following tables list the members exposed by [ISwDMDimXpertFeature](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature.html).

# ![](dotnetimages/collapse.gif)Public Properties

|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [Name](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature~Name.html) | Gets the name of this DimXpert feature. |
| ![ Property](dotnetimages/Property.gif) | [type](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature~type.html) | Gets the type of this DimXpert feature. |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetCadIdentifierCount](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature~GetCadIdentifierCount.html) | Gets the number of CAD identifiers in this DimXpert feature. |
| ![ Method](dotnetimages/Method.gif) | [GetCadIdentifiers](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature~GetCadIdentifiers.html) | Gets all of the CAD identifiers of this DimXpert feature. |
| ![ Method](dotnetimages/Method.gif) | [IGetCadIdentifiers](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature~IGetCadIdentifiers.html) | Gets all of the CAD identifiers of this DimXpert feature. |
| ![ Method](dotnetimages/Method.gif) | [IsSuppressed](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertFeature~IsSuppressed.html) | Gets whether this DimXpert feature is suppressed from the view in the model. |
