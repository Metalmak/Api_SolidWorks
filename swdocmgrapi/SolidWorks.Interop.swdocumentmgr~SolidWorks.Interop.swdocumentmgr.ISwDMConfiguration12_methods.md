<!-- source: swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12_methods.html -->
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetComponentVisibleByDisplayStateName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12~GetComponentVisibleByDisplayStateName.html) | Gets the visibility states and path and file names of the components in the given display state. |
| ![ Method](dotnetimages/Method.gif) | [GetID](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12~GetID.html) | Gets the ID of the configuration. |
| ![ Method](dotnetimages/Method.gif) | [GetLinkedDisplayStates](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12~GetLinkedDisplayStates.html) | Gets the names and number of linked display states. |
