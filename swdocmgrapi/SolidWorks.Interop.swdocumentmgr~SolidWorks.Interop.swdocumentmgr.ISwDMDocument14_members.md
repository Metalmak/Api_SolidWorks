...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMDocument14 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [Get3DCCGenericStreamFile](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14~Get3DCCGenericStreamFile.html) | Exports an XML file with the 3D Content Central (3DCC) generic format configuration rules that were built into this document by the SOLIDWORKS Configuration Publisher. |
| ![ Method](dotnetimages/Method.gif) | [Get3DCCStreamFile](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14~Get3DCCStreamFile.html) | Exports an XML file with the 3D Content Central (3DCC) original format configuration rules built into this document by the SOLIDWORKS Configuration Publisher. |
