...
|  |
| --- |
| [SolidWorks.Interop.swdocumentmgr Namespace](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr_namespace.html) : ISwDMConfiguration7 Interface |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [AlternateName2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~AlternateName2.html) | Gets or sets the user-specified name of the configuration. |
| ![ Property](dotnetimages/Property.gif) | [Comment2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Comment2.html) | Gets or sets the comment for the configuration. |
| ![ Property](dotnetimages/Property.gif) | [Delete](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Delete.html) | Gets or sets whether to mark this configuration as deleted. |
| ![ Property](dotnetimages/Property.gif) | [Name2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~Name2.html) | Gets or sets the name of the configuration. |
| ![ Property](dotnetimages/Property.gif) | [PreviewPNGStreamName](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~PreviewPNGStreamName.html) | Gets the name of the stream for the PNG preview bitmap of this configuration. |
...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetPreviewPNGBitmap](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7~GetPreviewPNGBitmap.html) | Gets the PNG preview bitmap for this configuration. |
