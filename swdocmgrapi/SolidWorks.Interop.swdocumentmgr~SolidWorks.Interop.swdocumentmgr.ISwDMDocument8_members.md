...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetChangedReferences](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument8~GetChangedReferences.html) | Gets a list of the names of the original references and their corresponding new references if the references were changed using the SOLIDWORKS Document Manager API or SOLIDWORKS Explorer. |
| ![ Method](dotnetimages/Method.gif) | [GetComponentCount](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument8~GetComponentCount.html) | Gets the number of components in a SOLIDWORKS assembly document. |
