...
'     a. Type **SwDocMgrStorageApp\_VBNET** in **Name**.
...
'  6. Replace the code in **Form1.vb** with [this code](#Form1).
'  7. Replace the code in **Form1.Designer.vb** with [this code](#Form1Designer).
...
'     b. Click **Open**.
'  3. Type **temp** in **StoreName** and in both **StorageName**
fields.
...
'     b. Click **Open**.
'  9. Type **temp** in **StoreName** and in both **StorageName**
fields.
' 10. Click **Read**.
...
    Public sLicenseKey As String = "*your\_license\_key*"

    Public Sub btnFile\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFile.Click
...
    Public Sub btnOpen\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpen.Click
        OpenFile()
...
    Public Sub btnSave\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        OpenFile()
        If (swDoc19 IsNot Nothing) Then
            If txtStorageName.Text <> String.Empty Then
...
    Public Sub btnExit\_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        Me.Close()
    End Sub
...
            grfmode = grfmode Or CInt(STGM.SHARE\_EXCLUSIVE)
...
        WRITE = &H1
        READWRITE = &H2
        SHARE\_DENY\_NONE = &H40
        SHARE\_DENY\_READ = &H30
        SHARE\_DENY\_WRITE = &H20
        SHARE\_EXCLUSIVE = &H10
        PRIORITY = &H40000
...
        'Me.btnExit.Click += New System.EventHandler(Me.btnExit\_Click)
        '
        ' btnSave
        '
...
        'Me.btnSave.Click += New System.EventHandler(Me.btnSave\_Click)
        '
        ' btnOpen
        '
...
        'Me.btnOpen.Click += New System.EventHandler(Me.btnOpen\_Click)
        '
        ' btnFile
        '
...
        'Me.btnFile.Click += New System.EventHandler(Me.btnFile\_Click)
        '
        ' OpenFileDialog1
        '
