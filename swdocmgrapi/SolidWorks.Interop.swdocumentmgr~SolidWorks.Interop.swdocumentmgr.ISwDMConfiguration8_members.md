...
|  | Name | Description |
| --- | --- | --- |
| ![ Method](dotnetimages/Method.gif) | [GetReferencesInformation2](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration8~GetReferencesInformation2.html) | Gets the names of any reference documents, the configuration names of the references, and their suppression states. |
