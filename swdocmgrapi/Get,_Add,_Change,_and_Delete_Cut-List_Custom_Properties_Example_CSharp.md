...
get cut-list items and their custom properties and how to add, modify, and delete a cut-list custom property.
...
custom properties).
// 4. Add the **SolidWorks.Interop.swdocumentmgr.dll** reference to

//    the project:
//    a. Right-click the solution in Solution Explorer.
//    b. Click **Add Reference**.
//    c. Click **Browse**.
//    d. Click *install\_dir***\api\redist\SolidWorks.Interop.swdocumentmgr.dl**l.
//    e. Click **Add**.
//    f. Click **Close**.
// 5. Substitute *your\_license\_code* with your SOLIDWORKS

//    Document Manager license code.
...
            SwDMDocument10
swDocument10 = default(SwDMDocument10);
            SwDMDocument13
swDocument13 = default(SwDMDocument13);
...
            sLicenseKey =
"*your\_license\_code*";
            // Specify your SOLIDWORKS
Document Manager license key
            sDocFileName = ("C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS
2019\\samples\\tutorial\\weldments\\weldment\_box2.sldprt");
...
            swDocMgr =
(SwDMApplication)swClassFact.**GetApplication**(sLicenseKey);
            swDocument10 = (SwDMDocument10)swDocMgr.GetDocument(sDocFileName,
nDocType, false,
out
nRetVal);
...
            SwDMCutListItem3
Cutlist = default(SwDMCutListItem3);
            int
I = 0;
            SwDmCustomInfoType
nType = 0;
...
            for
(I = 0; I <= vCutListItems.GetUpperBound(0); I++)
            {
...
                    for
(J = 0; J <= vPropNames.GetUpperBound(0); J++)
                    {
                        Debug.Print("
Property Name : " + vPropNames[J]);
                        Debug.Print("
Property Value : " + Cutlist.**GetCustomPropertyValue2**((string)vPropNames[J],
out nType,
out nLink));
                        Debug.Print("
Type : " + nType);
...
                Debug.Print("\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_");
            }

            Cutlist = (SwDMCutListItem3)vCutListItems[0];
            Debug.Print("ADD
CUSTOM PROPERTY CALLED Testing1");
            Debug.Print("
Custom Property added? " + Cutlist.**AddCustomProperty**("Testing1",
...
                Debug.Print("
Property Value : " +
Cutlist.**GetCustomPropertyValue2**((string)vPropNames[J],
out nType,
out nLink));
                Debug.Print("
Type : " + nType);
...
            Debug.Print("\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_");
            Debug.Print("SET
NEW CUSTOM PROPERTY VALUE FOR Testing1");
            Debug.Print("
Property Value Before Setting: " +
Cutlist.**GetCustomPropertyValue2**("Testing1",
out nType,
out nLink));
            Debug.Print("
New Value Set? " + Cutlist.**SetCustomProperty**("Testing1",
"Verify3"));
            Debug.Print("
Property Value After Setting : " +
Cutlist.**GetCustomPropertyValue2**("Testing1",
out nType,
out nLink));
            Debug.Print("
...
            Debug.Print("\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_");
            Debug.Print("DELETE
CUSTOM PROPERTY Testing1");
            Debug.Print("
Delete Property Value? " + Cutlist.**DeleteCustomProperty**("Testing1"));
