<!-- source: swconst/SolidWorks.Interop.swconst~SolidWorks.Interop.swconst.swLocationLabelText_e.html -->
...
| swLocationLabelText\_e Enumeration | |
...
|  |
| --- |
| [SolidWorks.Interop.swconst Namespace](SolidWorks.Interop.swconst~SolidWorks.Interop.swconst_namespace.html) : swLocationLabelText\_e Enumeration |
...
| --- | --- |
| ``` Dim instance As swLocationLabelText_e ``` | |
