...
| swCornerTreatmentTrimType\_e Enumeration | |
...
|  |
| --- |
| [SolidWorks.Interop.swconst Namespace](SolidWorks.Interop.swconst~SolidWorks.Interop.swconst_namespace.html) : swCornerTreatmentTrimType\_e Enumeration |
...
| Member | Description |
| --- | --- |
| **swCornerTreatmentTrim\_BodyTrim** | 1 |
| **swCornerTreatmentTrim\_MiterTrim** | 2 |
| **swCornerTreatmentTrim\_PlanarTrim** | 0 |
