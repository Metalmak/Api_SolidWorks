<!-- source: swconst/SolidWorks.Interop.swconst~SolidWorks.Interop.swconst.swSelectType_e.html -->
...
|  |
| --- |
| [SolidWorks.Interop.swconst Namespace](SolidWorks.Interop.swconst~SolidWorks.Interop.swconst_namespace.html) : swSelectType\_e Enumeration |
...
| --- | --- |
| ``` Dim instance As swSelectType_e ``` | |

| C# |  |
| --- | --- |
| ``` public enum swSelectType_e : System.Enum ``` | |

| C++/CLI |  |
| --- | --- |
| ``` public enum class swSelectType_e : public System.Enum ``` | |
...
| swSelectType\_e | **IModelDocExtension::SelectByID2**  **string** | **ISelectionMgr::GetSelectedObject6** **return value** | **IFeature::GetSpecificFeature2** **return value** |
| --- | --- | --- | --- |
| swSelNOTHING |  |  |  |
| swSelEDGES | "EDGE" | IEdge |  |
| swSelFACES | "FACE" | IFace2 |  |
| swSelVERTICES | "VERTEX" | IVertex |  |
| swSelDATUMPLANES | "PLANE" | Feature[2](#2) | IRefPlane |
| swSelDATUMAXES | "AXIS" | Feature[2](#2) | IRefAxis |
| swSelDATUMPOINTS | "DATUMPOINT" | Feature[1](#1) | No specific interface |
| swSelOLEITEMS | "OLEITEM" | Not Supported |  |
| swSelATTRIBUTES | "ATTRIBUTE" | Feature[1](#1) | IAttribute |
| swSelSKETCHES | "SKETCH" | Feature[2](#2) | ISketch |
...
| swSelSECTIONLINES | "SECTIONLINE" | Feature[1](#1) | IDrSection |
| swSelDETAILCIRCLES | "DETAILCIRCLE" | Feature[1](#1) | IDetailCircle |
| swSelSECTIONTEXT | "SECTIONTEXT" |  |  |
| swSelSHEETS | "SHEET" | ISheet |  |
| swSelCOMPONENTS | "COMPONENT" | IComponent2 |  |
| swSelMATES | "MATE" | Feature[2](#2) | IMate |
| swSelBODYFEATURES | "BODYFEATURE"[3](#3) | Feature[1](#1) | No specific interface |
| swSelREFCURVES | "REFCURVE" | Feature[1](#1) | IReferenceCurve |
| swSelEXTSKETCHSEGS | "EXTSKETCHSEGMENT" | ISketchSegment |  |
| swSelEXTSKETCHPOINTS | "EXTSKETCHPOINT" | ISketchPoint or origin point |  |
| swSelHELIX | "HELIX" |  |  |
| swSelREFERENCECURVES | "REFERENCECURVES" | Feature[1](#1) | IReferenceCurve |
...
| swSelCTHREADS | "CTHREAD" | Feature or ICThread[4](#4) | ICosmeticThreadFeatureData |
...
| swSelCONFIGURATIONS | "CONFIGURATIONS" | Feature[1](#1) | IConfiguration |
| swSelOBJHANDLES |  |  |  |
| swSelARROWS | "VIEWARROW" | IProjectionArrow |  |
| swSelZONES | "ZONES" |  |  |
| swSelREFEDGES | "REFERENCE-EDGE" | IEdge |  |
| swSelREFFACES |  |  |  |
| swSelREFSILHOUETTE |  | Feature[1](#1) |  |
| swSelBOMS | "BOM" |  |  |
...
| swSelSIMELEMENT | "SIMULATION\_ELEMENT" |  |  |
...
| swSelCAMERAS | "CAMERAS" | Feature[1](#1) | ICamera |
...
| swSelSWIFTANNOTATIONS | "SWIFTANN" | Feature[1](#1) | IDimXpertAnnotation |
| swSelSWIFTFEATURES | "SWIFTFEATURE" | Feature[1](#1) | IDimXpertFeature |
...
| swSelGRAPHICSBODY | "MESH BODY FEATURE" |  |  |
| swSelFACETS | "MESHFACETREF" |  |  |
| swSelMESHFACETEDGES | "MESHFINREF" |  |  |
| swSelMESHFACETVERTICES | "MESHVERTEXREF" |  |  |
| swSelMESHSOLIDBODIES | "MSOLIDBODY" |  |  |
| swSelBELTCHAINFEATS | "SKETCHBELT" |  |  |
| swSelADVSTRUCTMEMBER | "ADVSTRUCTMEMBER" |  |  |
