...
|  |
| --- |
| [SolidWorks.Interop.sldcostingapi Namespace](SolidWorks.Interop.sldcostingapi~SolidWorks.Interop.sldcostingapi_namespace.html) > [ICostFeature Interface](SolidWorks.Interop.sldcostingapi~SolidWorks.Interop.sldcostingapi.ICostFeature.html) : CombinedTime Property (ICostFeature) |
...
* equivalent to applying a cost override to this Costing feature.* ignored if the Costing feature disallows applying a cost override. For example, sheet metal Costing features must always return a time of 0; thus, times for sheet metal Costing features cannot be overridden.
