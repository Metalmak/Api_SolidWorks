...
|  |
| --- |
| [SolidWorks.Interop.sldcostingapi Namespace](SolidWorks.Interop.sldcostingapi~SolidWorks.Interop.sldcostingapi_namespace.html) > [ICostAnalysisSheetMetal Interface](SolidWorks.Interop.sldcostingapi~SolidWorks.Interop.sldcostingapi.ICostAnalysisSheetMetal.html) : MaterialCost Property (ICostAnalysisSheetMetal) |
...
See CostAnalysisSheetMetal::MaterialCost.
...
To use the cost of the sheet metal material specified in the Costing template, use [ICostAnalysisSheetMetal::MaterialCostFromTemplate](SOLIDWORKS.Interop.sldcostingapi~SOLIDWORKS.Interop.sldcostingapi.ICostAnalysisSheetMetal~MaterialCostFromTemplate.html).
