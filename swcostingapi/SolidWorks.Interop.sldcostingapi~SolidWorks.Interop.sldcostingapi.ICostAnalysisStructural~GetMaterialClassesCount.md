<!-- source: swcostingapi/SolidWorks.Interop.sldcostingapi~SolidWorks.Interop.sldcostingapi.ICostAnalysisStructural~GetMaterialClassesCount.html -->
...
| GetMaterialClassesCount Method (ICostAnalysisStructural) | |
...
Gets the number of material classes from the Costing template for this structural Costing analysis.

# ![](dotnetimages/collapse.gif).NET Syntax

| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function GetMaterialClassesCount() As System.Integer ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As ICostAnalysisStructural Dim value As System.Integer   value = instance.GetMaterialClassesCount() ``` | |

| C# |  |
| --- | --- |
| ``` System.int GetMaterialClassesCount() ``` | |
...
See CostAnalysisStructural::GetMaterialClassesCount.
