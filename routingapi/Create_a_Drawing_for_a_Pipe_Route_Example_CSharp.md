...
//
(in the
IDE right-click the project,
select **Add Reference**,

//    and browse *install\_dir***\api\redist**).
...
//
add the
locations of your SOLIDWORKS Routing files.
...
in a standard
format and
includes auto balloons, a bill of
...
System.Diagnostics;
namespace
CreatePipeDrawing\_CSharp.csproj
{
    partial
class
SolidWorksMacro
