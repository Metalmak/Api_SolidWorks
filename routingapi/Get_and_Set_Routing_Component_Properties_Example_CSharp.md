...
            Debug.Print("CPoint
configuration as defined in swCPointConfig\_e: "
+ cpConfig);
...
type as defined in swRouteComponentTypeID\_e: "
+ compType);
...
            Debug.Print("Route
type as defined in swComponentRouteType\_e: "
+ routeType);
...
            Debug.Print("Route
type from custom property as defined in swComponentRouteType\_e: "
+ routeTypeCustProp);
