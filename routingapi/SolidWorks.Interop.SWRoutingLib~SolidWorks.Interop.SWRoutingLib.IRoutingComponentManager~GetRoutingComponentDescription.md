...
See RoutingComponentManager::GetRoutingComponentDescription.
...
This method returns the information that was entered in **File > Properties > Custom**.
