...
//    click **Add Reference**, browse *install\_dir***\api\redist**, select
...
namespace SelectConnector\_CSharp.csproj
{
...
            nbrConnectors = rtAdvancedRouteSelector.**Find**("connector (3pin) female-1", (int)swRoutingSearchType\_e.swRoutingComponentSearch, true, false);
...
            attachNames = rtAdvancedRouteSelector.**Select**(0, false, null, (int)swAdvancedRouteSelectionOutput\_e.swBoth, out selName);
