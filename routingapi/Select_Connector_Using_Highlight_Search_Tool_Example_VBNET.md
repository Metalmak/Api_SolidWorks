...
        nbrConnectors = rtAdvancedRouteSelector.**Find**("connector (3pin) female-1", swRoutingSearchType\_e.swRoutingComponentSearch, True, False)
...
        attachNames = rtAdvancedRouteSelector.**Select**(0, False, Nothing, swAdvancedRouteSelectionOutput\_e.swBoth, selName)
