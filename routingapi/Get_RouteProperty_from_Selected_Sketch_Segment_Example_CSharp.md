...
//    click **Add Reference**, browse *install\_dir***\api\redist**, click
...
namespace GetRouteProperties\_CSharp.csproj
{
...
                        Debug.Print("  Set fixed length result code as defined in swSetRouteFixedLengthError\_e: " + lResult);
...
                    Debug.Print("  Route type as defined in swRouteType\_e: " + rtRouteProperty.**RouteType**);
