<!-- source: sw3dprinterapi/SolidWorks.Interop.sw3dprinter~SolidWorks.Interop.sw3dprinter.ISw3DPrinter~GetCalculatedBoundingVolume.html -->
...
| GetCalculatedBoundingVolume Method (ISw3DPrinter) | |
...
|  |
| --- |
| [SolidWorks.Interop.sw3dprinter Namespace](SolidWorks.Interop.sw3dprinter~SolidWorks.Interop.sw3dprinter_namespace.html) > [ISw3DPrinter Interface](SolidWorks.Interop.sw3dprinter~SolidWorks.Interop.sw3dprinter.ISw3DPrinter.html) : GetCalculatedBoundingVolume Method (ISw3DPrinter) |
...
Gets the dimension of the calculated bounding volume in document units.

# ![](dotnetimages/collapse.gif).NET Syntax

| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function GetCalculatedBoundingVolume() As System.String ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As ISw3DPrinter Dim value As System.String   value = instance.GetCalculatedBoundingVolume() ``` | |

| C# |  |
| --- | --- |
| ``` System.string GetCalculatedBoundingVolume() ``` | |
...
Dimension of calculated bounding volume

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See Sw3DPrinter::GetCalculatedBoundingVolume.
