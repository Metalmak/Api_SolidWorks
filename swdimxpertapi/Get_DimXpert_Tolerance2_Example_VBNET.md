...
' 3.
Select **Create Compound Plane** from the **DimXpert** shortcut toolbar.
...
' 6.
Click the back face of the block to complete the location dimension.

' 7.
Click to position the location dimension.

' 8. Pres **Esc** to end dimensioning.

' 9.
Observe the following DimXpert annotations: DistanceBetween1

' Create composite distance-between and radius dimension
tolerances:
...
' 4.
For **Primary Datum**, select the face in front of right hole.

' 5.
For **Secondary Datum**, select the top face of block.
...
' 3.
Click the green check mark to finish the Datum definition.
...
'    a.
Select **Symmetry** from the **Symbol** dropdown.
...
' 5.
Observe the following DimXpert annotations: Symmetry1
...
'    assembly is loaded (right-click the project in
the Project
...
'    (right-click
the project in the Project Explorer and click on **Add Reference >**
...
' 1.
Writes the
output to c:\temp\dimXpertInfo.txt.
...
 Dim
patternTreatment As swDimXpertPatternTreatmentType\_e
...
        If
annoType = swDimXpertAnnotationType\_e.swDimXpertDatum Then
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Symmetry
Then
...
ElseIf annoType = swDimXpertAnnotationType\_e.swDimXpertDimTol\_Radius
Then

            Dim
radiusDim As IDimXpertRadiusDimTol
...
            ElseIf
patternTreatment = swDimXpertPatternTreatmentType\_e.swDimXpertPatternTreatmentType\_CircularPattern
Then

                strs.Add("Pattern
Treatment: Circular pattern")

            ElseIf
patternTreatment = swDimXpertPatternTreatmentType\_e.swDimXpertPatternTreatmentType\_IndividualFeatures
Then

                strs.Add("Pattern
Treatment: Individual features")

            End
If

ElseIf annoType = swDimXpertAnnotationType\_e.swDimXpertDimTol\_Diameter
Then

            Dim
diaDim As IDimXpertDiameterDimTol
...
            'If
patternTreatment Is Nothing Then
...
        boolstatus
= annotation.GetOriginFeature(feature,
featureFosUsage)
...
        boolstatus
= annotation.GetDirectionVector(I, J,
K)
