<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertLineProfileTolerance.html -->
...
| IDimXpertLineProfileTolerance Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertLineProfileTolerance_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertLineProfileTolerance Interface |
...
Allows you to access DimXpert line profile tolerances.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertLineProfileTolerance ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertLineProfileTolerance ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertLineProfileTolerance.
...
You can access more general geometric tolerance information using [IDimXpertTolerance](SOLIDWORKS.Interop.swdimxpert~SOLIDWORKS.Interop.swdimxpert.IDimXpertTolerance.html).
