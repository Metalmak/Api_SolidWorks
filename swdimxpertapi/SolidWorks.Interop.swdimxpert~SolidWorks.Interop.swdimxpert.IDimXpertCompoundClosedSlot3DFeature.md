<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompoundClosedSlot3DFeature.html -->
...
| IDimXpertCompoundClosedSlot3DFeature Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompoundClosedSlot3DFeature_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertCompoundClosedSlot3DFeature Interface |
...
Allows you to access specific information about DimXpert 3D closed slots on the DimXpertManager tab of the Management Panel.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertCompoundClosedSlot3DFeature ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertCompoundClosedSlot3DFeature ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertCompoundClosedSlot3DFeature.
...
You can access more general DimXpert feature information using [IDimXpertFeature](SOLIDWORKS.Interop.swdimxpert~SOLIDWORKS.Interop.swdimxpert.IDimXpertFeature.html).
