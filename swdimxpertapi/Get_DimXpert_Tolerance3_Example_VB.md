...
' 1. Open
*public\_documents*\samples\tutorial\api\cover\_position.sldprt.
...
' 4. Observe this DimXpert annotation: CompositePosition1.
...
' 1.
Writes the output to c:\temp\dimXpertInfo.txt.
...
    ElseIf
annoType = swDimXpertGeoTol\_Position
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_CompositePosition
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_Angularity
Or annoType = swDimXpertGeoTol\_Parallelism
Or annoType = swDimXpertGeoTol\_Perpendicularity
Then
...
    If
annotation.zoneType = swDimXpertPositionZoneType\_PlanarPosition
Then
...
    If
annoType = swDimXpertGeoTol\_Perpendicularity
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_Parallelism
Then
