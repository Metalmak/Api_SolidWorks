<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertOrientationTolerance.html -->
...
| IDimXpertOrientationTolerance Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertOrientationTolerance_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertOrientationTolerance Interface |
...
Allows you to access DimXpert orientation tolerances.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertOrientationTolerance ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertOrientationTolerance ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertOrientationTolerance.
...
This interface defines angularity, parallelism and perpendicularity geometric tolerances. You can access more general geometric tolerance information using [IDimXpertTolerance](SOLIDWORKS.Interop.swdimxpert~SOLIDWORKS.Interop.swdimxpert.IDimXpertTolerance.html).
