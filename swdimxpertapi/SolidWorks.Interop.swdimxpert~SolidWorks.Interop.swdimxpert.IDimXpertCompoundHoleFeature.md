<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompoundHoleFeature.html -->
...
| IDimXpertCompoundHoleFeature Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompoundHoleFeature_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertCompoundHoleFeature Interface |
...
Allows you to access specific information about compound DimXpert holes on the DimXpertManager tab of the Management Panel.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertCompoundHoleFeature ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertCompoundHoleFeature ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertCompoundHoleFeature.
