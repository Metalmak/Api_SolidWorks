...
' 5. Find this Dimxpert annotation in the DimXpert tree:  AngleBetween1.
...
    ElseIf
annoType = swDimXpertGeoTol\_LineProfile
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_Straightness
Then
...
    ElseIf
annoType = swDimXpertDimTol\_ChamferDimension
Then

        Dim
chamfer As DimXpertChamferDimTol

        Set
chamfer = annotation

        Select
Case chamfer.ChamferType
...
            strs.Add
("Chamfer Dimension Type: Linear Distance 1")

        Case
swDimXpertChamferDimensionType\_LinearDistance2

            strs.Add
("Chamfer Dimension Type: Linear Distance 2")

        End
Select

    ElseIf
annoType = swDimXpertDimTol\_AngleBetween
Then
...
        strs.Add
("Supplement Angle: " + IIf(angleBetween.Supplement,
"True", "False"))
