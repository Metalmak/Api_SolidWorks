<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertChamferFeature.html -->
...
| IDimXpertChamferFeature Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertChamferFeature_members.html)   [Example](#ExampleBookmark) | |
...
Allows you to access specific information about DimXpert chamfers on the DimXpertManager tab of the Management Panel.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertChamferFeature ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertChamferFeature ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertChamferFeature.
