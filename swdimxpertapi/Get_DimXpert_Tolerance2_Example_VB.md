...
' 2.
Select **Part type** of **Prismatic**.

' 3.
Select T**olerance type** of **Plus
and Minus.**
...
Dim patternTreatment As swDimXpertPatternTreatmentType\_e
...
    ElseIf
annoType = swDimXpertGeoTol\_Symmetry
Then
...
ElseIf annoType = swDimXpertDimTol\_Radius
Then
...
         If
patternTreatment = swDimXpertPatternTreatmentType\_unknown
Then
...
         ElseIf
patternTreatment = swDimXpertPatternTreatmentType\_CircularPattern
Then
...
         ElseIf
patternTreatment = swDimXpertPatternTreatmentType\_IndividualFeatures
Then
...
 ElseIf
annoType = swDimXpertDimTol\_Diameter
Then
...
    boolstatus
= annotation.GetDirectionVector(I,
J, K)
...
    boolstatus
= annotation.GetIntraFeature(feature,
featureFosUsage)
...
        boolstatus
= annotation.GetPlusAndMinusToleranceIntraFeature(plus,
minus)
