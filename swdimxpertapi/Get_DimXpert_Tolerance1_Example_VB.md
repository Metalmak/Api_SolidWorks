...
    ElseIf
annoType = swDimXpertGeoTol\_Flatness
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_Circularity
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_Cylindricity
Then
...
Private Sub CircularityData(annotation
As DimXpertTolerance)
...
Private Sub CylindricityData(annotation
As DimXpertTolerance)
...
        If
countersink.ReferenceFeature Is
Nothing Then
...
        If
countersinkAngle.ReferenceFeature
Is Nothing Then
