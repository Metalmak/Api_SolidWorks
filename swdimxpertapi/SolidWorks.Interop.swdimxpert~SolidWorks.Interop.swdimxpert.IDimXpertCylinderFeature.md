<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCylinderFeature.html -->
...
| IDimXpertCylinderFeature Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCylinderFeature_members.html)   [Example](#ExampleBookmark) | |
...
Allows you to access specific information about DimXpert cylinders on the DimXpertManager tab of the Management Panel.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertCylinderFeature ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertCylinderFeature ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertCylinderFeature.
