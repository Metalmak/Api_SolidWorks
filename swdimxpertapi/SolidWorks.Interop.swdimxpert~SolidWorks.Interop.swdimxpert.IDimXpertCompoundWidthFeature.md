<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompoundWidthFeature.html -->
...
| IDimXpertCompoundWidthFeature Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompoundWidthFeature_members.html)   [Example](#ExampleBookmark) | |
...
Allows you to access specific information about compound DimXpert widths on the DimXpertManager tab of the Management Panel.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertCompoundWidthFeature ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertCompoundWidthFeature ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertCompoundWidthFeature.
