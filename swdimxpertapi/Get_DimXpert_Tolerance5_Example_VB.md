...
This example shows how to build a part and get attributes for the DimXpert Concentricity
...
'  1. Open *public\_documents*\samples\tutorial\api\cover\_with\_dimensions.sldprt.
...
'  1.
Click Datum of the DimXpert tool bar.
...
'  5.
Click **Geometric Tolerance** of the DimXpert toolbar.

'  6. In
the Geometric Tolerance Properties dialog:

'     a.
Select **Concentricity** in the **Symbol** dropdown.

'     b.
Click **Tolerance** 1.

'     c.
Click **Diameter** on the toolbar at the top of the dialog.

'     d.
Type **A** in **Primary**.

'  7.
Click the inside face of Simple Hole2.
...
' 10.
In the DimXpertManager tab of the Management Panel, expand Simple Hole2.

' 11.
Observe the following Dimxpert annotation: Concentricity1
...
'  1. Writes the
output ton c:\temp\dimXpertInfo.txt.
...
    ElseIf
annoType = swDimXpertGeoTol\_Concentricity
Then
