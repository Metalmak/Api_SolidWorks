<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertRadiusDimTol.html -->
...
| IDimXpertRadiusDimTol Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertRadiusDimTol_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertRadiusDimTol Interface |
...
Allows you to access DimXpert radius dimension tolerances.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertRadiusDimTol ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertRadiusDimTol ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertRadiusDimTol.
...
Use the Dimension Size icon on the DimXpert toolbar to create radius dimensions on non-closed curved faces.
