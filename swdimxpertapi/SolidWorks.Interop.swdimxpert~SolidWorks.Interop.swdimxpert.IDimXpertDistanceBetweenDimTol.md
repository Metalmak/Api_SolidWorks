<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertDistanceBetweenDimTol.html -->
...
| IDimXpertDistanceBetweenDimTol Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertDistanceBetweenDimTol_members.html)   [Example](#ExampleBookmark) | |
...
Allows you to access DimXpert distance-between dimension tolerances.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertDistanceBetweenDimTol ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertDistanceBetweenDimTol ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertDistanceBetweenDimTol.
