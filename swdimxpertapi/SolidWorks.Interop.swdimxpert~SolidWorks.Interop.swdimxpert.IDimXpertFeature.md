...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertFeature_members.html)   [Example](#ExampleBookmark) | |
...
Note that some features, such as swDimXpertFeatureType\_e.swDimXpertFeature\_Surface, do not have more specific interfaces. Those particular features are completely defined by the IDimXpertFeature interface.
