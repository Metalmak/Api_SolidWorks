...
'  1. Click **Datum** on the DimXpert tool bar.
...
'     a.
Select **Profile of Surface** from the **Symbol** dropdown.

'     b.
Type **A** in **Primary**, **B** in **Secondary**, and **C**

'        in **Tertiary**.

'     c.
In the second row, select **Profile of Surface** in the **Symbol** dropdown.
...
    ElseIf
annoType = swDimXpertGeoTol\_CompositeSurfaceProfile
Then
...
    ElseIf
annoType = swDimXpertGeoTol\_Tangency
Then
