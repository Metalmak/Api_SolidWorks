...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) > [IDimXpertExtrudeFeature Interface](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertExtrudeFeature.html) : GetTopBlends Method (IDimXpertExtrudeFeature) |
...
See DimXpertExtrudeFeature::GetTopBlends.

# ![](dotnetimages/collapse.gif)Remarks

The top blend is typically an [IDimXpertFilletFeature](SOLIDWORKS.Interop.swdimxpert~SOLIDWORKS.Interop.swdimxpert.IDimXpertFilletFeature.html).
