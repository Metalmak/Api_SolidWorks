<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCounterBoreDimTol.html -->
...
| IDimXpertCounterBoreDimTol Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCounterBoreDimTol_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertCounterBoreDimTol Interface |
...
Allows you to access specific dimension tolerancing information about DimXpert counterbore annotations on the DimXpertManager tab of the Management Panel.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertCounterBoreDimTol ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertCounterBoreDimTol ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertCounterBoreDimTol.
