...
' 1. Open
*public\_documents*\samples\tutorial\cosmosxpress\aw\_anchor\_plate.sldprt.
...
'  3.
Click to place Datum A.

'  4.
Click a back face of the part.

'  5.
Click to place Datum B.

'  6.
Click a side face of the part.

'  7.
Click to place Datum C.

'  8.
Click **Geometric** **Tolerance** of the DimXpert tool bar.
...
'     b.
Enter **A** in **Primary**, **B** in **Secondary**, and
...
'     f.
Click the front curve of the hook.
...
'  3.
Click onthe green check mark to accept the settings.
...
on the project name in the Project Explorer,
...
'     (right-click
on the project name in the Project Explorer, click
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Tangency
Then
...
    Private
Sub TangencyData(ByVal annotation As DimXpertTangencyTolerance)
