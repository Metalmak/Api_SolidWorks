...
'  1. Writes the output of this macro to
...
' NOTE:
Because the part is used elsewhere, do not save
changes.
...
    Set
dimXpertMgr = swapp.I**ActiveDoc2.Extension.DimXpertManager**(swapp.IActiveDoc2.IGetActiveConfiguration().Name,
True)
