<!-- source: swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertPositionTolerance.html -->
...
| IDimXpertPositionTolerance Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertPositionTolerance_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.swdimxpert Namespace](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert_namespace.html) : IDimXpertPositionTolerance Interface |
...
Allows you to access DimXpert position tolerances.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDimXpertPositionTolerance ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDimXpertPositionTolerance ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DimXpertPositionTolerance.
