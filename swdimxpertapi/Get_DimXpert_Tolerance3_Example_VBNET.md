...
' 2. Create
a composite position tolerance:
...
'       a.
Select **Position** from in **Symbol**

'       b.
Type **A** in **Primary**, **B** in **Secondary**, and **C** in
**Tertiary**.

'       c.
In second row (lower tier), select **Position** in **Symbol**.
...
' 3.
In the DimXpertManager tab of the Management Panel, expand Plane2.

' 4.
Observe the following DimXpert annotations in the DimXpert tree:

'    Perpendicularity1,
Position1, and CompositePosition1.

' 5. Ensure that the
SolidWorks.Interop.swdimxpert.dll
interop

'    assembly is loaded (right-click on the
...
'    (right-click
on the project in Project Explorer and click **Add Reference >**
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Position
Then
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Angularity
Or annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Parallelism
Or annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Perpendicularity
Then
...
        boolstatus
= annotation.GetProjectedZone(enabled,
value)
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Parallelism
Then
