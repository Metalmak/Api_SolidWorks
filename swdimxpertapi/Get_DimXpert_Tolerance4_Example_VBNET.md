...
' Create
the chamfer dimension tolerance:
...
' 4.
Observe ChamferDepth1 and ChamferDepth2 annotations in the DimXpert tree.
...
' 3.
Click a face perpendicular to the face selected in step 2
...
' 5.
Find the following Dimxpert annotation in the DimXpert tree:  AngleBetween1.
...
'    a.
Select **Straightness** in **Symbol**.

'    b.
In second row, select **Profile of Line** in **Symbol**.

'    c.
Type **0.25** in **Tolerance 1**.

'    d.
Click the top face of the part.

'    e.
Click to place the annotation.

'    f.
Click **OK** close the Geometric Tolerance Properties dialog.

' 3.
In the DimXpertManager tab of the Management Panel, expand Plane7.

' 4.
Observe the following Dimxpert annotations: LineProfile1
and
Straightness1
...
'    (right-click
the project in Project Explorer and click **Add Reference >**
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_LineProfile
Then
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertGeoTol\_Straightness
Then
...
        boolstatus
= annotation.GetPlanarZoneVector(I,
J, K)
...
        boolstatus
= annotation.GetPerUnitLength(enabled,
dist)
...
        ElseIf
annoType = swDimXpertAnnotationType\_e.swDimXpertDimTol\_AngleBetween
Then
...
            Dim
angleBetweenAnno As IDimXpertAngleBetweenDimTol
...
            strs.Add("Origin
Feature: " + angleBetweenAnno.OriginFeature.Name)

            '
is supplement angle

            strs.Add("Supplement
Angle: " + IIf(angleBetweenAnno.Supplement,
"True", "False"))
