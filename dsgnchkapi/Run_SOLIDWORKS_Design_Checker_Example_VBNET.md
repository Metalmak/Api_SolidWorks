...
        swApp.**SetUserPreferenceIntegerValue**(swUserPreferenceIntegerValue\_e.swFeatureManagerDesignBinderVisibility,
swAutoHideShowResponse\_e.swAutoHideShowResponse\_Show)
...
        Debug.Print("")
        Debug.Print("SOLIDWORKS
Design Checker created report in this format (0=XML, 1=MSWord): "
& lReportFormat)
