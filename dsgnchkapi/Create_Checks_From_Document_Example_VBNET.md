...
' 3. Reference the SOLIDWORKS Design Checker primary interop
assembly
...
        retValue = swDCAddIn.**CreateChecksFromSWFile**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS
...
            Case
2
                Debug.Print("Could not
create report directory.")
            Case
3
                Debug.Print("No active
document.")
            Case
4
