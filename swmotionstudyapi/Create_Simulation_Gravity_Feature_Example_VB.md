...
' 2. In SOLIDWORKS, verify that View > MotionManager is
selected.
' 3. In the IDE, click **Tools > References** and
select
...
'
' Postconditions:
' 1. Adds **Gravity** to the MotionManager design tree on the Motion
Study 1 tab.
...
2018\samples\tutorial\api\beam\_boltconnection.sldasm",
...
feature data object failed"
    End If

    swGravityFeat.**ReverseDirection** =
False
