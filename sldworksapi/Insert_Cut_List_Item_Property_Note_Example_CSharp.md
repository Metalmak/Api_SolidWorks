...
//----------------------------------------------------------------------------
// Preconditions: Open *public\_documents***\samples\tutorial\api\2012-sm.slddrw**.
//
// Postconditions:
// 1. Inserts a note with all of the cut list item properties in Drawing
View1.
...
namespace
InsertCutListPropertyNote\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            aView = (View)SelMgr.**GetSelectedObject6**(1,
-1);
