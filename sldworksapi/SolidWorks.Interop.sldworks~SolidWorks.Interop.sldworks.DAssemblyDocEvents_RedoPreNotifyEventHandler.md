...
| DAssemblyDocEvents\_RedoPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_RedoPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See RedoPreNotify Event (AssemblyDoc).
...
If developing a C++ application, use swAssemblyRedoPreNotify to register for this notification.
