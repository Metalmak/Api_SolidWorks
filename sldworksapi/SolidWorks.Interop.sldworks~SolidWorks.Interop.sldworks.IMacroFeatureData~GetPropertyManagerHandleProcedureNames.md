...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IMacroFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData.html) : GetPropertyManagerHandleProcedureNames Method (IMacroFeatureData) |
...
See MacroFeatureData::GetPropertyManagerHandleProcedureNames.
