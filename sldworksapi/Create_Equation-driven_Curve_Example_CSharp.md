...
//
// Postconditions:
// 1. Creates a 2D sketch and creates an equation-driven
spline of
//    a sine curve.
...
namespace
SimplifySketchSpline\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            skSegment = (SketchSegment)swModel.**SketchManager**.**CreateEquationSpline2**("",
"sin(x)",
"",
"0",
"6.28",
...
            SketchSpline
skSpline = default(SketchSpline);
            skSpline = (SketchSpline)skSegment;
            skSpline.**GetEquationParameters**(out
y, out r1,
out r2,
out rad,
out ang,
...
            // Change spline to a cosine
curve
            y =
"cos(x)";
            skSpline.**SetEquationParameters**(y, r1, r2, rad, ang, xOff,
yOff, LockStart, LockEnd);
