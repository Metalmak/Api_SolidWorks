...
namespace
GetBendDirection\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            f = (Feature)swModel.**ISelectionManager**.**GetSelectedObject6**(1,
-1);
...
of the selected bend is up.");
            }
            else
if (obe.**BendDirection**
== 2)
            {
                Debug.Print("Direction
of the selected bend is down.");
            }
            else
            {
                Debug.Print("Error
getting the direction of the selected bend.");
            }
        }
