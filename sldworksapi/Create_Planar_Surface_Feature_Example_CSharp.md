...
//
// Postconditions:
// 1. Creates a new model document with a boss
extrusion.
...
namespace CreateSurfacePlaneFeature\_CSharp.csproj
{
...
            boolStatus = Part.**Extension**.**SetUserPreferenceToggle**((int)swUserPreferenceToggle\_e.swSketchAddConstToRectEntity, (int)swUserPreferenceOption\_e.swDetailingNoOptionSpecified, false);
            boolStatus = Part.**Extension**.**SetUserPreferenceToggle**((int)swUserPreferenceToggle\_e.swSketchAddConstLineDiagonalType, (int)swUserPreferenceOption\_e.swDetailingNoOptionSpecified, true);
...
            Debug.Print("Type as defined in swSelectType\_e:");
...
    Debug.Print("Types of planar surface bounding entities as defined in swSelectType\_e:");
