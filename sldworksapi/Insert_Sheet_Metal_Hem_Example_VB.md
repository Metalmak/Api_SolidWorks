...
    Set myFeature = Part.**FeatureManager**.**InsertSheetMetalHem2**(swHemTypes\_e.swHemTypeOpen,
swHemPositionTypes\_e.swHemPositionTypeOutside, False, 0.01, 0.01, 0, 0.005,
0.0011, CBAObject, False, swSheetMetalReliefTypes\_e.swSheetMetalReliefObround,
0, True, 1#, 0, 0)
    Part.**ClearSelection2** True

    Set myHem = myFeature.**GetDefinition**
    Debug.Print "Hem type as defined in swHemTypes\_e: " & myHem.**Type**
End Sub