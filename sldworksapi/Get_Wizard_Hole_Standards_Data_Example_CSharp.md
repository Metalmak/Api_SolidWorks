...
namespace GetHoleStandards\_CSharp
{
...
            holeStandards = (HoleStandardsData)swApp.**GetHoleStandardsData**((int)swWzdGeneralHoleTypes\_e.swWzdCounterBore);
...
                Debug.Print("Fastener table type ID as defined in swFastenerTableTypes\_e: " + fastenerDataObject.**TableTypeID**);
