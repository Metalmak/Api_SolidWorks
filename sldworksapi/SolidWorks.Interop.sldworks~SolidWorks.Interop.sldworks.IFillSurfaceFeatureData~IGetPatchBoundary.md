...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IFillSurfaceFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFillSurfaceFeatureData.html) : IGetPatchBoundary Method (IFillSurfaceFeatureData) |
...
*EntType*
:   * in-process, unmanaged C++: Pointer to an array of types of entities used to define the patch boundary as defined by swSelectType\_e:
      + edges (swSelEDGES)
