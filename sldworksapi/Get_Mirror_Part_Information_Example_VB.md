...
Dim selType As swSelectType\_e
...
    If selMgr.**GetSelectedObjectCount2**(-1)
= 0 Then Exit Sub
...
    mirrorOptions =
swMirrorPartOptions\_ImportSolids + \_

swMirrorPartOptions\_ImportCustomProperties + \_

swMirrorPartOptions\_ImportCutListProperties

    Set mirrorFeature = swPart.**MirrorPart2**(False,
