...
'---------------------------------------------------------------------------
' Preconditions:
' 1. Open *public\_documents***\samples\tutorial\advdrawings\bowl
and chute.sldasm**.
...
> > False **pIntMgr.IncludeMultibodyPartInterferences**
> > =
> > True **pIntMgr.MakeInterferingPartsTransparent** =
> > True
...
> > swNonInterferingComponentDisplay\_e.swNonInterferingComponentDisplay\_Wireframe'Run
> > interference detection
> > vInts = pIntMgr.**GetInterferences**Debug.Print("#
...
> > > vComps = interference.**Components**For
> > > j = 0 To
> > > UBound(vComps)
> > >
> > > > comp = vComps(j)
...
> > > Next
> > > j
> > > vol = interference.**Volume**Debug.Print("  Interference
...
> > i
> >
> > ret = pIntMgr.**ExportResults**("c:\temp\IntDetReport.xlsx",
> > True)
> >
> > 'Stop
> > interference detection and close Interference Detection pane
> > 'pIntMgr.**Done**()
>
> End
> Sub
