...
namespace
WrapFeatureData\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
swWrapSketch = default(WrapSketchFeatureData);
...
= " + swFeat.**Name**);
            Debug.Print("
Reverse direction?  " + swWrapSketch.**ReverseDirection**);
            Debug.Print("
Type of surface revolve =  " +
swWrapSketch.**Type**);
            Debug.Print("
Thickness =  " + swWrapSketch.**Thickness**);
