...
        docUserUnit = Part.**GetUserUnit**(swUserUnitsType\_e.swAngleUnit)
...
        boolstatus = ModelDocExtension.**SetUserPreferenceInteger**(swUserPreferenceIntegerValue\_e.swUnitsAngular, swUserPreferenceOption\_e.swDetailingNoOptionSpecified, swAngleUnit\_e.swDEG\_MIN\_SEC)
        boolstatus = ModelDocExtension.**SetUserPreferenceInteger**(swUserPreferenceIntegerValue\_e.swUnitsAngularDecimalPlaces, swUserPreferenceOption\_e.swDetailingNoOptionSpecified, 2)
