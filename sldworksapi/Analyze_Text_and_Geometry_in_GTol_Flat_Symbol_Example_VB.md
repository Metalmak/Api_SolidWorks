...
    Set swModel = swApp.**OpenDoc6**(fileName, swDocumentTypes\_e.swDocPART, swOpenDocOptions\_e.swOpenDocOptions\_Silent, "",
errors, warnings)
    Set swEnvironment = swApp.**GetEnvironment**

    Debug.Print "GTOL library - Surface
Profile symbol name:"
...
    'Get the number of lines, arcs, circles,
text strings,
    'and triangles in <"GTOL-SPROF">
...
    'Get the x,y,z coordinates for the
first
...
nbrLineCoordinates + 1)
    Debug.Print ("     Point coordinates:")
    Debug.Print ("       (Line 1's
x,y,z coordinates for first and second points,")
    Debug.Print ("        Line
2's x,y,z coordinates for first and second points,")
    Debug.Print ("
...)")
...
    'Get the x,y,z coordinates of
the center, start, and
