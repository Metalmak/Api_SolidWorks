...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelViewManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelViewManager.html) : CreateManipulator Method (IModelViewManager) |
...
*Type*
:   Type of manipulator to create as defined by swManipulatorType\_e
...
See ModelViewManager::CreateManipulator.
