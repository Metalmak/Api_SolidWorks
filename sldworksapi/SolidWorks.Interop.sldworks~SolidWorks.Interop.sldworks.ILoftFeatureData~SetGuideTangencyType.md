...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ILoftFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoftFeatureData.html) : SetGuideTangencyType Method (ILoftFeatureData) |
...
*TangType*
:   Tangency type of guide curve as defined in swTangencyType\_e
...
See LoftFeatureData::SetGuideTangencyType.
