...
System;
namespace
CreatePathLengthDim\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
void Main()
        {
            swApp.**SetUserPreferenceToggle**((int)swUserPreferenceToggle\_e.swInputDimValOnCreate,
false);
...
            myDisplayDim = (DisplayDimension)Part.**Extension**.**AddPathLengthDim**(-0.0580395474035344,
