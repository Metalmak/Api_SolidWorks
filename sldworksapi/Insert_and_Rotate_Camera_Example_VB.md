...
> swDocPART, swOpenDocOptions\_Silent, "", fileerror, filewarning
>
...
>
> swCamera.Type
> = swCameraType\_Floating
>
> ' Show camera
>
> boolstatus = swModelDocExt.SelectByID2("Camera1",
> "CAMERAS", 0, 0, 0, False, 0, Nothing, 0)
>
> boolstatus = swModel.SetUserPreferenceToggle(swUserPreferenceToggle\_e.swDisplayCameras,
> True)
>
...
>
> Debug.Print "Original pitch (up or down angle)     =
> " & swCamera.Pitch \*
> 57.3 & " deg"
>
> Debug.Print "Original yaw (side-to-side angle)     =
> " & swCamera.Yaw \* 57.3
> & " deg"
>
> Debug.Print " "
...
>
> Debug.Print "New pitch (up or down angle)          =
> " & swCamera.Pitch \*
> 57.3 & " deg"
>
> Debug.Print "New yaw (side-to-side angle)          =
> " & swCamera.Yaw \* 57.3
> & " deg"
>
> swModel.GraphicsRedraw2
