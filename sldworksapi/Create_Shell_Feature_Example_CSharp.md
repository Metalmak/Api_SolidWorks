...
namespace CreateShellFeature\_CSharp.csproj
{
...
foreach (object vMultiFace\_loopVariable in vMultiFaceArr) {
vMultiFace = vMultiFace\_loopVariable;
swMultiFace = (Face2)vMultiFace;
swEnt = (Entity)swMultiFace;

Debug.Print("    Alternative thickness
in mm at face (" + i + "): " + swShell.**GetMultipleThicknessAtIndex**(i) \* 1000.0);
i = i + 1;
