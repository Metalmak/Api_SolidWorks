...
| DSldWorksEvents\_FileOpenNotify2EventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DSldWorksEvents\_FileOpenNotify2EventHandler Delegate (SolidWorks.Interop.sldworks) |
...
If developing a C++ application, use swAppFileOpenNotify2 to register for this notification.
