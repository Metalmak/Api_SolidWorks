...
View1", "DRAWINGVIEW", 0.395146689428525, 0.746414551874767, 0, False, 0,
Nothing, 0)

    Set swView = swSelMgr.**GetSelectedObject6**(1,
-1)
    boolstatus = swView.**ShowModelBreakState**(True, "Model
Break View1")

    Debug.Print "Displaying Model Break
View?
" & swView.**IsModelBreakState**
