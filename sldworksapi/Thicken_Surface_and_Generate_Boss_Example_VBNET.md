...
        bRet = swSelMgr.**SetSelectedObjectMark**(1, 1, swSelectionMarkAction\_e.swSelectionMarkSet)

        swFeat = swFeatMgr.**FeatureBossThicken**(0.001, swThickenThicknessType\_e.swThickenSideOne, 0, False, True, True, True)
