...
2018\samples\tutorial\api\sweepcutextrude.SLDPRT", 1, 0, "", longstatus, longwarnings)

    boolstatus = swModel.**Extension**.**SelectByID2**("Sketch2",
"SKETCH", 0.01948983274156, -0.02564816935317, 0, False, 1, Nothing, 0)
    boolstatus = swModel.**Extension**.**SelectByID2**("Sketch3",
...
    swSweep.**SetWallThickness** True, 0.001 'Meters in
Direction 1
    swSweep.**SetWallThickness** False, 0.001 'Meters in
Direction 2
