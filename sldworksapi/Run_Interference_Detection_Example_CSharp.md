...
> > > pIntMgr = swAssemblyDoc.**InterferenceDetectionManager**;//Specify the interference detection settings and options
...
> > > pIntMgr.**NonInterferingComponentDisplay** = (int)swNonInterferingComponentDisplay\_e.swNonInterferingComponentDisplay\_Wireframe;
> > >
> > > //Run
...
> > >
> > > //Stop
> > > interference detection and close Inteference Detection pane
> > > //pIntMgr.**Done**();
>
>     }
>
