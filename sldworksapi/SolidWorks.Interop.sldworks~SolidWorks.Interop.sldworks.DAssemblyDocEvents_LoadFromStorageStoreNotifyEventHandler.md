...
| DAssemblyDocEvents\_LoadFromStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_LoadFromStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See LoadFromStorageStoreNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyLoadFromStorageStoreNotify to register for this notification.
