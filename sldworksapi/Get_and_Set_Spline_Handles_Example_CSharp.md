...
namespace GetSetSplineHandle\_CSharp.csproj
{
...
                Debug.Print(" Tangent magnitude: " + swSplineHandle.**get\_TangentMagnitude**((int)swTangentMagnitudeDirection\_e.swTangentMagnitudeDirection1));
                Debug.Print(" Tangent radial direction: " + swSplineHandle.**TangentRadialDirection**);

                if ((i == 2))
                {
                    swSplineHandle.**set\_TangentMagnitude**((int)swTangentMagnitudeDirection\_e.swTangentMagnitudeDirection1, swSplineHandle.**get\_TangentMagnitude**((int)swTangentMagnitudeDirection\_e.swTangentMagnitudeDirection1) + 0.02);
