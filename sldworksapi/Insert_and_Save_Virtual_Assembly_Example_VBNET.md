...
'
' Postconditions:
' 1. First, **Tools > Options > System Options > Assemblies > Save new
components**
...
tree.
'    b. M**yTestValveAssembly.sldasm** is saved in the assembly's
directory.
' 2. Next, **Tools > Options > System Options > Assemblies > Save new
components**
...
as defined in swInsertNewAssemblyErrorCode\_e.
'------------------------------------
Imports
...
        ' Turn on Tools > Options > System
Options > Assemblies > Save new components to external files
        swApp.SetUserPreferenceToggle(swUserPreferenceToggle\_e.swSaveNewComponentsToExternalFile,
True)
...
        ' Create a virtual sub-assembly and
