...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : IGetDocumentDependencies2 Method (ISldWorks) |
...
* in-process, unmanaged C++: Pointer to an array of strings with two strings for each document returned in this list of dependent files:
  + File name
    ...
    + Filename with the complete pathname; this combination repeats itself for each dependent file found for this document* VBA, VB.NET, C#, and C++/CLI: Not supported
