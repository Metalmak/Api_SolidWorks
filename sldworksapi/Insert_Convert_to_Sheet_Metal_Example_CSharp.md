...
//--------------------------------------------------------------------------
// Preconditions: Open *public\_documents***\samples\tutorial\api\sweepcutextrude.sldprt**.
...
System;
namespace
InsertConvertSheetMetal\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            // Convert extrusion to sheet
metal of thickness=13mm,

            //
bend radius=0.5mm, rip gap=2mm, relief type =
rectangular,
...
            //
rip
edge overlap ratio = 0.5, do not keep bodies
            boolstatus =
swDoc.**FeatureManager**.**InsertConvertToSheetMetal2**(0.013,
false,
false, 0.0005,
0.002, 0, 0.5, 1, 0.5, false);
