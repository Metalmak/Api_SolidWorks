...
Function CreateHoleWizardFeature(swApp As SldWorks.SldWorks,
swModel As SldWorks.ModelDoc2) As Boolean
...
As SldWorks.Feature
    Dim swWizHole
As SldWorks.WizardHoleFeatureData2
