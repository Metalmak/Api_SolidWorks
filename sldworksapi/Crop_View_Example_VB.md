...
    Set myView = Part.**SelectionManager**.**GetSelectedObject6**(1,
-1)

    boolstatus = Part.**ActivateView**("Drawing
View1")
    Dim vSkLines As Variant
    vSkLines = Part.**SketchManager**.**CreateCornerRectangle**(-5.74722079408937E-02,
3.31536511827661E-02, 0, 3.71399698368841E-02, -3.73161088172339E-02, 0)
