...
    copyopt =
SwConst.swMoveCopyOptions\_e.swMoveCopyOptionsOverwriteExistingDocs
    errors = swApp.**CopyDocument**(source + sourcefile,
target + sourcefile, (sourcefiles), (targetfiles), copyopt)
