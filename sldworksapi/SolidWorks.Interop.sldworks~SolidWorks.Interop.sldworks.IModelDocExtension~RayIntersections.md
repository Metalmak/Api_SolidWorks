...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDocExtension Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension.html) : RayIntersections Method (IModelDocExtension) |
...
*Options*
:   Options as defined in swRayPtsOpts\_e (see **Remarks**)
...
See ModelDocExtension::RayIntersections.
