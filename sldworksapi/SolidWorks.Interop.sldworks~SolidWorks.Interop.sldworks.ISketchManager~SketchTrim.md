...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISketchManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager.html) : SketchTrim Method (ISketchManager) |
...
*Option*
:   Sketch trim option as defined in swSketchTrimChoice\_e (see **Remarks**)
...
* non-zero doubles only when Option is specified with swSketchTrimChoice\_e.swSketchTrimEntityPoint.* 0.0, 0.0, and 0.0 for all other Options.
