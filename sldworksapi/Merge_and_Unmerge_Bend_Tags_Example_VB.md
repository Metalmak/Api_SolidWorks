...
Dim errors As
Long, warnings As Long
Dim noteList(1) As SldWorks.note
...
swApp.**OpenDoc6** fileName, swDocDRAWING, swOpenDocOptions\_Silent, "",
errors, warnings
...
status = swModelDocExt.**SelectByID2**("DetailItem37@Drawing View1", "NOTE",
9.02750427561398E-02, 0.24484926035503, 0, False, 0, Nothing, 0)

Set swNote = swSelectionMgr.**GetSelectedObject6**(1, 0)

Set noteList(0) = swNote
...
status = swModelDocExt.**SelectByID2**("DetailItem38@Drawing View1", "NOTE",
9.78933563656073E-02, 0.244401124260355, 0, True, 0, Nothing, 0)

Set swNote = swSelectionMgr.**GetSelectedObject6**(1, 0)

Set noteList(1) = swNote
...
7.65893917313017E-02, 0.16302919597189, 0, False, 0, Nothing, 0)

Set swView = swSelectionMgr.**GetSelectedObject6**(1, 0)
...
status = swModelDocExt.**SelectByID2**("DetailItem38@Drawing View1", "NOTE",
0.098037379978424, 0.245097849056604, 0, False, 0, Nothing, 0)
