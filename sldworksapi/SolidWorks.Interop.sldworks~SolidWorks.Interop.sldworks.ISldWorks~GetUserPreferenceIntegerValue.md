...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : GetUserPreferenceIntegerValue Method (ISldWorks) |
...
*UserPreferenceValue*
:   User preference as defined in swUserPreferenceIntegerValue\_e
...
See SldWorks::GetUserPreferenceIntegerValue.
...
This method is intended for user preferences of type integer and is equivalent to interactively getting system options in the SOLIDWORKS software. See System Options and Document Properties for details.
