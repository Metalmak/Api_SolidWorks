...
swCurveDrivenPatternFeatureData = swFeatureMgr.**CreateDefinition**(swFeatureNameID\_e.swFmCurvePattern)

swCurveDrivenPatternFeatureData.**D1AlignmentMethod** = 0
        swCurveDrivenPatternFeatureData.**D1CurveMethod**
= 0
        swCurveDrivenPatternFeatureData.**D1InstanceCount**
= 3
        swCurveDrivenPatternFeatureData.**D1IsEqualSpaced**
= True
        swCurveDrivenPatternFeatureData.**D1ReverseDirection**
= False
        swCurveDrivenPatternFeatureData.**D1Spacing**
= 0.0254

        swFeature =
swFeatureMgr.**CreateFeature**(swCurveDrivenPatternFeatureData)
