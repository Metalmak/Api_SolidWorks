...
        ' Set HLR quality to a fast redraw
and lower image quality of model edges
        swModView.**HlrQuality** =
swHlrQuality\_e.swFastHlr

        Debug.Print("File = "
& swModel.**GetPathName**)
        Debug.Print("  Hidden-line
removal quality as defined in swHlrQuality\_e (1 = swHlrQuality\_e.swFastHlr) = "
& swModView.**HlrQuality**)
