...
//
parent
assembly component, are printed in the Immediate Window.
//------------------------------------------------------------
using
...
namespace
IsVirtualComponent3CSharp.csproj
{
    partial
class
SolidWorksMacro
...
                return;
            if
(doc.**GetType**() != (int)swDocumentTypes\_e.swDocASSEMBLY)
                return;
...
                        object
titleChain = null;
                        result3 = compDoc.Extension.**IsVirtualComponent3**(out
pathChain, out
titleChain);
