...
| DPartDocEvents\_UnitsChangeNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_UnitsChangeNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See UnitsChangeNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartUnitsChangeNotify to register for this notification.
