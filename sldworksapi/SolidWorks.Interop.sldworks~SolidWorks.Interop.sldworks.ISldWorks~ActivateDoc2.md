...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : ActivateDoc2 Method (ISldWorks) |
...
*Errors*
:   Status of the document activate operation as defined in swActivateDocError\_e; if
    no errors or warnings are encountered, then this value is set to 0

Obsolete. Superseded by [ISldWorks::ActivateDoc3](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISldWorks~ActivateDoc3.html).
