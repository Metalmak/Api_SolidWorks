...
System;
namespace
SelectConfiguration\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            Configuration
swConf = default(Configuration);
            ConfigurationManager
swConfMgr = default(ConfigurationManager);
            Configuration
swDerivConf = default(Configuration);
            bool
bRet = false;
            int
i;
...
            for
(i = 0; i <= vConfigNameArr.GetUpperBound(0); i++)  {
