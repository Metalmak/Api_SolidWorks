...
Studio 2010, or later, create an SOLIDWORKS add-in
//    project using **Visual C# > SwCSharpAddin**.
// 2. Name the project
**SwCSharpAddin1**.
// 3. Copy and paste
[this code](#SwAddin) into **SwAddin.cs** of your C# project.
// 4. Click **Project >
SwCSharpAddin1 Properties > Debug.**// 5. Select **Start external program** and type the path to **sldworks.ex**e. Include
//    **sldworks.exe** in the path.
// 6. Press F5 to start
debugging SOLIDWORKS with this add-in.
//
// Postconditions:
...
// 5. Click **Tools > Options > System Options > Colors** > select
a different
//    **Background** > **OK**.
...
            }
            // create a third-party icon in
the context-sensitive menus of faces in parts
...
        public
int
InterfaceBrightnessThemeChangeNotify(int theme,
ref object
colors)
        {
            MessageBox.Show("Background changed to (0 = light, 1 = medium, 2 = dark,
