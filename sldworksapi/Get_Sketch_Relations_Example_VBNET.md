...
        vSkRelArr = swSkRelMgr.**GetRelations**(swSketchRelationFilterType\_e.swAll)
: If
IsNothing(vSkRelArr) Then
Exit
Sub
        For
Each vSkRel
...
            dispDim =
swSkRel.**GetDisplayDimension** If
Not dispDim
Is Nothing Then
                Debug.Print("      Display
dimension
...
            If
Not
IsNothing(vEntTypeArr) And
Not
IsNothing(vEntArr) Then
                If
UBound(vEntTypeArr) = UBound(vEntArr) Then
...
                                swSkPt = vEntArr(j) : Debug.Assert(Not
swSkPt Is
Nothing)
...
                            Case
swSketchRelationEntityTypes\_e.swSketchRelationEntityType\_Line, \_
