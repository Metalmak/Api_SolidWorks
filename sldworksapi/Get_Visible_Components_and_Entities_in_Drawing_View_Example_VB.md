...
        'Get all edges of
this component that are visible in this drawing view
        vEdges = drView.**GetVisibleEntities2**(Comp,
...
        Else
            Debug.Print "
This component has " & UBound(vEdges) + 1 & " visible edges in this view."
            For itr = 0
To UBound(vEdges)
...
        vVerts =
drView.**GetVisibleEntities2**(Comp, swViewEntityType\_Vertex)
...
        Else
            Debug.Print "
This component has " & UBound(vVerts) + 1 & " visible vertices in this view."
            For itr = 0
To UBound(vVerts)
...
        'Get all faces of
this component that are visible in this drawing view
        vFaces = drView.**GetVisibleEntities2**(Comp,
...
        Else
            Debug.Print "
This component has " & UBound(vFaces) + 1 & " visible faces in this view."
            For itr = 0
To UBound(vFaces)
...
        'Get all
silhouette edges of this component that are visible in this drawing view
        vSilhouetteEdges = drView.**GetVisibleEntities2**(Comp,
swViewEntityType\_SilhouetteEdge)

        Dim silEdge As
SldWorks.SilhouetteEdge
