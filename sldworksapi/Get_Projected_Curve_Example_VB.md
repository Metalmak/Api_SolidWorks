...
    Set Part = swApp.**NewDocument**(defTemplate,
...
    Part.**ClearSelection2** True
    Set skSegment = Part.**SketchManager**.**CreateLine**(-0.015062,
-0.011566, 0#, -0.020354, -0.032124, 0#)
    Part.**SetPickMode**
    Part.**ClearSelection2** True
    vSkLines = Part.**SketchManager**.**CreateCornerRectangle**(0,
-1.27873930746226E-02, 0, 9.77008554030195E-03, -3.21240207064702E-02, 0)
    Part.**SetPickMode**
    Part.**ClearSelection2** True
    Part.**SketchManager**.**InsertSketch** True
    Part.**ClearSelection2** True
...
    boolstatus = Part.**Extension**.**SelectByID2**("Sketch2",
"SKETCH", 4.47795587263838E-03, -1.27873930746226E-02, 0, True, 2, Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByRay**(8.5488248477642E-03,
-0.075454504318941, 2.93545895954139E-02, 0, -0.707106781186541,
0.707106781186554, 6.92047725771388E-04, 2, True, 1, 0)
