...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : ShowBubbleTooltipAt2 Method (ISldWorks) |
...
*TitleBitmapID*
:   ID of the bitmap to display in the bubble ToolTip as defined in swBitMaps (see **Remarks**)
...
*Cookie*
:   Add-in's application ID specified in ISwAddin::ConnectToSW

*LinkStringID*
:   ID of the hyperlink as defined in swLinkString (see **Remarks**)
...
See SldWorks::ShowBubbleTooltipAt2.
