...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISMGussetFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISMGussetFeatureData.html) : FilletOuterCorners Property (ISMGussetFeatureData) |
...
See SMGussetFeatureData::FilletOuterCorners.
...
After setting this property, set [ISMGussetFeatureData::OuterCornerFilletRadius](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISMGussetFeatureData~OuterCornerFilletRadius.html).
