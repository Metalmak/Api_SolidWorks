...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ITaskpaneView Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITaskpaneView.html) : AddStandardButton Method (ITaskpaneView) |
...
*BitmapOption*
:   Type of standard SOLIDWORKS button as defined in swTaskPaneBitmapsOptions\_e
...
See TaskpaneView::AddStandardButton.
