...
'----------------------------------------------------------
' Preconditions:
' 1. In the IDE, reference your ActiveX control
file
...
'    *activex\_control\_CLSID\_or\_ProgID* with your ActiveX
control's
'    information.
'
' Postconditions:
...
' 4. Rerun the macro.
' 5.
Opens the part document and splits the FeatureManager design
'    tree; the splitter is
above the FeatureManager design tree
'    to which the
...
iconSmall As
String =
"C:\Program Files\SOLIDWORKS Corp\SOLIDWORKS\data\user macro icons\button.bmp"
...
        Dim
ctrlTop As
*activex\_control\_component\_declaration*
        Dim
ctrlBtm As
*activex\_control\_component\_declaration*
        Dim
...
"",
"Top tab ToolTip",
swFeatMgrPane\_e.swFeatMgrPaneTop)
...
"",
"Bottom tab ToolTip",
swFeatMgrPane\_e.swFeatMgrPaneBottom)
