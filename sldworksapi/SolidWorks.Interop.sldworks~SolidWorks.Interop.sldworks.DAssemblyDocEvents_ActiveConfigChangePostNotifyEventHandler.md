...
| DAssemblyDocEvents\_ActiveConfigChangePostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_ActiveConfigChangePostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ActiveConfigChangePostNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyActiveConfigChangePostNotify to register  for this notification.
