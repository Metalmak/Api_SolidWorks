...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IFeatureManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager.html) : FeatureExtruRefSurface2 Method (IFeatureManager) |
...
*T1*
:   Termination type for first end as defined in swEndConditions\_e

*T2*
:   Termination type for second end as defined in swEndConditions\_e
...
*TranslateSurface2*
:   If you specified T2 as swEndConditions\_e.swEndCondOffsetFromSurface, then true specifies that the end of the extrusion is a translation of the reference surface, and false specifies to use a true offset
...
Obsolete. Superseded by [IFeatureManager::FeatureExtruRefSurface3](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~FeatureExtruRefSurface3.html).
...
See FeatureManager::FeatureExtruRefSurface2.
...
* Select the base of the extrusion surface:
  + Sketch; call [IModelDocExtension::SelectByID2](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~SelectByID2.html) with selection mark 0.+ Sketch segments; call IModelDocExtension::SelectByID2 with selection mark 0 or 4.+ Single planar face; call IModelDocExtension::SelectByID2 with selection mark 0.+ Multiple co-planar faces; call IModelDocExtension::SelectByID2 with selection mark 0 for the first planar face and selection mark 256 for other co-planar faces.* Select the entity reference for the direction of the extrusion by calling IModelDocExtension::SelectByID2 with selection mark 16. If no entity is selected, the direction of extrusion is normal to the selected extrusion surface.
