...
'    \* Angle defined by the selected sketch
segment and an extension line
...
        myDisplayDim = Part.**Extension**.**AddDimension**(-0.0456250220540824, 0, 0.00150965590938767, swSmartDimensionDirection\_e.swSmartDimensionDirection\_Right)
