...
' 1. Open a drawing
document of an assembly that contains **Drawing View1**
...
'Get all visible components in
Drawing View1

vComps = swView.**GetVisibleDrawingComponents**

'Print the number of visible
components
...
'Iterate through the visible
components and print each one's name
...
' Print the referenced assembly
component name

swComp = swDrComp.Component

If
Not IsNothing(swComp)
...
Call swComp.GetBodies3(swBodyType\_e.swAllBodies,
vBodies)

If
Not IsNothing(vBodies)

Then

Debug.Print("
Component bodies exist.")
