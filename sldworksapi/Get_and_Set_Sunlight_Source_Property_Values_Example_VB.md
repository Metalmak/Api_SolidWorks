...
    Debug.Print "Minutes of sunlight: " & swModelDocExt.**SunLightInformation**(swSunlight\_LengthOfDay**)** Debug.Print "Sunrise (hours from midnight): " &
swModelDocExt.**SunLightInformation**(swSunlight\_Sunrise)
    Debug.Print "Sunset (hours from midnight): " & swModelDocExt.**SunLightInformation**(swSunlight\_Sunset)
