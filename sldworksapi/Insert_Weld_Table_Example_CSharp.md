...
// 2. Verify that *install\_dir*\**lang\english\weldtable-standard.sldwldtbt**
exists.
//
// Postconditions:
...
System;
namespace
InsertWeldTable\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
true,
true, 0, 0,
(int)swBOMConfigurationAnchorType\_e.swBOMConfigurationAnchor\_BottomLeft, "Default",
WeldTableTemplate);
        }
