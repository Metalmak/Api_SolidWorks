...
| DTaskpaneViewEvents\_TaskPaneDeactivateNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DTaskpaneViewEvents\_TaskPaneDeactivateNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See TaskPaneDeactivateNotify Event (TaskpaneView).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAppTaskPaneDeactivateNotify to register for this notification.
