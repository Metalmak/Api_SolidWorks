...
    Set Part = swApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2018\samples\tutorial\api\block20.sldprt", 1, 0, "", longstatus,
longwarnings)
...
"VERTEX", 6.46002912861796E-02, 0, 4.93456023787655E-02, False, 1, Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByID2**("",
...
Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByID2**("",
"VERTEX", -6.24778997860176E-02, 0, 4.93456023787655E-02, True, 1, Nothing, 0)

    Part.**Insert3DSplineCurve** False
    Part.**ClearSelection2** True
    boolstatus = Part.**Extension**.**SelectByID2**("Curve1",
"REFERENCECURVES", 0, 0, 0, False, 0, Nothing, 0)
