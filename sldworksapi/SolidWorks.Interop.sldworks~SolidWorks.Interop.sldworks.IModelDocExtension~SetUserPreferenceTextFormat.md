...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDocExtension Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension.html) : SetUserPreferenceTextFormat Method (IModelDocExtension) |
...
*UserPref*
:   User preference as defined by swUserPreferenceTextFormat\_e
...
*Value*
:   [Text format](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ITextFormat.html) to which to assign the user preference specified in UserPref
...
See ModelDocExtension::SetUserPreferenceTextFormat.
