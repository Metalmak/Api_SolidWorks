...
namespace Scene\_CSharp.csproj
{
...
            Scene.**BackgroundType** = (int)swSceneBackgroundType\_e.swBackgroundType\_UseEnvironment;
            Debug.Print("Type of scene background as defined in swSceneBackgroundType\_e: " + Scene.**BackgroundType**);
...
            Debug.Print("Scale the scene floor
uniformly? " + Scene.**FixedAspectRatio**);
            Debug.Print("Flip the scene floor direction? " + Scene.**FloorDirection**);
            Debug.Print("Automatically resize the scene floor
based on the model bounding box? " + Scene.**FloorAutoSize**);
