...
2019\samples\tutorial\api\assem20.sldasm", 2, 0, "", longstatus, longwarnings)
...
2019\samples\tutorial\api\shaft.sldprt", 1, 32, "", errors, longwarnings)
    Set Part = swApp.**ActivateDoc3**(AssemblyTitle, True, 0, errors)

    Set swInsertedComponent =
Part.**AddComponent5**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS
2019\samples\tutorial\api\shaft.sldprt", 0, "", False, "", 0.29642267129384,
9.20506109250709E-02, -0.187506963149644)
    swApp.**CloseDoc** "C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS
2019\samples\tutorial\api\shaft.sldprt"
...
    Set swTransform =
swMathUtil.**CreateTransform**((TransformDataVariant))
    boolstatus =
...
-0.758094294050284, 2.99151229353486E-03, 2, True, 1, 0)
    boolstatus = Part.Extension.SelectByRay(0.130082347379926,
5.12737883206569E-02, -2.38688162796734E-02, -0.400036026779312,
-0.515038074910024, -0.758094294050284, 2.99151229353486E-03, 2, True, 1, 0)
...
    boolstatus = Part.Extension.SelectByRay(-2.47922125254263E-03,
...
    boolstatus = Part.Extension.SelectByRay(-1.30850967460105E-02,
...
    boolstatus = Part.Extension.SelectByRay(-2.65813760897231E-02,
