...
System.Diagnostics;
namespace
ChamferDisplayDimension\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
type as defined in swDimensionType\_e: " +
swDispDim.**Type2**);
...
                int
AngUnit = 0;
                bRet = swDispDim.**GetChamferUnits**(out
LenUnit, out
AngUnit);
                Debug.Print("Uses
local length unit as defined in swLengthUnit\_e: "
+ LenUnit);
                //0=swMM
                //0=swDegrees,
3=swRadians
...
            int
indx = 0;
            swDispDim.**set\_ChamferPrecision**(indx, 0);
            Debug.Print("Precision
of chamfer distance: " + indx +
" decimal places");
            swDispDim.**set\_ChamferPrecision**(indx, 1);
            Debug.Print("Precision
of chamfer angle: " + indx +
" decimal places");
...
            count = swDispDim.**GetTextFormatItems**((int)swDimensionTextParts\_e.swDimensionTextCalloutAbove,
out
objTokenFormats, out
objTokenValues);
            Debug.Print("Number
...
            }
            Debug.Print("");
            count = swDispDim.**GetTextFormatItems**((int)swDimensionTextParts\_e.swDimensionTextPrefix,
out
objTokenFormats, out
objTokenValues);
            Debug.Print("Number
...
            }
            Debug.Print("");
            count = swDispDim.**GetTextFormatItems**((int)swDimensionTextParts\_e.swDimensionTextSuffix,
out
objTokenFormats, out
objTokenValues);
            Debug.Print("Number
...
            }
            Debug.Print("");
            count = swDispDim.**GetTextFormatItems**((int)swDimensionTextParts\_e.swDimensionTextCalloutBelow,
out
objTokenFormats, out
objTokenValues);
            Debug.Print("Number
