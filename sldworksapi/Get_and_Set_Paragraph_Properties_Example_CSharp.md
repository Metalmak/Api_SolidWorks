...
namespace GetParagraphs\_CSharp.csproj
{
...
                    Debug.Print("Paragraph list type as defined in swParagraphType\_e: " + paraType);
                    if (paraType == 1)
                    {
                        Debug.Print("Numbered list:");
                        Debug.Print("  Start numbering from location as defined in swNumberedListStartType\_e: " + numberingtype);
