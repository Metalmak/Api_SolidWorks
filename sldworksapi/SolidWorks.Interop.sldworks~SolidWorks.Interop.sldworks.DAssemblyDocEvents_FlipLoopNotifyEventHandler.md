...
| DAssemblyDocEvents\_FlipLoopNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_FlipLoopNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See FlipLoopNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyFlipLoopNotify to register for this notification.
