...
# Fire Notification When Component Referenced Display State Changes Example (VBA)
...
'Send message after user changes referenced display state
of a component in an assembly

Private Function swAssem\_ComponentReferredDisplayStateChangeNotify(ByVal
...
    MsgBox
"The component's referenced display state has changed."
