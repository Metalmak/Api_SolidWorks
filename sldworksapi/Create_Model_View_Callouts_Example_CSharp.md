...
System.Diagnostics;
namespace
ModelViewCallout\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            ViewMgr.ViewportDisplay = (int)swViewportDisplay\_e.swViewportFourView;
...
                Viewcallout.set\_Label2(0,"TEST");
                Viewcallout.SkipColon =
false;
                Viewcallout.set\_ValueInactive(0,true);
