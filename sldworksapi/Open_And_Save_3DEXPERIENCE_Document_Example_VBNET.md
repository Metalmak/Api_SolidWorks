...
' 6. Press F5 to re-load
the document from your

'
collaborative space In **3D**EXPERIENCE.
...
'
on the **3D**EXPERIENCE platform and re-opened.

' 2. Use **3D**EXPERIENCE
3DSearch to find **NonActiveSave.sldprt**
...
Dim swPLMObjectSpecification
As

PLMObjectSpecification

Dim swDocSpecification
As
...
swApplicationType\_e.swApplicationType\_3DEXPERIENCE
...
Stop
'Close the document in the user
interface

'Re-open the document from
**3D**EXPERIENCE
