...
namespace
DivideSketchSegment\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            skSegment = Part.**SketchManager**.**CreateLine**(-0.067186,
0.00851, 0.0, 0.07118, 0.081524, 0.0);
...
"SKETCHSEGMENT",
0.0058451006543539, 0.017433416397686, -0.0149283857579217,
false, 0,
null, 0);

            SkSeg = (SketchSegment)((SelectionMgr)Part.**SelectionManager**).**GetSelectedObject6**(1,
-1);
            boolstatus = SkSeg.**EqualSegment**((int)swSketchSegmentType\_e.swSketchSegmentType\_sketchpoints,
99);
