...
| DPartDocEvents\_DeleteCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_DeleteCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See DeleteCustomPropertyNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartDeleteCustomPropertyNotify to register for this notification.
