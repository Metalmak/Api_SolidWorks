...
        swModel = swApp.**OpenDoc6**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2018\samples\tutorial\api\beam\_boltconnection.sldasm", 2, 0, "", longstatus, longwarnings)
        swApp.**ActivateDoc2**("beam\_boltconnection", False, longstatus)
...
        swContFeat = swMotionStudy1.**CreateDefinition**(swFeatureNameID\_e.swFmAEM3DContact)
...
        boolstatus = swModelDocExt.**SelectByID2**("Beam with holes-1@beam\_boltconnection", "COMPONENT", 0, 0, 0, False, 0, Nothing, 0)
        boolstatus = swModelDocExt.**SelectByID2**("Beam with holes-2@beam\_boltconnection", "COMPONENT", 0, 0, 0, True, 0, Nothing, 0)
...
        swContFeat.**FrictionOption** = swMotionContactFrictionType\_e.swMotionContactFrictionFull

        ' Create a 3D Contact feature
        swFeat = swMotionStudy1.**CreateFeature**(swContFeat)

        boolstatus = swModelDocExt.**SelectByID2**("Solid Body Contact1", "SIMULATION\_ELEMENT", 0, 0, 0, False, 0, Nothing, 0)
...
            End If
            If swContFeat.**FrictionOption** = swMotionContactFrictionType\_e.swMotionContactFrictionFull Then
