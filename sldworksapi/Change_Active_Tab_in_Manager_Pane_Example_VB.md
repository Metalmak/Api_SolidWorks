...
'    in the Manager Pane.
' 2. In the SOLIDWORKS Microsoft Visual Basic for Applications IDE:
'    a. Copy [Main](#Main) to the main module.
'    b. Click **Insert > Class Module** and copy
[Class1](#Class1) to that module.
