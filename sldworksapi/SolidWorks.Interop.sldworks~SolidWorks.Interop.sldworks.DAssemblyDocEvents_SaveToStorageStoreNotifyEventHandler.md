...
| DAssemblyDocEvents\_SaveToStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_SaveToStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See SaveToStorageStoreNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblySaveToStorageStoreNotify to register for this notification.
