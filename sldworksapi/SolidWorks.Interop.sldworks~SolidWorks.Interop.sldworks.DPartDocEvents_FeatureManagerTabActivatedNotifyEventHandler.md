...
| DPartDocEvents\_FeatureManagerTabActivatedNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_FeatureManagerTabActivatedNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See FeatureManagerTabActivatedNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartFeatureManagerTabActivatedNotify to register for this notification.
