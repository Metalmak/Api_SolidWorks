...
| DPartDocEvents\_UserSelectionPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_UserSelectionPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See UserSelectionPreNotify Event (PartDoc).
...
If developing a C++ application, use swPartUserSelectionPreNotify to register for this notification.
