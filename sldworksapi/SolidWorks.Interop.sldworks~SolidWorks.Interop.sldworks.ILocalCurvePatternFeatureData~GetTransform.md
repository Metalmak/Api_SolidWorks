...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ILocalCurvePatternFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILocalCurvePatternFeatureData.html) : GetTransform Method (ILocalCurvePatternFeatureData) |
...
See LocalCurvePatternFeatureData::GetTransform.

# ![](dotnetimages/collapse.gif)Remarks

Valid values for Instance are 1 <= Instance <= [ILocalCurvePatternFeatureData::GetPatternComponentCount](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ILocalCurvePatternFeatureData~GetPatternComponentCount.html).
