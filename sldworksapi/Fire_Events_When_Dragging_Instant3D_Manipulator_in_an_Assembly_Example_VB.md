...
' 2. Copy and paste [Main](#Main) into the main module.
' 3. Click **Insert > Class** module and copy and paste
'    [Class1](#Class1) into the class module.
...
' 5. Writes a
debug statement to the Immediate window
'    informing you that dragging
of an Instant3D
...
Private Function doc\_DragStateChangeNotify(ByVal
