...
// 2. Press F5 at each System.Diagnostics.Debugger.Break
statement.
...
namespace
SelectSketchRegion\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            SelectData
mySelectData = default(SelectData);
            Feature
myFeature = default(Feature);
            Sketch
mySketch = default(Sketch);
            int
regionCount = 0;
            object[]
vSkRegions = null;
            SketchRegion
skRegion = default(SketchRegion);
            Loop2
myLoop = default(Loop2);
            int
edgeCount = 0;
            int
vertexCount = 0;
...
                for
(i = vSkRegions.GetLowerBound(0); i <= vSkRegions.GetUpperBound(0); i++)
                {
...
                            for
(k = vEdges.GetLowerBound(0); k <= vEdges.GetUpperBound(0); k++)
                            {
...
                            for
(k = vVertices.GetLowerBound(0); k <= vVertices.GetUpperBound(0); k++)
                            {
