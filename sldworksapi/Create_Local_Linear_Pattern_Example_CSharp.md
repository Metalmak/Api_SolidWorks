...
namespace CreateLocalLinearPattern\_CSharp
{
...
            swLocalLinearPatternFD = (LocalLinearPatternFeatureData)swFeatureManager.**CreateDefinition**((int)swFeatureNameID\_e.swFmLocalLPattern);
