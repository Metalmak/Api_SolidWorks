...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IPageSetup Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPageSetup.html) : GetHeaderFooterString Method (IPageSetup) |
...
*WhichOne*
:   Type of string as defined in swStandardHeaderFooterPageSetupTexts\_e
...
See PageSetup::GetHeaderFooterString.
