...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IAssemblyDoc Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc.html) : AddComponent5 Method (IAssemblyDoc) |
...
*ConfigOption*
:   Mode in which to open the document as specified in swAddComponentConfigOptions\_e
...
:   Name for the new assembly configuration;
    ...
    * swAddComponentConfigOptions\_e.swAddComponentConfigOptions\_NewConfigWithAllReferenceModels - or -* swAddComponentConfigOptions\_e.swAddComponentConfigOptions\_NewConfigWithAsmStructure
