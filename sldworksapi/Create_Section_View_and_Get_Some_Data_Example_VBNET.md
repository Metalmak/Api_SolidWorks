...
section views? " & swView.**EmphasizeOutline**)
...
        Debug.Print("
Display surface bodies? " & swSectionView.**DisplaySurfaceBodies)**     Debug.Print("
...
swSectionView.**GetAutoHatch)** Debug.Print(" Hide cut surface
