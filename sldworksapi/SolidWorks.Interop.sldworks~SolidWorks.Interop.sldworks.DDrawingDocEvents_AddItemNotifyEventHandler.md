...
| DDrawingDocEvents\_AddItemNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DDrawingDocEvents\_AddItemNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
*EntityType*
:   Type of the new item as defined in swNotifyEntityType\_e
...
See AddItemNotify Event (DrawingDoc).

# ![](dotnetimages/collapse.gif)Remarks

This method supports the addition of configurations.

If developing a C++ application, use swDrawingAddItemNotify to register for this notification.
