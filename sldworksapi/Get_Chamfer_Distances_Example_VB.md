...
As SldWorks.Feature
    Dim swChamfer
As SldWorks.ChamferFeatureData2
    Dim swVertex
As SldWorks.Vertex
    Dim vEdgeArr
As Variant
...
& swChamfer.**GetVertexChamferDistance**(0) \* 1000# & " mm"
    Debug.Print "    VertexChamferDistance(1)  = "
& swChamfer.**GetVertexChamferDistance**(1) \* 1000# & " mm"
    Debug.Print "    VertexChamferDistance(2)  = "
& swChamfer.**GetVertexChamferDistance**(2) \* 1000# & " mm"
    Debug.Print "    KeepFeatures              = " & swChamfer.**KeepFeatures**    Debug.Print "    Number of chamfered faces = " & swChamfer.**GetFaceCount** Debug.Print "    Number of chamfered edges
= " & swChamfer.**GetEdgeCount**    Debug.Print "    Type                      = " & swChamfer.**Type**
        ' ChamferFeatureData2::Type
        '   1 = Angle-Distance
        '   2 = Distance-Distance
        '   3 = Vertex

    ' Roll back to get access to geometric
entities
    bRet = swChamfer.**AccessSelections**(swModel, Nothing):
Debug.Assert bRet
...
            ' is
topology; instead, get edges (geometry) and select through
            ' entity from
edge
