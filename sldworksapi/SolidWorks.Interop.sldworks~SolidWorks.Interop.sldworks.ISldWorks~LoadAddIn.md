...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : LoadAddIn Method (ISldWorks) |
...
Status of loading the add-in as defined in swLoadAddinError\_e

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See SldWorks::LoadAddIn.
...
You cannot load PhotoView 360 using its add-in path. Instead, load PhotoView 360 as follows:

```
status = swApp.LoadAddIn('PhotoView 360') 'CASE INSENSITIVE
```
