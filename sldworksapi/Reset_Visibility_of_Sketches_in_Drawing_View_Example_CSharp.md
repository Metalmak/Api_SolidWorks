...
namespace
ResetSketchVisibilityCSharp.csproj
{
...
2018\\samples\\tutorial\\api\\resetsketchvisibility.SLDDRW";
...
            // Select a drawing view where
to hide a sketch
            boolstatus = swDrawing.**ActivateView**("Drawing
View1");

            // Hide the selected sketch
            boolstatus = swModelDocExt.**SelectByID2**("Sketch1@resetsketchvisibility-7@Drawing
View1",
"SKETCH", 0, 0, 0,
false, 0,
null, 0);
...
            // Examine the drawing to
verify that selected sketch is hidden, then press F5
            System.Diagnostics.Debugger.Break();

            // Select the drawing view with
the hidden sketch
...
            // Reset the visibility of
sketches in the selected
            //
