...
    swApp.**OpenDoc6** "C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2018\samples\tutorial\assemblymates\knee.sldprt",
...
    Set swFeat = swFeatMgr.**InsertMoveFace3**(swMoveFaceTypeTranslate,
False, 0, 0, (transParams), Nothing, swEndCondBlind, 0)
...
    swMoveFaceFeat.**TriadTranslationParameters**
= (transParams)

    ' Roll back the part with the modified
Move Face feature
