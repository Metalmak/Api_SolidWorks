...
2018\samples\tutorial\api\box.sldprt", 1, 0, "", longstatus, longwarnings)
...
lRipDirection, Nothing, 0)
    swModel.InsertRip 0.0001

    bRet = swModel.**Extension**.**SelectByID2**("Rip1",
...
    bRet = swRip.**AccessSelections**(swModel,
Nothing)
...
        Debug.Print
"Direction of rip for edge (0=current, 1=other, 2=both): " & swRip.**GetDirection**(swEdge)
