...
'----------------------------------------------------------------------------
' Preconditions: Open *public\_documents***\samples\tutorial\advdrawings\foodprocessor.slddrw**.
'
' Postconditions:
' 1. Inserts a note.
...
    Set myNote = Part.**InsertNote**("Drawing
View1 Note")
    If Not myNote Is Nothing Then
       myNote.**AllUpperCase** = True
       myNote.**SetTextVerticalJustification**
(swTextAlignmentVertical\_e.swTextAlignmentBottom)
       myNote.**LockPosition** = True
       Set myAnnotation = myNote.**GetAnnotation**()
       If Not myAnnotation Is Nothing Then
          boolstatus =
myAnnotation.**SetPosition**(0.2, 0.269, 0)
       End If
    End If
