...
namespace
GetTemplateSheetMetal\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            ModelDocExtension
swModelExt = default(ModelDocExtension);
            SelectData
swSelData = null;
            Feature
swSheetMetalTemplFeature = default(Feature);
            SheetMetalFeatureData
swSheetMetal = default(SheetMetalFeatureData);
            Face2
swFixedFace = default(Face2);
            Entity
