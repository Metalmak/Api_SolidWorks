...
//    \* Angle defined by the selected
sketch segment and an extension line
...
            myDisplayDim = (DisplayDimension)Part.**Extension**.**AddDimension**(-0.0456250220540824, 0, 0.00150965590938767, (int)swSmartDimensionDirection\_e.swSmartDimensionDirection\_Right);
