...
2018\samples\tutorial\api\sweepcutextrude2.SLDPRT", 1, 0, "", longstatus, longwarnings)
    swApp.ActivateDoc2 "sweepcutextrude.SLDPRT", False,
longstatus
    Set swModel = swApp.**ActiveDoc**
    Set swModelDocExt = swModel.**Extension**

    boolstatus = swModel.**Extension**.**SelectByID2**("Sketch4",
"SKETCH", 3.68377611840314E-02, -1.01247230141019E-02, 0, False, 1, Nothing, 0)
    boolstatus = swModel.**Extension**.**SelectByID2**("Sketch3",
"SKETCH", -0.030956245593495, -0.018624786459474, 0, True, 4, Nothing, 0)
