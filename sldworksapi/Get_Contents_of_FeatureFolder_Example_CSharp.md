...
// 3. Select **Add to New Folder**, which addsthe feature to
//    the new folder.
...
            IFeatureFolder
swFeatFolder = default(IFeatureFolder);
            Feature
swFtrFolder = default(Feature);
            string
FeatType = null;
            string
FeatTypeName = null;
...
                if
((FeatTypeName == "FtrFolder"
& !FeatType.Contains("EndTag")))
                {
...
                    Debug.Print("
Number of Features: " + swFeatFolder.**GetFeatureCount**());
                    for
(i = 0; i <= (swFeatFolder.**GetFeatureCount**() - 1); i++)
                    {
                        swFtrFolder = (Feature)Features[i];
                        Debug.Print("
Name of feature: " + swFtrFolder.**Name**);
                        Debug.Print("
Type of feature: " +
swFtrFolder.**GetTypeName2**());
                    }
                }
