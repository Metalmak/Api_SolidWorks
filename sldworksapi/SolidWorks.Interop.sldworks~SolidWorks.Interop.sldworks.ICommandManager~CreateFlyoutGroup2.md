...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ICommandManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICommandManager.html) : CreateFlyoutGroup2 Method (ICommandManager) |
...
See CommandManager::CreateFlyoutGroup2.
...
* [IFlyoutGroup::AddContextMenuFlyout](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IFlyoutGroup~AddContextMenuFlyout.html) to add the flyout to context menus.* [IFlyoutGroup::AddCommandItem](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IFlyoutGroup~AddCommandItem.html) to add menu items to the flyout group.
