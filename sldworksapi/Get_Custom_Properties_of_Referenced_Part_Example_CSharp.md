...
// 4. In the macro, replace *Property\_Name* with the name of
...
namespace
Get4CustomPropertyManagerCSharp.csproj
{
    partial
class
SolidWorksMacro
...
            swCustProp = swModelDocExt.**get\_CustomPropertyManager**("");
            status = swCustProp.**Get4**("*Property\_Name*",
false,
out val,
out valout);
