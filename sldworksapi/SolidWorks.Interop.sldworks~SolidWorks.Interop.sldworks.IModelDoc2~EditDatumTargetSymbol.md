...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDoc2 Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2.html) : EditDatumTargetSymbol Method (IModelDoc2) |
...
*ArrowStyle*
:   Arrow head style (for example, open, closed, and so on) as defined in swArrowStyle\_e

*LeaderLineStyle*
:   Leaderline type as defined in swLeaderStyle\_e
...
See ModelDoc2::EditDatumTargetSymbol.
