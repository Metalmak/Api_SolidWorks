...
// 1. Open a drawing.
// 2.
Replace *DXF\_file\_path* with the pathname of an existing DXF/DWG file.
...
namespace
InsertDXFDrawing\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            // Unit
            importData.s**et\_LengthUnit**("",
(int)swLengthUnit\_e.swINCHES);
...
(int)swImportDxfDwg\_ImportMethod\_e.swImportDxfDwg\_ImportToExistingDrawing);
...
            {
                if
(object.ReferenceEquals(swSketch,
swView.**GetSketch**()))
                {
                    break;
