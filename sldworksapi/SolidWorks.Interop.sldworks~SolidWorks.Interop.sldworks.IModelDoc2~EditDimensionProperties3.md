...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDoc2 Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2.html) : EditDimensionProperties3 Method (IModelDoc2) |
...
*ArrowsIn*
:   Value for the arrow direction as defined in swDimensionArrowsSide\_e

*UseDocArrows*
:   True to use the document's arrow types, false to use values specified for Arrow1 and Arrow2

*Arrow1*
:   Type of arrow to use on the first arrow of this dimension as defined in swArrowStyle\_e if UseDocArrows is false

*Arrow2*
:   Type of arrow to use on the second arrow of this dimension as defined in swArrowStyle\_e if UseDocArrows is false
...
*ConfigOption*
:   Configuration options as defined swInConfigurationOpts\_e

*ConfigNames*
:   Names of configurations to which to apply these edits (see **Remarks**)

Obsolete. Superseded by [IModelDocExtension::EditDimensionProperties](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~EditDimensionProperties.html).
...
See ModelDoc2::EditDimensionProperties3.
