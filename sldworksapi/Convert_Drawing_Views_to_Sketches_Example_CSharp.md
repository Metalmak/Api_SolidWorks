...
// 2.
Converts
**Drawing View2** to a sketch block
// 3.
Converts
**Drawing View3** to a sketch block at a new position in the
drawing.
//
...
namespace
ConvertViewToSketch\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
false, 0,
null, 0);
            drview = (View)selMan.**GetSelectedObject6**(1,
0);
...
            boolstatus = drview.**InsertViewAsBlock**(insertionPt,
position);
