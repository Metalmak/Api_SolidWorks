...
//----------------------------------------------------------------------------
// Preconditions:
// 1. Open *public\_documents***\samples\tutorial\api\TopAssembly1.SLDASM**
in lightweight
//    mode.
...
System.Diagnostics;
namespace
GetMatPropValues\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
I + ")"
+ "ConfigName : "
+ swComp.ReferencedConfiguration + "MatProp
: ");
                    Debug.Print("Red:
" + (varMatProp[0]) \* 255.0);
                    Debug.Print("Green:
