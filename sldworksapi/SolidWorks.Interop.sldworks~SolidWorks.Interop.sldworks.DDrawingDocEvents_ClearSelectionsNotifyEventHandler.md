...
| DDrawingDocEvents\_ClearSelectionsNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DDrawingDocEvents\_ClearSelectionsNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ClearSelectionsNotify Event (DrawingDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swDrawingClearNotificationsNotify to register for this notification.
