...
| DMouseEvents\_MouseMBtnUpNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DMouseEvents\_MouseMBtnUpNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See MouseMBtnUpNotify Event (Mouse).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swMouseMBtnUpNotify to register for this notification.
