...
String
        filename =
"C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2018\samples\tutorial\api\SimpleHole.slddrw"
...
                    ' If the feature is
HoleTableFeat, then get the table annotations
                    Do
Until
subFeature Is
Nothing
...
Object
                            holeTables =
swHoleTable.**GetTableAnnotations**
...
                                    ' If
the hole table is anchored, then continue
                                    If
swTable.**Type** = swTableAnnotationType\_e.swTableAnnotation\_HoleChart
Then
                                        If
...
holeTableAnchor As
TableAnchor
                                            holeTableAnchor = drwView.**Sheet**.**TableAnchor**(swTableAnnotationType\_e.swTableAnnotation\_HoleChart)
...
            Case
swDocumentTypes\_e.swDocASSEMBLY, swDocumentTypes\_e.swDocPART
