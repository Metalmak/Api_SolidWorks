...
    Dim tableType As swTableAnnotationType\_e
...
    Debug.Print ("Table type selected: swTableAnnotation\_General")
...
    Debug.Print ("Table type selected:
swTableAnnotation\_WeldmentCutList")
...
    Debug.Print ("Table type selected:
swTableAnnotation\_BillOfMaterials")
...
        listGrpArray(0) =
swBomTableSortItemGroup\_None
        listGrpArray(1) =
swBomTableSortItemGroup\_Parts
        listGrpArray(2) =
swBomTableSortItemGroup\_Other
    End If
...
    ' Save sorting scheme to the BOM table in
the drawing
...
    ' Apply sorting scheme saved in the BOM
table
