...
    Debug.Print "    Thickness: " & swShell.**Thickness**
\* 1000# & " mm"
    Debug.Print "    Count of faces removed: " &
swShell.**FacesRemovedCount**
    Debug.Print "    Count of faces with
alternative thicknesses: " & swShell.**GetMultipleThicknessFacesCount**

    bRet = swShell.**AccessSelections**(swModel,
Nothing)
...
        Debug.Print "
Alternative thickness in mm at face (" & i & "): " & swShell.**GetMultipleThicknessAtIndex**(i)
\* 1000#
        i = i + 1
