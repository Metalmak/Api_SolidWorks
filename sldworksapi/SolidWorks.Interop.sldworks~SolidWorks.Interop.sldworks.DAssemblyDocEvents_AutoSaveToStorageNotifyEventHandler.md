...
| DAssemblyDocEvents\_AutoSaveToStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_AutoSaveToStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See AutoSaveToStorageNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyAutoSaveToStorageNotify to register for this notification.
