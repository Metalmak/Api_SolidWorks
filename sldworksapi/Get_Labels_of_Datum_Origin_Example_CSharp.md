...
namespace GetLabels\_CSharp.csproj
{
...
            swDrawingDoc = (DrawingDoc)swApp.**NewDocument**(drawingDocTemplate, (int)swDwgPaperSizes\_e.swDwgPaperBsize, 0.2794, 0.4318);
...
            //Get whether to display hole sizes using
ANSI inch letters and drill numbers
            Debug.Print("Display ANSI inch letter and drill number
sizes in hole table? " + swHoleTable.**ShowANSIInchLetterNumberDrillSizes**);
