...
| IEntity Interface | |
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEntity_members.html)   [Example](#ExampleBookmark) | |
...
* error C3121: cannot change GUID for class 'IEntity'* error C2011: 'IEntity' : 'struct' type redefinition* undefined symbol errors when linking add-ins that do a QueryInterface on IEntity
...
* use SWEntity instead of IEntity in your code* do a QueryInterface using the GUID constant of the renamed interface:
