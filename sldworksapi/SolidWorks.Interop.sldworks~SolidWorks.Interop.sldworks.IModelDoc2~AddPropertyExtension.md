...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDoc2 Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2.html) : AddPropertyExtension Method (IModelDoc2) |
...
See ModelDoc2::AddPropertyExtension.

# ![](dotnetimages/collapse.gif)Remarks

To use this method:

1. Declare the variable.- Assign the variable a value: float, integer, or string.- Call this method to add the value to the model.
