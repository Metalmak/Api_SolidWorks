...
| DPartDocEvents\_DynamicHighlightNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_DynamicHighlightNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See DynamicHighlightNotify Event (PartDoc).
...
If developing a C++ application, use swPartDynamicHighlightNotify to register for this notification.
