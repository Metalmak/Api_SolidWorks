...
swCustomInfoType\_e.swCustomInfoDate, "4-13-59",
swCustomPropertyAddOption\_e.swCustomPropertyDeleteAndAdd)
    lRetVal = cusPropMgr.**Get6**("ADATE", False, ValOut,
ResolvedValOut, wasResolved, linkToProp)

    bRet = cusPropMgr.**IsCustomPropertyEditable**("ADATE",
config.**Name**)
    If bRet = 0 Then
        Debug.Print "    ADATE
is editable."
...
type, and evaluated value
    For j = 0 To nNbrProps - 1
        custPropType = cusPropMgr.**GetType2**(vPropNames(j))
        Debug.Print "    Name,
swCustomInfoType\_e value, and resolved value:  " & vPropNames(j) & ", ";
custPropType & ", " & vPropValues(j)
    Next j
