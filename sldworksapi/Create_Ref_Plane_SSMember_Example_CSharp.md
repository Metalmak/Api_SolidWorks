...
//    - **Plane2** and Plane3 parallel to
and flanking **Top Plane**

//    - **Plane4** and Plane5 parallel to
and flanking **Front Plane**

// 2. Configures the member profile.

// 3. Selects the start/end reference planes that
define the lengths of the members: **Plane1** and **Right Plane**.

// 4. Selects the axis reference planes that define the
direction of the members: **Plane2** and **Plane3**.

// 5. Selects the location reference planes that define
the positions of the members: **Plane4** and **Plane5**.

// 6. Creates a **Structure System1** with nine structure
system reference plane members.

// 7. Inspect the structure system in the graphics
area.
