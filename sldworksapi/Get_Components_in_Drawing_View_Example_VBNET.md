...
        assemblyDrawing =
"C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2018\samples\tutorial\driveworksxpress\mobile gantry.slddrw"
...
visible edges
                swDrawComp.**SetLineStyle**(swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible,
swLineStyles\_e.swLineCHAIN)
                Debug.Print("        Line
style for visible edges                      = "
& swDrawComp.**GetLineStyle**(swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible))
                ' Set new line thickness
for visible edges
                swDrawComp.**SetLineThickness**(swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible,
swLineWeights\_e.swLW\_CUSTOM, 0.0003)
                lineWeight = swDrawComp.**GetLineThickness**(swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible,
lineThickness)
                Debug.Print("        Line
