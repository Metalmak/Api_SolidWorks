...
        For paragraphIndex
= 0 To numParagraphs - 1

paragraphs.**CurrentParagraph** = paragraphIndex
            Debug.Print
"paragraph(" & paragraphIndex & "): "; paragraphs.**GetText**(True)
...
paragraphs.**GetBulletsAndNumbering** paraType, numberingtype, startas, numtype,
format
            Debug.Print
"Paragraph list type as defined in swParagraphType\_e: " & paraType
            If paraType =
1 Then
...
swNumberedListStartType\_e: " & numberingtype

Debug.Print "  Start numbering index: " & startas

Debug.Print "  Type as defined in swNumberedListType\_e: " & numtype

Debug.Print "  Format as defined in swNumberingFormat\_e: " & format
            End If

numSegs = paragraphs.**GetTextSegmentCount**
            Debug.Print
"Text segment count: " & numSegs
