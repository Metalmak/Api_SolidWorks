...
' 3. Copy [Class1](#class1)
to a class module named Class1.
'
' Postconditions:
...
>
> Set swTextFormat = myCallout.**TextFormat**ProcessTextFormat swApp, swModel, swTextFormat
...
End Sub
Private Function SwCalloutHandler\_OnStringValueChanged(ByVal pManipulator As
Object, ByVal RowID As Long, ByVal Text As String) As Boolean
