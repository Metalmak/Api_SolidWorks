...
namespace
DrawingViewRotateCSharp.csproj
{
...
2018\\samples\\tutorial\\driveworksxpress\\mobile
gantry.slddrw", (int)swDocumentTypes\_e.swDocDRAWING,
...
View4", "DRAWINGVIEW",
0.1122300799499, 0.1471819585104, 0, false,
0, null, 0);

            //Convert degrees to radians, the default
system unit

// 1 radian = 180º/p
= 57.295779513º or approximately 57.3º

            status = swDrawing.**DrawingViewRotate**(45 /
57.3);
        }
