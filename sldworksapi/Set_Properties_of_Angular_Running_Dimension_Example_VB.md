...
    Set dispdimvar = Part.**Extension**.**AddAngularRunningDim**(False,
...
running dimension? " & dispdim.**ExtensionLineExtendsFromCenterOfSet** Debug.Print "Are extension lines jogged? " & dispdim.**Jogged**
