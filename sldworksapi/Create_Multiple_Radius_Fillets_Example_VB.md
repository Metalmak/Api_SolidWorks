...
    'Create multiple-radius fillets along
selected edges
    swFeatMgr.**FeatureFillet** FilletOptions, 0.01,
swFeatureFilletType\_Simple, swFilletOverFlowType\_Default, (VarRadArray8), 0, 0
