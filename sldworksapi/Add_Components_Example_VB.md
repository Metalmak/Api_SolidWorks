...
'    b. Click **Insert > Reference Geometry > Coordinate
System**.
...
' 2. Replace *<component\_name>* in the code with the full path name
...
'       select Feature Properties, and rename the coordinate
system
...
    compNames(0) = "*<component\_name>*"

' Define the transformation matrix. See the IMathTransform
API documentation.

' Add a rotational diagonal unit matrix (zero rotation) to
...
' The last three elements of the transformation matrix are
unused
