...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISurfExtrudeFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurfExtrudeFeatureData.html) : ReleaseSelectionAccess Method (ISurfExtrudeFeatureData) |
...
See SurfExtrudeFeatureData::ReleaseSelectionAccess.
