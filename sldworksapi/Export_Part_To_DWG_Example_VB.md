...
swExportToDWG\_ExportAnnotationViews, False, varAlignment, False, False, 0, varViews

    'Export sheet metal to a single drawing
file
    options = 1   'include flat-pattern geometry
    swPart.**ExportToDWG2** sPathName, sModelName,
swExportToDWG\_ExportSheetMetal, True, varAlignment, False, False, options, Null
