...
namespace Capture3DView\_CSharp.csproj
{
...
            for (v\_counter = 0; v\_counter <= viewNames.GetUpperBound(0); v\_counter++) {
            Debug.Print("  " + viewNames[v\_counter]);
            }
...
            Debug.Print("Display mode as defined in swDisplayMode\_e: " + sw3DView.**DisplayMode**);
            Debug.Print("Scale: " + sw3DView.**Scale**);

modelBreakViewName = sw3DView.**ModelBreakViewName**;

if (modelBreakViewName ==
null)
            {
