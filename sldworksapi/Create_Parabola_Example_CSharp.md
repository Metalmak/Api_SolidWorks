...
part document must be active.", (int)swMessageBoxIcon\_e.swMbWarning,
...
            if
(!(pFocal.**Z** == 0) | !(pApex.**Z** == 0) | !(pStart.**Z** == 0)
| !(pEnd.**Z** == 0))
            {
                MessageBox.Show("Need
a 2D sketch.");
                return;
            }
...
            // Correct anomalies when the
parabola is aligned with the x and y axes
            if
(pFocal.**Y** == pApex.**Y**)
            {
                if
(pFocal.**X** > pApex.**X**)
                {
                    p = Math.Sqrt(Math.Pow((pFocal.**Y**
- pApex.**Y**), 2) + Math.Pow((pFocal.**X**
- pApex.**X**), 2));
                }
                else
                {
...
            if
(pFocal.**X** != pApex.**X** & pFocal.**Y** != pApex.**Y**)
            {
                p = (Math.Sqrt(Math.Pow((pFocal.**Y**
- pApex.**Y**), 2) + Math.Pow((pFocal.**X**
- pApex.**X**), 2)));
...
            // Obtain the correct value for
theta as the parabola rotates
            if
(pFocal.**X** != pApex.**X** & pFocal.**Y** != pApex.**Y**)
            {
                a = 1 / (4 \* p);
...
                if
(pFocal.**Y** > pApex.**Y** & pFocal.**X** > pApex.**X**)
                {
                    theta = Math.Atan((pFocal.**Y**
- pApex.**Y**) / (pFocal.**X** - pApex.**X**));
                }
