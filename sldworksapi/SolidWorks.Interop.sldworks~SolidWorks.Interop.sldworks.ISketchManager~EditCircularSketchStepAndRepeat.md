...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISketchManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager.html) : EditCircularSketchStepAndRepeat Method (ISketchManager) |
...
See SketchManager::EditCircularSketchStepAndRepeat.
