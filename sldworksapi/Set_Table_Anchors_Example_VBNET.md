...
        swDrw = swApp.**OpenDoc6**(filename, swDocumentTypes\_e.swDocDRAWING, swOpenDocOptions\_e.swOpenDocOptions\_Silent, "", errors, warnings)
...
        oldTableAnchor = swSheet.**TableAnchor**(swTableAnnotationType\_e.swTableAnnotation\_HoleChart)
        newTableAnchor = swSheet.**SetAsTableAnchor**(swTableAnnotationType\_e.swTableAnnotation\_HoleChart)
