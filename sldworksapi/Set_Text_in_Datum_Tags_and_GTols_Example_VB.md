...
    bRet = swDispGtol.**InsertBelowFrameTextAt**(1, "Line 1 of
below frame")
    bRet = swDispGtol.**InsertBelowFrameTextAt**(2, "Line 2 of
below frame")
    bRet = swDispGtol.**InsertBelowFrameTextAt**(3, "Line 3 of
below frame")
...
    'Inserts a line at index position 2,
because overwrite is set to False
    bRet = swDispGtol.**SetBelowFrameTextAt**(2, "Line 2
edited in below frame", False)
    Debug.Print "  swDispGtol.**GetBelowFrameTextAt**(2)"

    bRet = swDispGtol.**DeleteBelowFrameTextAt**(1)
'Deletes the first line in the below frame
    'bRet = swDispGtol.**DeleteBelowFrameTextAt**(-1)
'Deletes all below frame text
