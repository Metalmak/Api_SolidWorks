...
    'Get bodies resulting from the split
operation
...
    'Specify the origins of the bodies to save;
specify Nothing to use the default origins
...
    'Save the first body to a separate part
document
...
    'Create the Split feature, consuming all
split bodies
    Set swFeat = swFeatMgr.**PostSplitBody2**((vBodiesToMark),
True, (vBodyOrigins), (vBodyNames), "")
