...
0, swLineCONTINUOUS, swLW\_NORMAL, True, True)
...
    Set swDrawModel = swApp.**OpenDoc6**(swView.**GetReferencedModelName**,
swDocPART, swOpenDocOptions\_Silent, "", nErrors, nWarnings)
...
    vBody = swDrawPart.**GetBodies2**(swSolidBody,
True)
...
    ChangeComponentLayer swApp, swDraw,
swView.**Name**
