...
Array of intersecting object types as defined by swSelectType\_e:

* swSelFACES* swSelREFFACES* swSelDATUMPLANES

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See PrimaryMemberFacePlaneIntersectionFeatureData::GetIntersectingObjectTypes.
