...
| DDrawingDocEvents\_LoadFromStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DDrawingDocEvents\_LoadFromStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See LoadFromStorageStoreNotify Event (DrawingDoc).
...
If developing a C++ application, use swDrawingLoadFromStorageStoreNotify to register for this notification.
