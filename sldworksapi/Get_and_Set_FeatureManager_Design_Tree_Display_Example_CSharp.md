...
namespace
ViewFeatureManagerDesignTreeCSharp.csproj
{
    partial
class
SolidWorksMacro
...
            document = "C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS
2018\\samples\\tutorial\\advdrawings\\bladed
shaft.sldasm";

            swModelDoc = (ModelDoc2)swApp.**OpenDoc6**(document, (int)swDocumentTypes\_e.swDocASSEMBLY,
...
            Debug.Print("Show
feature details  = " + swFeatMgr.**ShowFeatureDetails**);
            Debug.Print("Show
hierarchy only   = " + swFeatMgr.**ShowHierarchyOnly**);
