...
        boolstatus = swModel.**Extension.SetUserPreferenceToggle**(swUserPreferenceToggle\_e.swShowZoneLines, 0,
True)
        boolstatus = swModel.**Extension**.**SetUserPreferenceInteger**(swUserPreferenceIntegerValue\_e.swRevisionTableMultipleSheetStyle, 0, swRevisionTableMultipleSheetStyle\_e.swRevisionTable\_Independent)
...
        boolstatus = swDraw.**NewSheet4**("Test", swDwgPaperSizes\_e.swDwgPaperAsize, swDwgTemplates\_e.swDwgTemplateAsize, 1, 1, True, "", 0, 0, "", 0.5, 0.5, 0.5, 0.5, 2, 2)
...
        boolstatus = swDraw.**SetupSheet6**("Test", swDwgPaperSizes\_e.swDwgPapersUserDefined, swDwgTemplates\_e.swDwgTemplateCustom, 1, 1, True, "C:\Program Files\SOLIDWORKS Corp\SOLIDWORKS\lang\english\sheetformat\a - landscape.slddrt", 0.2794, 0.2159, "Default", False, 0.5, 0.5, 0.5, 0.5, 3, 3)
...
        revTableAnno = currentsheet.**InsertRevisionTable2**(True, 0.0#, 0.0#, swBOMConfigurationAnchorType\_e.swBOMConfigurationAnchor\_TopLeft, "C:\Program Files\SOLIDWORKS Corp\SOLIDWORKS\lang\English\standard revision block.sldrevtbt", swRevisionTableSymbolShape\_e.swRevisionTable\_CircleSymbol, True)
