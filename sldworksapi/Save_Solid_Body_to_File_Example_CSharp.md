...
//----------------------------------------------------------------------------
// Preconditions: Open *public\_documents***\samples\tutorial\api\weldment\_box3.sldprt**.
//
// Postconditions:
...
// 4. At
System.Diagnostics.Debugger.Break(), press F5.
...
//
// NOTE: Because **weldment\_box3.sldprt** is used elsewhere, do not save changes.
//---------------------------------------------------------------------------
using
...
System;
namespace
CreatePartForSolidBody\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
+ "\\RefWeldment1"
+ ".sldprt",
1, swCutListTransferOptions\_e.swCutListTransferOptions\_CutListProperties, false,
"",
out
longstatus, out
longWarnings);
