...
boolstatus = swApp.**SetUserPreferenceIntegerValue**(swUserPreferenceIntegerValue\_e.swImportStlVrmlModelType,
swImportStlVrmlModelType\_e.swImportStlVrmlModelType\_Graphics)
...
boolstatus = swApp.**SetUserPreferenceIntegerValue**(swUserPreferenceIntegerValue\_e.swImportStlVrmlModelType,
swImportStlVrmlModelType\_e.swImportStlVrmlModelType\_Surface)

boolstatus = swApp.**SetUserPreferenceIntegerValue**(swUserPreferenceIntegerValue\_e.swImportStlVrmlModelType,
1)

swApp.SetUserPreferenceToggle(swUserPreferenceToggle\_e.swVrmlStlImportAsPSMesh,
True)
...
        If lSelType =
swSelectType\_e.swSelGRAPHICSBODY Then
...
ElseIf lSelType = swSelectType\_e.swSelGRAPHICSBODY Then
...
If lBodyType = swBodyType\_e.swGraphicsBody Then
...
If lSelType = swSelectType\_e.swSelFACETS Then
...
If lSelType = swSelectType\_e.swSelMESHFACETEDGES Then
...
If lSelType = swSelectType\_e.swSelMESHFACETVERTICES Then
...
If lSelType = swSelectType\_e.swSelSURFACEBODIES Then
...
If lBodyType = swBodyType\_e.swMeshBody Then
...
bFilter = swApp.GetSelectionFilter(swSelectType\_e.swSelMESHFACETEDGES)

swApp.SetSelectionFilter(swSelectType\_e.swSelMESHFACETEDGES, (bFilter =
False))
...
If lCurFilter = swSelectType\_e.swSelGRAPHICSBODY Then

Debug.Print("Selection filter is swSelGRAPHICSBODY")

ElseIf lCurFilter = swSelectType\_e.swSelFACETS Then

                    Debug.Print("Selection
filter is swSelFACETS")

ElseIf lCurFilter = swSelectType\_e.swSelMESHFACETEDGES Then

Debug.Print("Selection filter is swSelMESHFACETEDGES")

ElseIf lCurFilter = swSelectType\_e.swSelMESHFACETVERTICES Then
...
lSelFilters(0) = swSelectType\_e.swSelMESHFACETVERTICES
