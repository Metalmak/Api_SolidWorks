...
'    design tree.
' 2. Adds a new tab to each FeatureManager
design tree.
' 3. Activates the new tab
on the top of the FeatureManager
'    design tree.
...
As FeatMgrView
        Dim ctrlTop
As *activex\_control\_component\_declaration*
        Dim ctrlBtm
As *activex\_control\_component\_declaration*
        Dim fileName
As
...
        ' New
tab on original of FeatureManager design tree
