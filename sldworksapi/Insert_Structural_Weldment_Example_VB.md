...
    vSkLines =
Part.SketchManager.**CreateCornerRectangle**(0.06513561531715, 0.03369083550887, 0,
0.1807053904567, -0.08106219210316, 0)
...
    boolstatus = Part.**Extension**.**SelectByID2**("Line2@Sketch1", "EXTSKETCHSEGMENT",
...
    boolstatus =
Part.**Extension**.**SelectByID2**("Line5@Sketch1", "EXTSKETCHSEGMENT", 0.1185825251083,
0.03369083550887, 0, False, 0, Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByID2**("Line6@Sketch1", "EXTSKETCHSEGMENT",
...
    boolstatus =
Part.**Extension**.**SelectByID2**("c channel 3 x 5(1)", "BODYFEATURE", 0, 0, 0, False,
0, Nothing, 0)
...
Group.**Segments**
            For j =
LBound(vSegments) To UBound(vSegments)
...
    boolstatus =
Part.**Extension**.**SelectByID2**("c channel 3 x 5(2)", "BODYFEATURE", 0, 0, 0, False,
0, Nothing, 0)
    Set swWeldFeat = SelMgr.**GetSelectedObject6**(1, 0)
