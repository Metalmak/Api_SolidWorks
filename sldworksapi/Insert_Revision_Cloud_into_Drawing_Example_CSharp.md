...
//----------------------------------------------------------------------------
// Preconditions: Open *public\_documents***\samples\tutorial\api\resetsketchvisibility.slddrw.**
//
// Postconditions:
...
namespace
InsertRevisionCloud\_CSharp.csproj
{
    partial
class
SolidWorksMacro
