...
| DTaskpaneViewEvents\_TaskPaneActivateNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DTaskpaneViewEvents\_TaskPaneActivateNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See TaskPaneActivateNotify Event (TaskpaneView).
...
If developing a C++ application, use swAppTaskPaneActivateNotify to register for this notification.
