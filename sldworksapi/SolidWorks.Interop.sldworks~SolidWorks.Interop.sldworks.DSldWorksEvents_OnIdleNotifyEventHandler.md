...
| DSldWorksEvents\_OnIdleNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DSldWorksEvents\_OnIdleNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See OnIdleNotify Event (SldWorks).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAppOnIdleNotify to register for this notification.
