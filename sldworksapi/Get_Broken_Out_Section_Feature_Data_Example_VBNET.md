...
        For
I = LBound(varSheet) To
UBound(varSheet)
            varViews = varSheet(I)
            For
J = 1 To
UBound(varViews) ' skip the sheet
view
                Dim
swView As
View
...
' get and select depth reference,
if set
                        If
(swDepthRef Is
Nothing)
...
segType
                        Case
swSketchSegments\_e.swSketchLINE
                            Dim
swSegLine As
SketchLine
                            swSegLine = swSeg
...
Nothing
                        Case
swSketchSegments\_e.swSketchARC
                            Dim
swSegArc As
SketchArc
                            swSegArc = swSeg
