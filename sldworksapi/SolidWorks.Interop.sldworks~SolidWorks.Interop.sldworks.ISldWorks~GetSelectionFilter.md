...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : GetSelectionFilter Method (ISldWorks) |
...
*SelType*
:   Selection type to verify as defined in swSelelectType\_e
...
See SldWorks::GetSelectionFilter.
