...
Set swEdge = selMgr.GetSelectedObject6(1,
-1)
...
retPar = swCurve.GetEndParams(param(0),
param(1), isClose, isPeriodic)

BoundSuf = param

status = swCurve.FindMinimumRadius(BoundSuf,
numOfRadius, radius, location, uvparameter)
