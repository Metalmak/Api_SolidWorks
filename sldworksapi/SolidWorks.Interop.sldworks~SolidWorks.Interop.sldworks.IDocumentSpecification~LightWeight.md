...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IDocumentSpecification Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDocumentSpecification.html) : LightWeight Property (IDocumentSpecification) |
...
See DocumentSpecification::LightWeight.
...
[IDocumentSpecification::UseLightWeightDefault](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IDocumentSpecification~UseLightWeightDefault.html) must be false for this property to have an effect.
