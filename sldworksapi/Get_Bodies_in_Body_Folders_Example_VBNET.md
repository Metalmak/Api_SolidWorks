...
"," & FeatType
& "," &
BodyFolderType(BodyFolderTypeE) & " type
" & BodyFolderTypeE)
...
            Dim
FeatureFromBodyFolder As
Feature
            FeatureFromBodyFolder = BodyFolder.**GetFeature**

            If
Not
FeatureFromBodyFolder Is
thisFeat Then
                MsgBox("Features
don't match!")
            End
...
Nothing
            DoTheWork(curFeat)
'Do the thing that we are doing this feature
traversal for
