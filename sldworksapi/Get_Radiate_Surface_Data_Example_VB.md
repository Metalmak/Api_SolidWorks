...
' 2. Creates **Boss-Extrude1**  and **Surface-Radiate1** in the graphics
area and
...
4.66820674117181E-03, False, 0, Nothing, 0)
...
    Part.**InsertRadiateSurface** 0.0254,
False, False

    Set swSelMgr = Part.**SelectionManager**
    Set swSelData = swSelMgr.**CreateSelectData**

    boolStatus = Part.**Extension**.**SelectByID2**("Surface-Radiate1",
...
    Debug.Print "    Distance: " & swRadiate.**Distance** \*
1000# & " mm"
