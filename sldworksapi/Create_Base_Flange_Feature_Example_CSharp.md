...
swBaseFlangeFeat = (BaseFlangeFeatureData)swModel.FeatureManager.**CreateDefinition**((int)swFeatureNameID\_e.swFmBaseFlange);

cba = (CustomBendAllowance)swBaseFlangeFeat.**GetCustomBendAllowance**();

cba.**Type** = (int)swBendAllowanceTypes\_e.swBendAllowanceDirect;
...
false,
(int)swSheetMetalReliefTypes\_e.swSheetMetalReliefRectangular,
...
Debug.Print("Relief
type as defined by swSheetMetalReliefTypes\_e: "
...
Debug.Print("Result
code for override of AutoRelief as defined by swSheetMetalModifierError\_e: " + smFeatData.**SetOverrideDefaultParameter2**((int)swSheetMetalOverrideDefaultParameters\_e.swSheetMetalOverrideDefaultParameters\_AutoRelief,
