...
'    is selected.
' 3. Under **Override Units** on the Other tab, observe that:  **'    \* Decimal** is clicked.
...
View1", "DIMENSION", 0.305961854224123, 0.247549077953509, 0, False, 0, Nothing,
0)
    Set swDispDim = swSelMgr.**GetSelectedObject6**(1, 0)

    longstatus = swDispDim.**SetUnits2**(False,
swLengthUnit\_e.swFEETINCHES, swFractionDisplay\_e.swDECIMAL, 0, False,
swUnitsDecimalRounding\_e.swUnitsDecimalRounding\_Truncate)
