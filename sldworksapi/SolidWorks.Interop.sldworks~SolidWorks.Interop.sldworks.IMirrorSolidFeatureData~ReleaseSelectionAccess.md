...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IMirrorSolidFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMirrorSolidFeatureData.html) : ReleaseSelectionAccess Method (IMirrorSolidFeatureData) |
...
See MirrorSolidFeatureData::ReleaseSelectionAccess.
