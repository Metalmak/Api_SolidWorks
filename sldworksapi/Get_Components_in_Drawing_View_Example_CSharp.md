...
namespace
LineFontsDrawingComponentCSharp.csproj
{
    partial
class
SolidWorksMacro
...
default(DrawingComponent);
            object[]
vDrawChildCompArr = null;
            DrawingComponent swDrawComp =
default(DrawingComponent);
...
gantry.slddrw";
            swModel = (ModelDoc2)swApp.**OpenDoc6**(assemblyDrawing, (int)swDocumentTypes\_e.swDocDRAWING,
...
                // Returns
NULL if
underlying model is open in a different configuration
                swComp =
(Component2)swDrawComp.**Component**;
...
                {
                    // Returns NULL if
drawing is lightweight
                    swCompModel =
(ModelDoc2)swComp.**GetModelDoc2**();
...
                    // Turn off using
document default settings for component's line font style
...
                    // Set new line style
for visible edges
                    swDrawComp.**SetLineStyle**((int)swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible,
(int)swLineStyles\_e.swLineCHAIN);
                    Debug.Print("        Line
style for visible edges                      = "
+ swDrawComp.**GetLineStyle**((int)swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible));
                    // Set new line
thickness for visible edges
                    swDrawComp.**SetLineThickness**((int)swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible,
(int)swLineWeights\_e.swLW\_CUSTOM,
0.0003);
                    lineWeight = swDrawComp.**GetLineThickness**((int)swDrawingComponentLineFontOption\_e.swDrawingComponentLineFontVisible,
out
lineThickness);
                    Debug.Print("        Line
