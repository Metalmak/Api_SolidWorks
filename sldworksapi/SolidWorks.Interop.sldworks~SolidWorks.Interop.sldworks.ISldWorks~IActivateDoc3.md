...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : IActivateDoc3 Method (ISldWorks) |
...
*Errors*
:   Status of the document activate operation as defined in swActivateDocError\_e; if no errors or warnings are encountered, this value is set to 0
