...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IComponent2 Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IComponent2.html) : AddPropertyExtension Method (IComponent2) |
...
See Component2::AddPropertyExtension.
...
1. Declare the variable.- Assign the variable a value: float, integer, or string.- Call this method to add the value to the component.
