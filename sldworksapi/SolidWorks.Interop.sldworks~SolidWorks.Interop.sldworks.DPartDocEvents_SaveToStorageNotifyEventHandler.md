...
| DPartDocEvents\_SaveToStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_SaveToStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See SaveToStorageNotify Event (PartDoc).
...
If developing a C++ application, use swPartSaveToStorageNotify to register for this notification.
