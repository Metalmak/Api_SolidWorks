...
| DPartDocEvents\_SaveToStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_SaveToStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See SaveToStorageStoreNotify Event (PartDoc).
...
If developing a C++ application, use swPartSaveToStorageStoreNotify to register for this notification.
