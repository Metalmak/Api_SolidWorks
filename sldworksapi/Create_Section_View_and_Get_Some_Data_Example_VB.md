...
'--------------------------------------------------------------------------
' Preconditions:
' 1. Open *public\_documents***\samples\tutorial\driveworksxpress\mobile gantry.slddrw**' 2. Open the Immediate window.'
' Postconditions:
...
    ' Activate the view for which you want to
...
    ' Create the section view at the specified
coordinates
...
    Debug.Print "  Display only SpeedPak bodies? " & swSectionView.**GetDisplayOnlySpeedPakBodies**     Debug.Print "  Get scale with model changes? " & swSectionView.**GetScaleWithModelChanges**     Debug.Print "  Auto-hatch enabled? " & swSectionView.**GetAutoHatch**Debug.Print "  Hide cut surface bodies? " & swSectionView.**CutSurfaceBodies**
