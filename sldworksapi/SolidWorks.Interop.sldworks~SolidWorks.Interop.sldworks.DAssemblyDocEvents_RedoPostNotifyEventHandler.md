...
| DAssemblyDocEvents\_RedoPostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_RedoPostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See RedoPostNotify Event (AssemblyDoc).
...
If developing a C++ application, use swAssemblyRedoPostNotify to register for this notification.
