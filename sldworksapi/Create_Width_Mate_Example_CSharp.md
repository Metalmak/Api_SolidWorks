...
            if (swMateData.TypeName == (int)swMateType\_e.swMateWIDTH)
            {

                swWidthMateData = (WidthMateFeatureData)swMateData;
                swWidthMateData.**ConstraintType** = (int)swMateWidthOptions\_e.swMateWidth\_Dimension;
...
                if (swWidthMateData.**ConstraintType** == (int)swMateWidthOptions\_e.swMateWidth\_Dimension)
                {
...
                swWidthMateData.**ConstraintType** = (int)swMateWidthOptions\_e.swMateWidth\_Percent;
