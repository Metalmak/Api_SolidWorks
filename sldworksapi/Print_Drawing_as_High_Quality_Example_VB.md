...
    Set swModel = swApp.**OpenDoc6**(drawing, swDocDRAWING,
...
& printSpec.**PrintCrossHatchOnOutOfDateViews**
    Debug.Print "  Printer queue: " & printSpec.**PrinterQueue**    Debug.Print "    File: " & printSpec.**PrintFile**
    Debug.Print "  Print white items black: " & printSpec.**PrintWhiteItemsBlack**
    Debug.Print "  Selection as defined in
swPrintSelectionScaleFactor\_e: " & printSpec.**ScaleMethod**
