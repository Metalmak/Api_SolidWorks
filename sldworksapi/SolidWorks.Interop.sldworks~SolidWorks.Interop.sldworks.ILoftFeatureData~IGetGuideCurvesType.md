...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ILoftFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoftFeatureData.html) : IGetGuideCurvesType Method (ILoftFeatureData) |
...
* in-process, unmanaged C++: Pointer to an array of the types of guide curves as defined by swSelectType\_e of size Count
