...
| DPartDocEvents\_DeleteItemPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_DeleteItemPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See DeleteItemPreNotify Event (PartDoc).
...
If developing a C++ application, use swPartDeleteItemPreNotify to register for this notification.
