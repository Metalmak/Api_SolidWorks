...
|  | Name | Description |
| --- | --- | --- |
| ![ Property](dotnetimages/Property.gif) | [CreatedBy](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~CreatedBy.html) | Gets the name of the user who created the feature. |
| ![ Property](dotnetimages/Property.gif) | [CustomPropertyManager](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~CustomPropertyManager.html) | Gets the custom property information for weldment and cut-list item features only. |
| ![ Property](dotnetimages/Property.gif) | [DateCreated](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~DateCreated.html) | Gets the date on which the feature was created. |
| ![ Property](dotnetimages/Property.gif) | [DateModified](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~DateModified.html) | Gets the date on which the feature was last modified. |
| ![ Property](dotnetimages/Property.gif) | [Description](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~Description.html) | Gets or sets the description for this feature. |
| ![ Property](dotnetimages/Property.gif) | [ExcludeFromCutList](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~ExcludeFromCutList.html) | Gets or sets whether to exclude this feature from the cut list. |
| ![ Property](dotnetimages/Property.gif) | [Is3DInterconnectFeature](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~Is3DInterconnectFeature.html) | Gets whether this is a 3D Interconnect feature. |
| ![ Property](dotnetimages/Property.gif) | [Is3DInterconnectUpdateAvailable](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~Is3DInterconnectUpdateAvailable.html) | Gets whether an update is available for this 3D Interconnect part or assembly. |
| ![ Property](dotnetimages/Property.gif) | [Name](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~Name.html) | Gets or sets the name of the current feature. |
| ![ Property](dotnetimages/Property.gif) | [Visible](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeature~Visible.html) | Gets the visibility state of this feature. |
