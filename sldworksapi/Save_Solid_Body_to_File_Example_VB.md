...
            If
swBodyFolder Is Nothing Then ErrorMsg Swapp, "Failed to get body folder"
...
            If boolstatus
= False Then ErrorMsg Swapp, "Failed to select feature"
...
            boolstatus =
currentModel.**SaveToFile3**(Swapp.**GetCurrentMacroPathFolder** +
"\RefWeldment1" + ".sldprt", 1,
swCutListTransferOptions\_CutListProperties, False, "", longstatus, longWarnings)
            Stop
            If boolstatus
= False Then ErrorMsg Swapp, "Failed to insert weldment member into new part"

Set swModel = Swapp.**ActiveDoc**
            If swModel Is
Nothing Then ErrorMsg Swapp, "Failed to set open model as active document"
...
Swapp, "Failed to get first feature"

        Do While Not
swFeat Is Nothing
            If swFeat.**GetTypeName2**
= "SolidBodyFolder" Then
