...
namespace LimitAngleMate\_CSharp
{
...
            swAngleMateData.**MateAlignment** = (int)swMateAlign\_e.swMateAlignALIGNED;
...
            if (swMateData.**TypeName** == (int)swMateType\_e.swMateANGLE)
            {

                Debug.Print("Angle mate alignment is " + swAngleMateData.**MateAlignment**);

                if (swAngleMateData.**MateAlignment** == (int)swMateAlign\_e.swMateAlignALIGNED)
                {
                    swAngleMateData.**MateAlignment** = (int)swMateAlign\_e.swMateAlignANTI\_ALIGNED;
                }
                else
                {
                    swAngleMateData.**MateAlignment** = (int)swMateAlign\_e.swMateAlignALIGNED;
