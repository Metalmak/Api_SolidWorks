...
| DPartDocEvents\_ModifyTableNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_ModifyTableNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ModifyTableNotify Event (PartDoc).
...
If developing a C++ application, use swPartModifyTableNotify to register for this notification.
