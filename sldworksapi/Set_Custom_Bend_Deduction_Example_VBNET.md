...
        Feature = Part.**SelectionManager**.**GetSelectedObject6**(1,
-1)
...
        ' Get whether to use default bend
allowance to determine the current state
        Dim
useCustom As
Boolean
        useCustom = FeatureData.**UseDefaultBendAllowance**

        ' Get the custom bend allowance
object
...
Long
        bType = bData.**Type**
        ' Set the bend allowance type to
deduction
        bData.**Type** =
