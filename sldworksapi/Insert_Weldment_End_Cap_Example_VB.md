...
cap1", "BODYFEATURE", 0, 0, 0, False, 0, Nothing, 0)
    Part.**EditDelete**

    Part.**ViewZoomTo2** 0.632542197290199,
0.972121141705638, 3.46184961022406E-02, 1.1852319686392, 0.619681287512073,
3.46184961022431E-02
...
    Set myFeature = Part.**FeatureManager**.**InsertEndCapFeature3**(0.005,
False, False, 0.003, 0.6, 0.003, True, 0.002, False, 2)
...
= " & swEndCap.**DepthDistance** \* 1000# & " mm"
    Debug.Print "    Thickness direction
(0=outward, 1=inward, 2=inset) = " & swEndCap.**IsEndCapInward**
