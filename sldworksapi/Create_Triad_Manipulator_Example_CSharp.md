...
//    **Add Reference**.
// 2. On the Browse tab, navigate to *install\_dir***\api\redist**, click
...
// 5. Copy [Module](#Module) to **SolidWorksMacro.cs**.
// 6. Copy [Class module](#Class Module) to **swDragManipHdlr.cs**.
...
namespace CreateTriadManipulator\_CSharp.csproj
{
...
            swManip = swModViewMgr.**CreateManipulator**((int)swManipulatorType\_e.swTriadManipulator, swDragHdlr);
