...
        Debug.Print "Origin
= (" & vCone(0) \* 1000# & "mm, " & vCone(1) \* 1000# & "mm, " & vCone(2) \* 1000#
& "mm)"
        Debug.Print "Axis
= (" & vCone(3) & ", " & vCone(4) & ", " & vCone(5) & ")"
        Debug.Print "Radius
= " & vCone(6) \* 1000# & " mm"
        ' 1 radian = 180º/p
= 57.295779513º or approximately 57.3º
        Debug.Print "Half angle
= " & vCone(7) \* 57.3 & " degrees"
        Debug.Print "Reference direction
= (" & vCone(8) \* 1000# & "mm, " & vCone(9) \* 1000# & "mm, " & vCone(10) \* 1000#
& "mm)"
    End If
