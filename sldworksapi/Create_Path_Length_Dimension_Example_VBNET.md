...
        swApp.**SetUserPreferenceToggle**(swUserPreferenceToggle\_e.swInputDimValOnCreate,
False)
...
Object
        vSkLines =
Part.**SketchManager**.**CreateCornerRectangle**(-0.075, 0.05, 0, 0.05, -0.025, 0)
        Part.**ClearSelection2**(True)
...
        boolstatus = Part.**Extension**.**SelectByID2**("Line1",
"SKETCHSEGMENT",
0.00661546453402301, 0.0508003665223665, 0,
False, 0,
Nothing, 0)

        myDisplayDim = Part.**Extension**.**AddPathLengthDim**(-0.0580395474035344,
0.0841706952643316, 0)
        Part.**SketchManager**.**InsertSketch**(True)
