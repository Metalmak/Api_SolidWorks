...
| DSldWorksEvents\_Begin3DInterconnectTranslationNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DSldWorksEvents\_Begin3DInterconnectTranslationNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See Begin3DInterconnectTranslationNotify Event (SldWorks).
...
If developing a C++ application, use swAppBegin3DInterconnectTranslationNotify to register for this notification.
