...
// 2.
Copy
[SolidWorksMacro.cs](#Module)
to the project.
// 3. Add a class module and copy [clsPropMgr.cs](#Class) to
that module.
// 4.
Add the SolidWorks.Interop.swpublished
...
//
  \*
 Reselect the Tools > Options > System Options > Stop VSTA
debugger

//
     on macro exit checkbox,
if it was selected prior to running the macro.
//
  \*
 Because the assembly
document is used elsewhere,
//
do not save changes.
//---------------------------------------------------------------------------
