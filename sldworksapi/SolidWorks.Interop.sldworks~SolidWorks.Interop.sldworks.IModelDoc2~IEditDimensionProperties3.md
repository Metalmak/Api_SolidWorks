...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDoc2 Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2.html) : IEditDimensionProperties3 Method (IModelDoc2) |
...
*Arrow2*
:   Type of arrow to use on the secondarrow of this dimension as defined in swArrowStyle\_e if UseDocArrows is false
...
Obsolete. Superseded by [IModelDocExtension::IEditDimensionProperties](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~IEditDimensionProperties.html).
...
See ModelDoc2::IEditDimensionProperties3.
