...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : GetUserPreferenceDoubleValue Method (ISldWorks) |
...
*UserPreferenceValue*
:   User preference as defined in swUserPreferenceDoubleValue\_e
...
See SldWorks::GetUserPreferenceDoubleValue.
...
This method is intended for user preferences of type double and is equivalent to interactively getting system options in the SOLIDWORKS software. See System Options and Document Properties for details.
