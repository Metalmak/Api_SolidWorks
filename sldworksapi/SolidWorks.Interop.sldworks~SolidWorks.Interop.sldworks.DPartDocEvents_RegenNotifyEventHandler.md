...
| DPartDocEvents\_RegenNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_RegenNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
If developing a C++ application, use swPartRegenNotify to register for this notification.
