...
System.Diagnostics;
namespace
UsePersistentReference\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            for
(i = 0; i <= IDstring.Length - 3; i += 3)
            {
                int
j;
                j = i / 3;
                ByteStream[j] = Convert.ToByte(IDstring.Substring(i,
3));
            }
...
            Debug.Assert((int)swPersistReferencedObjectStates\_e.swPersistReferencedObject\_Ok
== nRetval);
            Debug.Assert((functionReturnValue
!= null));
            return
functionReturnValue;
...
swObj))
            {
                Debug.Assert(object.ReferenceEquals(swSelObj,
swObj));
