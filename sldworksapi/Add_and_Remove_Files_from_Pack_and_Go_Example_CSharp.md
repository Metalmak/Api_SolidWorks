...
namespace
AddExternalDocumentsPackAndGo.csproj
{
    partial
class
SolidWorksMacro
...
            openFile =
"C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2018\\samples\\tutorial\\EDraw\\claw\\claw-mechanism.sldasm";
            swModel = (ModelDoc2)swApp.**OpenDoc6**(openFile, (int)swDocumentTypes\_e.swDocASSEMBLY,
...
            Debug.Print("");
            Debug.Print("  Add
SOLIDWORKS files' paths and filenames: ");
            if ((pgFileNames
!= null))
            {
                for (i = 0;
...
                {
                    Debug.Print("    The
path and filename is: " + pgFileNames[i]);
                }
            }
...
            // Get the render stock references in
this assembly
            // and print
...
            {
                Debug.Print("    The
path and filename is: " + renderReferences[i]);
            }

            // Add render stock files to Pack and Go
            status = swPackAndGo.**AddExternalDocuments**(renderReferences);

            // Add other non-SOLIDWORKS files to Pack
and Go
            object[]
otherFiles = new
object[2];
            string
otherFile = "C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2018\\samples\\tutorial\\edraw\\claw\\claw-mechanism.easm";
            otherFiles[0] = (object)otherFile;
            otherFile = "C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2018\\samples\\tutorial\\edraw\\claw\\claw-mechanism.emodel\_debugonly.xml";
...
non-SOLIDWORKS file:");
            Debug.Print("    The
path and filename is: " + delOtherFiles[0]);
...
        public
BStrWrapper[]
ObjectArrayToBStrWrapperArray(object[]
SwObjects)
        {
            int arraySize;
...
            BStrWrapper[]
dispwrap = new
BStrWrapper[arraySize + 1];
            int arrayIndex;

            for (arrayIndex
= 0; arrayIndex < arraySize + 1; arrayIndex++)
            {
                dispwrap[arrayIndex] = new
BStrWrapper((string)(SwObjects[arrayIndex]));
            }
