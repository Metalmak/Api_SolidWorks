...
// ------------------------------------------------------------------------------
// Preconditions: Open *public\_documents***\samples\whatsnew\sheet metal\tab\_and\_slot.sldprt**.
//
// Postconditions:
...
namespace CreateTabAndSlot\_CSharp
{
...
            featdata = (TabAndSlotFeatureData)Part.FeatureManager.**CreateDefinition**((int)swFeatureNameID\_e.swFmTabAndSlot);
