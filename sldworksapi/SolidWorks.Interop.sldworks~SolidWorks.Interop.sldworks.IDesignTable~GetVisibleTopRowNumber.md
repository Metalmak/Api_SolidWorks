<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDesignTable~GetVisibleTopRowNumber.html -->
...
| GetVisibleTopRowNumber Method (IDesignTable) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IDesignTable Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDesignTable.html) : GetVisibleTopRowNumber Method (IDesignTable) |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function GetVisibleTopRowNumber() As System.Integer ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As IDesignTable Dim value As System.Integer   value = instance.GetVisibleTopRowNumber() ``` | |

| C# |  |
| --- | --- |
| ``` System.int GetVisibleTopRowNumber() ``` | |
...
Number of the topmost visible row

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DesignTable::GetVisibleTopRowNumber.
