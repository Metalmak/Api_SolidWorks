...
Studio 2010, or later, create a SOLIDWORKS add-in
'    project using **Visual Basic > SwVBAddin**.
' 2. Name the project
**SwVBAddin1**.
' 3. Copy and paste
[this code](#SwAddin) into **SwAddin.vb** of your VB.NET project.
' 4. Select **Project >
SwVBAddin1 Properties > Debug**.
...
cube.
' 3. Click the
third-party icon in the face's context-sensitive menu.
' 4. Click a menu
item on the shortcut menu and inspect the Immediate Window.
...
        Dim
docTypes() As
Integer = {swDocumentTypes\_e.swDocASSEMBLY,
\_
