...
'----------------------------------------------------------------------------
' Preconditions:
' 1. Open a drawing that contains a flat
pattern view
...
        swView = Part.SelectionManager.GetSelectedObjectsDrawingView2(1,
-1)
        myBendTableAnnot = swView.InsertBendTable(False,
0.3018189506239, 0.4876053587373,
