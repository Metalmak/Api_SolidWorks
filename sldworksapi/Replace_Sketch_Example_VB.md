...
    vSkLines = Part.**SketchManager**.**CreateCornerRectangle**(-3.38155129850894E-02,
1.67825138518592E-02, 0, 5.51067619016271E-02, -2.45475575743612E-02, 0)
...
    Set skSegment = Part.**SketchManager**.**Create3PointArc**(-0.033816,
0.016783, 0#, 0.055107, 0.016783, 0#, 0.016009, 0.025458, 0#)
    Part.**ClearSelection2** True

    boolstatus = Part.**Extension**.**SelectByID2**("Line1",
"SKETCHSEGMENT", 2.02904300411839E-03, 1.19654152286464E-02,
-7.09549576220667E-03, True, 0, Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByID2**("Arc1",
"SKETCHSEGMENT", 5.88878331207997E-03, 1.71023327681304E-02,
-1.26221740799126E-02, True, 0, Nothing, 0)

    ' Replace
Line1 with Arc1, delete Line1, and make Arc1 a contour
    boolstatus = Part.**SketchManager**.**SketchReplace2**(False,
True)
