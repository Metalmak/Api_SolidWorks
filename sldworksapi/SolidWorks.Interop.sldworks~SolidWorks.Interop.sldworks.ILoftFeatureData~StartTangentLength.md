<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoftFeatureData~StartTangentLength.html -->
...
| StartTangentLength Property (ILoftFeatureData) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ILoftFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ILoftFeatureData.html) : StartTangentLength Property (ILoftFeatureData) |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Property StartTangentLength As System.Double ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As ILoftFeatureData Dim value As System.Double   instance.StartTangentLength = value   value = instance.StartTangentLength ``` | |

| C# |  |
| --- | --- |
| ``` System.double StartTangentLength {get; set;} ``` | |

| C++/CLI |  |
| --- | --- |
| ``` property System.double StartTangentLength {    System.double get();    void set ( &   System.double value); } ``` | |
...
See LoftFeatureData::StartTangentLength.
