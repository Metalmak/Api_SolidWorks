...
As String = "C:\ProgramData\SolidWorks\SOLIDWORKS 2016\data\templates\drawing.drwdot"
    Const nYoffset
As Double = 0.01
...
        Set swDraw =
swApp.**NewDrawing2**(swDwgTemplateCustom, sPathToTemplate, swDwgPaperA1size,
0#, 0#)
...
        ' Create the
dimension, even if the entity is not
        ' visible in the drawing view
        Set swDispDim = swDrawModel.**Extension**.**AddDimension**(nXpos,
nYpos, 0#, swSmartDimensionDirection\_Left)
