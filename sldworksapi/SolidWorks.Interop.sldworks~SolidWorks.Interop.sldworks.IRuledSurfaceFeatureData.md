<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRuledSurfaceFeatureData.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IRuledSurfaceFeatureData_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : IRuledSurfaceFeatureData Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IRuledSurfaceFeatureData ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IRuledSurfaceFeatureData ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See RuledSurfaceFeatureData.
...
[RuledSurfaceFeatureData](SWObjectModel.pdf#RuledSurfaceFeatureData)
