...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IPartingSurfaceFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartingSurfaceFeatureData.html) : OffsetAngle Property (IPartingSurfaceFeatureData) |
...
See PartingSurfaceFeatureData::OffsetAngle.
...
This property only applies if you set [IPartingSurfaceFeatureData::PartingType](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IPartingSurfaceFeatureData~PartingType.html) to swPartingSurfaceMoldParmTangent or swPartingSurfceMoldParmNormal.
