...
| DAssemblyDocEvents\_ModifyTableNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_ModifyTableNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ModifyTableNotify Event (AssemblyDoc).
...
If developing a C++ application, use swAssemblyModifyTableNotify to register for this notification.
