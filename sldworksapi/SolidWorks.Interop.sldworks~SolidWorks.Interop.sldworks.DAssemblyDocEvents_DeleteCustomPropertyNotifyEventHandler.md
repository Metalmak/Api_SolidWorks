...
| DAssemblyDocEvents\_DeleteCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_DeleteCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See DeleteCustomPropertyNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyDeleteCustomPropertyNotify to register for this notification.
