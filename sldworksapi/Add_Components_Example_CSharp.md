...
// 2. Replace *part\_path* in the code with the full path name
...
//    e. Click the green check mark to save the coordinate system.
//       Coordinate System1 appears in the FeatureManager design tree.
//    f. Right-click on Coordinate System1 in the
...
                // Define the
transformation matrix. See the IMathTransform API documentation.
...
to the transform (zero translation)
                compXforms[9] = 0.0;
                compXforms[10] = 0.0;
                compXforms[11] = 0.0;

                // Add a scaling factor to
the transform
                compXforms[12] = 0.0;

                // The last three elements
in the transformation matrix are unused
