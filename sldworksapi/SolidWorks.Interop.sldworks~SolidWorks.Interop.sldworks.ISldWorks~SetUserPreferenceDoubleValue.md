...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISldWorks Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks.html) : SetUserPreferenceDoubleValue Method (ISldWorks) |
...
See SldWorks::SetUserPreferenceDoubleValue.
...
For a description of the user-preference types and which object supports that type, see swUserPreferenceDoubleValue\_e.
