...
| DPartDocEvents\_LoadFromStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_LoadFromStorageStoreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See LoadFromStorageStoreNotify Event (PartDoc).
...
If developing a C++ application, use swPartLoadFromStorageStoreNotify to register for this notification.
