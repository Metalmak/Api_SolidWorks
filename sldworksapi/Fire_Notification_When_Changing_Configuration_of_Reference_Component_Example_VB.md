...
'---------------------------------------------------------------
' Preconditions:
' 1. Copy and paste [this code](#Main) in the main module.
' 2. Click **Insert > Class Module** and copy and past [this
code](#Class)
'    the class module.
...
Private Function swAssem\_ComponentConfigurationChangeNotify(ByVal
