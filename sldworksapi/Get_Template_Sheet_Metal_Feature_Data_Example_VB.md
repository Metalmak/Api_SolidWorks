...
As SldWorks.Feature
    Dim swSheetMetal
As SldWorks.SheetMetalFeatureData
    Dim swFixedFace
As SldWorks.Face2
    Dim bRet
As Boolean
...
    Set swSheetMetalTemplFeature =
swModelExt.**GetTemplateSheetMetal**
...
        ' A fixed face or
fixed edge is not required,
        ' so Null is a valid value
        Debug.Print "There is no fixed face
or fixed edge in this sheet metal part."

    End If

    ' Cancel changes and roll forward the
model
