...
//----------------------------------------------------------------------------
// Preconditions: Open *public\_documents***\samples\tutorial\api\Multiple
Planar\_Faces2.sldprt**.
//
// Postconditions:
...
System;
namespace
ThinFeatureRevolve\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
"AXIS",
-0.03249248386774, -0.008890295497245, -0.005457395402805,
true, 16,
null, 0);
            boolstatus = Part.**Extension**.**SelectByID2**("",
"FACE",
-0.03948753408952, 0.1016773485926, -0.08343298757264,
true, 32,
null, 0);

            Feature
myFeature = default(Feature);
            myFeature = Part.**FeatureManager**.**FeatureRevolve2**(false,
true,
true,
false,
false,
