...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISecondaryMemberSupportPlaneFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISecondaryMemberSupportPlaneFeatureData.html) : GetIntersectingObjectTypes Method (ISecondaryMemberSupportPlaneFeatureData) |
...
* swSelFACES* swSelREFFACES* swSelDATUMPLANES

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See SecondaryMemberSupportPlaneFeatureData::GetIntersectingObjectTypes.
