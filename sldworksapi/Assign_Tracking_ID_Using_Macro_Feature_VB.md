...
'    add-in use** > **OK**.
' 2. Copy [Macros](#Macros) to the main module and rename it **Macros**. (To rename the module, click
'    **View > Properties Window** and type **Macros** in **(Name)**.)
' 3. Click **Insert > Module** and copy [PropMgrConst](#PropMgrConst)
to that module and name it **PropMgrConst**.
' 4. Click **Insert > Class module** and copy [PropMgr](#PropMgr)
to that class module and name it **PropMgr**.
' 5. Click **Insert > Class module** and copy [PropMgrCmd](#PropMgrCmd) to that class module and name it **PropMgrCmd**.
' 6. Click **Insert > Class module** and copy [PropMgrHdlr](#PropMgrHdlr) to that class module and name it **PropMgrHdlr**.
' 7. Open a part.
'
' Postconditions:
' 1. Select a face.
