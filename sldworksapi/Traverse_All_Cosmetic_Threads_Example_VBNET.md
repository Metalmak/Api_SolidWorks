...
'---------------------------------------------------------------------------
' Preconditions:
' 1. Open *public\_documents***\samples\tutorial\api\holecube.sldprt**.
...
"EDGE",
-0.000802489357837999, -0.0246888176810671, 0.0000600726028778809,
True, 0,
Nothing, 0)
        swFeat = swModel.**FeatureManager**.**InsertCosmeticThread3**(swCosmeticStandardType\_e.swStandardType\_StandardHelicoilMetric,
"Helicoil threads",
"M33x2.0",
0.033, swCosmeticEndConditions\_e.swEndConditionBlind2Dia, 0.025,
"M33x2.0 Helicoil Threads")
...
as defined in swCosmeticConfigOptions\_e = "
& swCosThread.**ConfigurationOption**)
                        Debug.Print("      EndCondition
as defined in swCosmeticEndConditions\_e = "
& swCosThread.**EndCondition**)
                        Debug.Print("      Size
= " & swCosThread.**Size**)
                        Debug.Print("      Standard
as defined in swCosmeticStandardType\_e = "
