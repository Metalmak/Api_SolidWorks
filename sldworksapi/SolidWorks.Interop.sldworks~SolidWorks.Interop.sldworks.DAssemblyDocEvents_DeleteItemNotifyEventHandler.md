...
| DAssemblyDocEvents\_DeleteItemNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_DeleteItemNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
*EntityType*
:   Type of entity deleted as defined in swNotifyEntityType\_e
...
See DeleteItemNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyDeleteItemNotify to register for this notification.
