...
Function TransformPoint(ByVal Sketch1 As SldWorks.Sketch,
ByVal X As Double, ByVal Y As Double, ByVal Z As Double) As Variant
...
    Set holeFeat = swFeatMgr.**SimpleHole2**(0.001, True,
