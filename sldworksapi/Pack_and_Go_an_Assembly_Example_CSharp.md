...
            swModelDoc = (ModelDoc2)swApp.**OpenDoc6**(openFile, (int)swDocumentTypes\_e.swDocASSEMBLY,
...
            object
pgFileStatus;
            status = swPackAndGo.**GetDocumentSaveToNames**(out
fileNames, out pgFileStatus);
            pgFileNames = (object[])fileNames;
            Debug.Print("");
            Debug.Print("  Current
...
"C:\\temp\\";
            status =
swPackAndGo.**SetSaveToName**(true,
myPath);
...
            {
                Debug.Print("    My
path and filename is: " + pgGetFileNames[i]);
            }
