...
For new untitled documents, SOLIDWORKS
...
You can use ISldWorks::ResetUntitledCount to
...
to reset the untitled document count. The
...
count at the beginning of the SOLIDWORKS session. This
