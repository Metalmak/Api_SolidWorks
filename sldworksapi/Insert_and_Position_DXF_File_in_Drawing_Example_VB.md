...
' Preconditions:
' 1. Open a drawing.
' 2. Replace *DXF\_file\_path* with the pathname of an existing DXF/DWG file.
...
    bRet =
swModel.Extension.**SelectByID2**("Sheet1", "SHEET", 0#, 0#, 0, False, 0, Nothing,
0)
...
SwConst.swLengthUnit\_e.swINCHES
...
swImportDxfDwg\_ImportMethod\_e.swImportDxfDwg\_ImportToExistingDrawing
