...
2019\samples\tutorial\api\block20.sldprt", 1, 0, "", longstatus, longwarnings)
    swApp.**ActivateDoc2** "block20.sldprt", False, longstatus
    Set Part = swApp.**ActiveDoc**

    Set featmgr = Part.**FeatureManager**

    boolstatus = Part.**Extension**.**SelectByRay**(1.08472195143463E-02,
3.96239999998329E-02, -1.01823136031953E-03, -0.400036026779312,
-0.515038074910024, -0.758094294050284, 1.1224765174324E-03, 2, False, 0, 0)

    Set ent = Part.**SelectionManager**.**GetSelectedObject6**(1,
-1)
...
    boolstatus = Part.**Extension**.**SelectByRay**(-1.03569711794194E-02,
1.88454182651299E-02, 0.049345602378537, -0.400036026779312, -0.515038074910024,
-0.758094294050284, 1.1224765174324E-03, 2, False, 0, 0)
    Set ent = Part.**SelectionManager**.**GetSelectedObject6**(1,
-1)
