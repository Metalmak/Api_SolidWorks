...
' 1. Part document is open and contains a feature split
of two.

' 2. The Solid Bodies folder contains **Split1[1]** and
**Split2[2]**.
...
' 1. **C:\temp\SaveBodies\1.sldprt**,
**C:\temp\SaveBodies\2.sldprt**,

'
and **C:\temp\assem.sldasm** are created.

' 2. In the original part, the **Split1** solid bodies in
the
...
Sub GetVariantOfBody(swFeature As SldWorks.Feature,
bodyList As Variant)
...
swFeatMgr.**CreateSaveBodyFeature** v1, fileNameVar, "c:\temp\assem.sldasm",
-1, -1
