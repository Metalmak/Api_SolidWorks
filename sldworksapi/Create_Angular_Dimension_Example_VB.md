...
'    \* Angle defined by the selected sketch segment and an
extension line
'      that is drawn to the right of the selected
sketch point
'      (Direction = swSmartDimensionDirection\_Right)
'    \* Explementary angle
...
"SKETCHSEGMENT", -6.72289031567236E-02, 1.80603779387131E-02,
1.84698306816742E-02, False, 0, Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByID2**("Point1",
"SKETCHPOINT", -8.11067833265636E-02, 3.89478433654258E-02, 0, True, 0, Nothing,
0)

    Set myDisplayDim = Part.**Extension**.**AddDimension**(-4.56250220540824E-02,
0, 1.50965590938767E-03, swSmartDimensionDirection\_Right)
    myDisplayDim.**ExplementaryAngle**
    myDisplayDim.**VerticallyOppositeAngle** Part.**SketchManager**.**InsertSketch** True
