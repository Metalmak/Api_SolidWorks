...
'---------------------------------------------------------------
' Preconditions:
' 1. Copy [Main](#Main) into the macro.
' 2. Click **Insert > Class Module** and copy [Class1](#Class)
into that
'    module.
...
Private Function swDraw\_**ActivateSheetPreNotify**(ByVal
SheetName As String) As Long

MsgBox "A sheet is about to be activated."
End Function

Private Function swDraw\_**ActivateSheetPostNotify**(ByVal
SheetName As String) As Long
