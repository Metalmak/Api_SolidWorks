...
| DMouseEvents\_MouseLBtnDownNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DMouseEvents\_MouseLBtnDownNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See MouseLBtnDownNotify Event (Mouse).
...
If developing a C++ application, use swMouseLBtnDownNotify to register for this notification.
