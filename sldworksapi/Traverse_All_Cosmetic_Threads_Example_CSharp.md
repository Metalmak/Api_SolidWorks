...
namespace
InsertCosmeticThread3\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
true, 0,
null, 0);
            swFeat = swModel.**FeatureManager**.**InsertCosmeticThread3**((int)swCosmeticStandardType\_e.swStandardType\_StandardHelicoilMetric,
"Helicoil threads",
"M33x2.0",
0.033, (int)swCosmeticEndConditions\_e.swEndConditionBlind2Dia,
