...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDocExtension Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension.html) : GetMassProperties2 Method (IModelDocExtension) |
...
*Status*
:   Error code as defined in swMassPropertiesStatus\_e
...
See ModelDocExtension::GetMassProperties2.
