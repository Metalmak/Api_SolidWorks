...
' 1. Creates **Exploded View1** in
ConfigurationManager.

' 2. Adds **Chain1** to **Exploded
View1**.

' 3. Displays the **Exploded View1** in
its exploded state.

' 4. Inspect the Immediate window, the
ConfigurationManager,
...
boolstatus = swModel.Extension.SelectByID2("Extrude-Thin1", "SOLIDBODY",
...
Set explStep = config.**AddPartExplodeStep**("Exploded
View1", 0.07, -1, False, True, errCode)
