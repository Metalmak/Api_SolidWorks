...
System.Diagnostics;
namespace
DragOperatorAddComponent\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
vComp = null;
            MathTransform
swXform = default(MathTransform);
            MathUtility
swMathUtil = default(MathUtility);
            MathPoint
swOriginPt = default(MathPoint);
            MathVector
swX\_Axis = default(MathVector);
            double[]
nPts = new
double[3];
            object
...
            swX\_Axis = (MathVector)swMathUtil.**CreateVector**(vData);

            // This is an incremental
rotation,
            //
so angle is always the same.
            swXform = (MathTransform)swMathUtil.**CreateTransformRotateAxis**(swOriginPt,
swX\_Axis, 1.0 \* RadPerDeg);
