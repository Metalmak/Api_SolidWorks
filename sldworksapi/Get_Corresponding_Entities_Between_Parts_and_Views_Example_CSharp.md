...
namespace GetCorresponding\_CSharp
{
...
            swApp.**ActivateDoc3**(swModelPart.**GetTitle**(), true, (int)swRebuildOnActivation\_e.swUserDecision, lErr);
...
            {
                case (int)swSelectType\_e.swSelFACES:
                case (int)swSelectType\_e.swSelEDGES:
                case (int)swSelectType\_e.swSelVERTICES:
...
                        swApp.**ActivateDoc3**(swModelDrawing.**GetTitle**(), false, (int)swRebuildOnActivation\_e.swDontRebuildActiveDoc, lErr);
                        bSelected = outputEntity.**Select4**(false, null);
                    }

                    break;
                case (int)swSelectType\_e.swSelNOTHING:
...
                        swApp.**ActivateDoc3**(swModelPart.**GetTitle**(), false, (int)swRebuildOnActivation\_e.swDontRebuildActiveDoc, lErr);
                        bSelected = outputEntity.**Select4**(false, null);
                    }
