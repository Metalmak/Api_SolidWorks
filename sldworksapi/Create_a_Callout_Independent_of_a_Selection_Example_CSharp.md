...
// 2. Click **Project > Add Reference >** **SolidWorks.interop.swpublished**//    on the .NET tab.
...
            myCallout.**set\_Value**(1,
"");
            myCallout.**set\_IgnoreValue**(1,
true);
            myCallout.**set\_Label2**(1,
"SldWorks API");
            myCallout.**SkipColon** =
true;
...
            myCallout.**set\_ValueInactive**(0,
true);
            myCallout.**TextBox** =
false;
...
TextFormat
swTextFormat = myCallout.**TextFormat;**            ProcessTextFormat(swApp, swModel, swTextFormat);
        }
