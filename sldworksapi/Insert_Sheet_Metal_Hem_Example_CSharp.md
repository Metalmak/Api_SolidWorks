...
            // Insert an open hem of
custom relief type Obround and relief ratio 1.0
            myFeature =
Part.**FeatureManager**.**InsertSheetMetalHem2**((int)swHemTypes\_e.swHemTypeOpen,
(int)swHemPositionTypes\_e.swHemPositionTypeOutside,
false,
0.01, 0.01, 0, 0.005, 0.0011, CBAObject,
false,
            (int)swSheetMetalReliefTypes\_e.swSheetMetalReliefObround,
0, true,
1.0, 0, 0);
