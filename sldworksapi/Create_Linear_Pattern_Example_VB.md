...
    ' Select face from which to offset the
pattern's furthest instance in Direction 1
    boolstatus = Part.**Extension**.**SelectByID2**("",
"FACE", 7.99245561853468E-03, -3.29718247828055E-02, -4.91565136701766E-02,
True, 2097152, Nothing, swSelectOptionDefault)

    ' Select seed instance edge with which to
measure distances between pattern instances
    boolstatus = Part.**Extension**.**SelectByID2**("",
"EDGE", 1.14738185224041E-02, 1.04517477574007E-03, -3.34013867415592E-02, True,
8388608, Nothing, swSelectOptionDefault)

    ' Create linear-pattern feature calling
...
    ' \* Offset2 (not used)
    '
    Set myFeature = Part.**FeatureManager**.**FeatureLinearPattern4**(
\_
    3, \_
    0.0029375, \_
    4, \_
