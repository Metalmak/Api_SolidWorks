<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ViewZoomto.html -->
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDoc2 Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2.html) : ViewZoomto Method (IModelDoc2) |
...
See ModelDoc2::ViewZoomto.

# ![](dotnetimages/collapse.gif)Remarks

See [IModelDoc2::ViewZoomTo2](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDoc2~ViewZoomTo2.html), which allows you to zoom to an X,Y,Z boxed location.
