...
namespace CreateSketchDrivenPattern\_CSharp.csproj
{
...
            swSketchPatt
= (SketchPatternFeatureData)Part.**FeatureManager**.**CreateDefinition**((int)swFeatureNameID\_e.swFmSketchPattern);
            swSketchPatt.**GeometryPattern**
= false;
            swSketchPatt.**UseCentroid**
= true;
            swSketchFeat
= (Feature)Part.**FeatureManager**.**CreateFeature**(swSketchPatt);
