...
| DPartDocEvents\_EquationEditorPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_EquationEditorPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See EquationEditorPreNotify Event (PartDoc).
...
If developing a C++ application, use swPartEquationPreNotify to register for this notification.
