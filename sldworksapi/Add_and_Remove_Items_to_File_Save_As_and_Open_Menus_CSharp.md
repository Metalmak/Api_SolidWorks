...
// 3. Copy and paste [this code](#SwAddin) into **SwAddin.cs** of
your C# project.
// 4. Click **Project > SwCSharpAddin1 Properties > Debug.**// 5. Select **Start external program** and type the path to **sldworks.ex**e. Include
...
    [Guid("144d6667-43ec-4733-ae26-867c9aa63fe6"),
ComVisible(true)]
    [SwAddin(
        Description = "SwCSharpAddin1
description",
...
            bRet = iSwApp.**AddFileSaveAsItem2**(addinID, "XXX\_FileSave", "XXX file (\*.xxx)", "xxx", (int)swDocumentTypes\_e.swDocPART);
            bRet = iSwApp.**AddFileOpenItem3**(addinID, "XXX\_FileOpen", "XXX file (\*.xxx)", "xxx", "", "");
...
bRet = iSwApp.**RemoveFileSaveAsItem2**(addinID, "XXX\_FileSave", "XXX file (\*.xxx)", "xxx", (int)swDocumentTypes\_e.swDocPART);
            bRet = iSwApp.**RemoveFileOpenItem2**(addinID, "XXX\_FileOpen", "XXX file (\*.xxx)", "xxx");
...
> > public void XXX\_FileSave(string sFileName)
> > {
> >     // S\_OK          =   Saved successfully
> >     // S\_FALSE       =   Unsuccessful
...
> > }
> >
> > public void XXX\_FileOpen(string sFileName)
> > {
> >     // S\_OK          =   Loaded successfully
> >     // S\_FALSE       =   Unsuccessful
...
> >     if (fileOp == 1)
> >     {
> >         MessageBox.Show("XXX\_FileSave = " + sFileName);
> >     }
> >     else
> >     {
> >         MessageBox.Show("XXX\_FileOpen = " + sFileName);
> >     }
> >
> > }
...
"",
-1);
            cmdGroup.LargeIconList = iBmp.**CreateFileFromResourceBitmap**("SwCSharpAddin1.ToolbarLarge.bmp",
thisAssembly);
            cmdGroup.SmallIconList = iBmp.**CreateFileFromResourceBitmap**("SwCSharpAddin1.ToolbarSmall.bmp",
thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.**CreateFileFromResourceBitmap**("SwCSharpAddin1.MainIconLarge.bmp",
thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.**CreateFileFromResourceBitmap**("SwCSharpAddin1.MainIconSmall.bmp",
thisAssembly);

            cmdIndex0 = cmdGroup.**AddCommandItem**("CreateCube",
-1, "Create a cube",
"Create cube",
0, "CreateCube",
"",
0);
            cmdIndex1 = cmdGroup.**AddCommandItem**("Show
PMP", -1,
...
                    System.Diagnostics.Debug.Print(cmdGroup.**get\_CommandID**(cmdIndex0).ToString());
...
                    System.Diagnostics.Debug.Print(cmdGroup.**get\_CommandID**(cmdIndex1).ToString());
...
            }
            // create a third-party icon
in the context-sensitive menus of faces in parts
            frame = (IFrame)SwApp.**Frame**();
            resultCode = frame.**AddMenuPopupIcon2**((int)swDocumentTypes\_e.swDocPART,
(int)swSelectType\_e.swSelFACES,
"contextsensitive",
addinID, "CSCallbackFunction",
"CSEnable",
"",
...
"",
"",
"", (int)swMenuItemType\_e.swMenuItemType\_Break
           );
            // add a couple of items to to
the menu
            resultCode = SwApp.**AddItemToThirdPartyPopupMenu2**(registerID,
(int)swDocumentTypes\_e.swDocPART,
"Test1",
addinID, "TestCallback",
"EnableTest",
"",
"Test1",
cmdGroup.**SmallMainIcon**, (int)swMenuItemType\_e.swMenuItemType\_Default
           );
            resultCode = SwApp.**AddItemToThirdPartyPopupMenu2**(registerID,
(int)swDocumentTypes\_e.swDocPART,
"Test4",
...
"",
"",
"", (int)swMenuItemType\_e.swMenuItemType\_Separator);
            resultCode = SwApp.**AddItemToThirdPartyPopupMenu2**(registerID,
(int)swDocumentTypes\_e.swDocPART,
"Test5",
addinID, "TestCallback",
...
open
            string
partTemplate = iSwApp.**GetUserPreferenceStringValue**((int)swUserPreferenceStringValue\_e.swDefaultTemplatePart);
            IModelDoc2
modDoc = (IModelDoc2)iSwApp.**NewDocument**(partTemplate,
(int)swDwgPaperSizes\_e.swDwgPaperA2size,
0.0, 0.0);
...
CSCallbackFunction()
        {
            resultCode = SwApp.**ShowThirdPartyPopupMenu**(registerID,
500, 500);
        }
...
                SwEventPtr.**InterfaceBrightnessThemeChangeNotify** +=
new
DSldWorksEvents\_InterfaceBrightnessThemeChangeNotifyEventHandler(InterfaceBrightnessThemeChangeNotify);
...
        public
int
InterfaceBrightnessThemeChangeNotify(int
theme, ref object colors)
        {
