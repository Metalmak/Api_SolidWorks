...
| DDrawingDocEvents\_SaveToStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DDrawingDocEvents\_SaveToStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See SaveToStorageNotify Event (DrawingDoc).
...
If developing a C++ application, use swDrawingSaveToStorageNotify to register for this notification.
