...
| DFeatMgrViewEvents\_ActivateNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DFeatMgrViewEvents\_ActivateNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ActivateNotify Event (FeatMgrView).
...
developing a C++ application, use swFMViewActivateNotify to register for this notification.
