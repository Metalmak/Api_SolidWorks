...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionManager_members.html)   [Example](#ExampleBookmark) | |
...
* call [ICollisionDetectionManager::IsCollisionPresent](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionManager~IsCollisionPresent.html).* call [ICollisionDetectionManager::GetCollisions](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionManager~GetCollisions.html).* apply new transforms to collision group components.* create new or modify existing collision groups.* set a new target assembly.
...
1. Call [ICollisionDetectionManager::SetAssembly](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionManager~SetAssembly.html) to set the target assembly for collision detection.- Call [ICollisionDetectionManager::CreateGroup](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionManager~CreateGroup.html) to create two collision groups.- Call [ICollisionDetectionGroup::SetComponents](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionGroup~SetComponents.html) to populate each collision group.- Use [ICollisionDetectionGroup::ApplyTransforms](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICollisionDetectionGroup~ApplyTransforms.html) to transform components into working positions.- Call ICollisionDetectionManager::IsCollisionPresent and/or ICollisionDetectionManager::GetCollisions to detect collisions.- Inspect any resulting ICollision objects. (See the NOTE above.)- Repeat steps 4-6 if you want to apply new transforms for the next collision detection frame.- Repeat steps 2-6 if you want to change collision groups.- Repeat steps 1-6 if you want to change the target assembly.
