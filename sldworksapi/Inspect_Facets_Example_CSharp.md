...
// 1. Copy *Public\_Documents***\SOLIDWORKS\SOLIDWORKS
...
boolstatus = swApp.**SetUserPreferenceIntegerValue**((int)swUserPreferenceIntegerValue\_e.swImportStlVrmlModelType,
(int)swImportStlVrmlModelType\_e.swImportStlVrmlModelType\_Graphics);
...
boolstatus = swApp.**SetUserPreferenceIntegerValue**((int)swUserPreferenceIntegerValue\_e.swImportStlVrmlModelType,
(int)swImportStlVrmlModelType\_e.swImportStlVrmlModelType\_Surface);

boolstatus = swApp.**SetUserPreferenceIntegerValue**((int)swUserPreferenceIntegerValue\_e.swImportStlVrmlModelType,
1);

swApp.**SetUserPreferenceToggle**((int)swUserPreferenceToggle\_e.swVrmlStlImportAsPSMesh,
true);
...
if (lSelType == (int)swSelectType\_e.swSelGRAPHICSBODY)
...
else if (lSelType == (int)swSelectType\_e.swSelGRAPHICSBODY)
...
if (lBodyType == (int)swBodyType\_e.swGraphicsBody)
...
if (lSelType == (int)swSelectType\_e.swSelFACETS)
...
if (lSelType == (int)swSelectType\_e.swSelMESHFACETEDGES)
...
if (lSelType == (int)swSelectType\_e.swSelMESHFACETVERTICES)
...
if (lSelType == (int)swSelectType\_e.swSelSURFACEBODIES)
...
if (lBodyType == (int)swBodyType\_e.swMeshBody)
...
bFilter =
swApp.GetSelectionFilter((int)swSelectType\_e.swSelMESHFACETEDGES);

swApp.SetSelectionFilter((int)swSelectType\_e.swSelMESHFACETEDGES, bFilter
== false);
...
if (lCurFilter == (int)swSelectType\_e.swSelGRAPHICSBODY)
...
else if (lCurFilter == (int)swSelectType\_e.swSelFACETS)
...
else if (lCurFilter == (int)swSelectType\_e.swSelMESHFACETEDGES)
...
else if (lCurFilter == (int)swSelectType\_e.swSelMESHFACETVERTICES)
...
lSelFilters[0] = (int)swSelectType\_e.swSelMESHFACETVERTICES;

// lSelFilters(1) = swSelectType\_e.swSelFACETS
...
if (lCurBodyType == (int)swBodyType\_e.swMeshBody)
...
else if (lCurBodyType == (int)swBodyType\_e.swGraphicsBody)
