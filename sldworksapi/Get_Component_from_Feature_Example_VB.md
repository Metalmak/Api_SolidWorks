...
    ' Get the feature
    Set swFeature = swModel.**SelectionManager**.**GetSelectedObject6**(1,
-1)
...
    Debug.Print "Entity type as defined in swSelectType\_e: " &
swEntity.**GetType**
...
    ' Select the feature through the Feature
interface
