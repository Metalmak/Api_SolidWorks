...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISwOLEObject Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISwOLEObject.html) : IGetBoundaries Method (ISwOLEObject) |
...
:   * in-process, unmanaged C++: Pointer to an array of doubles of these coordinates:
      ...
      + Drawings: sheet coordinates
        ...
        + Parts or assemblies: screen pixel coordinates* VBA, VB.NET, C#, and C++/CLI: Not supported
