...
| DAssemblyDocEvents\_DynamicHighlightNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_DynamicHighlightNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See DynamicHighlightNotify Event (AssemblyDoc).
...
If developing a C++ application, use swAssemblyDynamicHighlightNotify to register for this notification.
