...
namespace GetToolingSplitData\_CSharp.csproj
{
...
            Debug.Print("    Depth of block in direction 1: " + swToolingSplitFeatData.**get\_Depth**(0));
            Debug.Print("    Depth of block in direction 2: " + swToolingSplitFeatData.**get\_Depth**(1));
