...
' 2. Hides and then shows all edges in the root component in  **'    Drawing View1**.
...
        swDocSpecification = swApp.**GetOpenDocSpec**("C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS
...
        swView = swModel.**SelectionManager**.**GetSelectedObject6**(1,
-1)

        ' Print the drawing view name and
get the component in the drawing view
...
swViewEntityType\_e.swViewEntityType\_Edge)
        vEdges = swView.**GetVisibleEntities2**(swComponent,
swViewEntityType\_e.swViewEntityType\_Edge)
        Debug.Print("Number of edges
found: " & eCount)

        ' Hide all of the visible edges in
the drawing view
        For
i = 0 To
eCount - 1
