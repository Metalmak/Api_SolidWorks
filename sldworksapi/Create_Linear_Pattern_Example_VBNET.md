...
0, 0, 0, False,
4, Nothing,
swSelectOption\_e.swSelectOptionDefault)' Select
...
True, 2,
Nothing,
swSelectOption\_e.swSelectOptionDefault)' Select face
...
True, 2097152,
Nothing,
swSelectOption\_e.swSelectOptionDefault)' Select seed
...
True, 8388608,
Nothing,
swSelectOption\_e.swSelectOptionDefault)' Create
...
myFeature = Part.**FeatureManager**.**FeatureLinearPattern4**(
\_
