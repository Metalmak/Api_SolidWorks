...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISecondaryMemberBetweenPointsFeatureData_members.html)   [Example](#ExampleBookmark) | |
...
See SecondaryMemberBetweenPointsFeatureData.

# ![](dotnetimages/collapse.gif)Example

'VBA

'This example demonstrates how to add and edit these secondary structure system members to a primary structure system:
...
Cast [ISecondaryStructuralMemberFeatureData](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISecondaryStructuralMemberFeatureData.html) or [IStructureSystemMemberFeatureData](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IStructureSystemMemberFeatureData.html) to this interface.

# ![](dotnetimages/collapse.gif)Access Diagram

[SecondaryMemberBetweenPointsFeatureData](SWObjectModel.pdf#SecondaryMemberBetweenPointsFeatureData)
