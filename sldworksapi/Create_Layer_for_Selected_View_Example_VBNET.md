...
' 2. Click the **Layer Properties** tool on the Line Format toolbar to
verify
...
                    "Layer for part in "
& sLayerName, \_
                    0, swLineStyles\_e.swLineCONTINUOUS,
swLineWeights\_e.swLW\_NORMAL, True,
True)
...
        Debug.Print("  View         = "
& swView.**Name**)
        Debug.Print("    View Model = "
& swView.**GetReferencedModelName**)

        vBody = swDrawPart.**GetBodies2**(swBodyType\_e.swSolidBody,
True)
