...
' 3. Replace *component\_name* in the code below with the name of a second
...
        'Get the
transformation matrix for the second component in the radial explode step
...
        'Select another
component to overlap
        Set selMgr = Part.**SelectionManager**
        boolstatus = Part.**Extension**.**SelectByID2**("*component\_name*",
"COMPONENT", 0, 0, 0, False, 0, Nothing, 0)
        Set obj = selMgr.**GetSelectedObject6**(1,
-1)

        'Applies the
transformation matrix to overlap the components
