<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITaperedTapElementData.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ITaperedTapElementData_members.html)   [Example](#ExampleBookmark) | |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ITaperedTapElementData ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class ITaperedTapElementData ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See TaperedTapElementData.
...
[IAdvancedHoleFeatureData::GetFarSideElements](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAdvancedHoleFeatureData~GetFarSideElements.html)

[IAdvancedHoleFeatureData::GetNearSideElements](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAdvancedHoleFeatureData~GetNearSideElements.html)

# ![](dotnetimages/collapse.gif)Access Diagram

[TaperedTapElementData](SWObjectModel.pdf#TaperedTapElementData)
