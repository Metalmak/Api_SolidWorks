...
    ' Utility struct to combine the name
and ID of a camera
    Structure
Camera\_t
        Dim
...
        ' Get the active model view for the
active document
...
        Debug.Print("")
        Debug.Print("Number of cameras =
" & lNumCameras)

        ReDim
aCameras(lNumCameras - 1)
