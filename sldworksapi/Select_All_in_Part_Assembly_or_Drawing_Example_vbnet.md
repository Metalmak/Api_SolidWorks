...
        swModel = swApp.**OpenDoc6**(partFile,
...
        ' Open an assembly document and
select all components in the assembly
        assemblyFile =
"C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 2017\introsw\bolt-assembly.sldasm"
        swModel = swApp.**OpenDoc6**(assemblyFile,
...
    Sub
SelectAllinDocument(ByVal
swModel As
ModelDoc2, ByVal
swModelDocExt As
ModelDocExtension, ByVal
swSelMgr As
SelectionMgr)
        Dim
selCount As
