...
System.Diagnostics;
namespace
GetAttachedEntities\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            swSelObj = (Note)swSelMgr.**GetSelectedObject6**(1,
-1);
...
Type as defined in swAnnotationType\_e = " +
swAnn.**GetType**());
...
            {
                for
(i = 0; i <= vAttEntTypeArr.GetUpperBound(0); i++)
                {
                    // A dangling
