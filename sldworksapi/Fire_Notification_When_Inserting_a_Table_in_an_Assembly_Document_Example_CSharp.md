...
// 2. Verify that the **Tools > Options > System Options >**//    **Stop VSTA debugger on
...
AttachSWEvents()
        {
            swAssemblyDoc.InsertTableNotify +=
this.swAssemblyDoc\_InsertTableNotify;
        }

        private
int **swAssemblyDoc\_InsertTableNotify**(TableAnnotation
