...
| DAssemblyDocEvents\_EndInContextEditNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_EndInContextEditNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See EndInContextEditNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyEndInContextEditNotify to register for this notification.
