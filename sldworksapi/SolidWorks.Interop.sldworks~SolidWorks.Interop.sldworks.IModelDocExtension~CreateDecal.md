<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~CreateDecal.html -->
...
| CreateDecal Method (IModelDocExtension) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDocExtension Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension.html) : CreateDecal Method (IModelDocExtension) |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function CreateDecal() As Decal ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As IModelDocExtension Dim value As Decal   value = instance.CreateDecal() ``` | |
...
See ModelDocExtension::CreateDecal.
