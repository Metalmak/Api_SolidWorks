...
        bdlen = swWeldBead.**BeadLength**(swWeldBeadSide\_e.swWeldBeadArrowSide)
        Debug.Print("  Weld bead length: " & bdlen)

        bdPitch = swWeldBead.**BeadPitch**(swWeldBeadSide\_e.swWeldBeadArrowSide)
        Debug.Print("  Weld bead pitch: " & bdPitch)

        bdsz = swWeldBead.**BeadSize**(swWeldBeadSide\_e.swWeldBeadArrowSide)
        Debug.Print("  Weld bead size: " & bdsz)

        bdTy = swWeldBead.**BeadType**(swWeldBeadSide\_e.swWeldBeadArrowSide)
...
        swWeldBead.**GetFaces**(swWeldBeadSide\_e.swWeldBeadArrowSide, set1, faceVar)
...
        ve = swWeldBead.**GetVirtualEdges**(False, swWeldBeadSide\_e.swWeldBeadArrowSide)
...
        swWeldBead.**BeadLength**(swWeldBeadSide\_e.swWeldBeadArrowSide) = bdlen \* 0.5
        swWeldBead.**BeadPitch**(swWeldBeadSide\_e.swWeldBeadArrowSide) = bdPitch \* 0.5
        swWeldBead.**BeadSize**(swWeldBeadSide\_e.swWeldBeadArrowSide) = bdsz \* 0.5
        swWeldBead.**BeadType**(swWeldBeadSide\_e.swWeldBeadArrowSide) = bdTy
