...
namespace
GetCurrentMacroPathName\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            depends = (object[])swApp.**GetDocumentDependencies2**(sourcefile,
...
            while
(idx <= depends.GetUpperBound(0))
            {
                Array.Resize(ref
sourcefiles, sourcecount + 1);
                Array.Resize(ref
targetfiles, sourcecount + 1);
...
            copyopt = (int)swMoveCopyOptions\_e.swMoveCopyOptionsOverwriteExistingDocs;
