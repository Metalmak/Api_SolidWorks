...
//
// Postconditions:
// 1. Adds **Gravity** to the
MotionManager design tree on the Motion Study 1 tab.
...
namespace CreateSimGravFeat\_CSharp.csproj
{
...
            // Define feature data
            swGravityFeat = (SimulationGravityFeatureData)swMotionStudy1.**CreateDefinition**((int)swFeatureNameID\_e.swFmAEMGravity);
