...
    Set skSegment = Part.**SketchManager**.**CreateLine**(-0.060928,
0.026745, 0#, 0.06209, 0.002933, 0#)
    Part.**ClearSelection2** True
    Set skSegment = Part.**SketchManager**.**CreateTangentArc**(0.06209,
0.002933, 0#, 0.020571, -0.021799, 0#, 1)
    Part.**ClearSelection2** True
