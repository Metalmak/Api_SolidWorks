...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IExtrudeFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IExtrudeFeatureData.html) : GetWallThickness Method (IExtrudeFeatureData) |
...
Obsolete. Superseded by [IExtrudeFeatureData2::GetWallThickness](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IExtrudeFeatureData2~GetWallThickness.html).
...
See ExtrudeFeatureData::GetWallThickness.
