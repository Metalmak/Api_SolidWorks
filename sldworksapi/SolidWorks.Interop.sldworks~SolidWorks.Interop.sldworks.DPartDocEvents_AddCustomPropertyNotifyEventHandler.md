...
| DPartDocEvents\_AddCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_AddCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See AddCustomPropertyNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartAddCustomPropertyNotify to register for this notification.
