...
namespace GetMassProperties2\_CSharp.csproj
{
...
Debug.Print("Please
select one or more components and rerun the macro.");
...
            vMassProp = (double[])swModelExt.**GetMassProperties2**(1, out nStatus,
true);

            Debug.Print("Status as defined in swMassPropertiesStatus\_e (0
= Mass properties calculation successful) = " + nStatus);
