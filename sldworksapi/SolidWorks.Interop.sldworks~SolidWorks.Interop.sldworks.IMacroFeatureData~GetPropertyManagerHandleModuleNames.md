<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~GetPropertyManagerHandleModuleNames.html -->
...
| GetPropertyManagerHandleModuleNames Method (IMacroFeatureData) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IMacroFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData.html) : GetPropertyManagerHandleModuleNames Method (IMacroFeatureData) |
...
See MacroFeatureData::GetPropertyManagerHandleModuleNames.
