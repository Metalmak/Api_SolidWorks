...
Case status
                        Case
swAnnotationVisibilityState\_e.swAnnotationHidden
                            swBlockInstance.**Visible** =
swAnnotationVisibilityState\_e.swAnnotationVisible
                            Debug.Print("  Was
hidden, now visible.")
                        Case
swAnnotationVisibilityState\_e.swAnnotationVisible
...
visible, now hidden.")
                        Case
swAnnotationVisibilityState\_e.swAnnotationHalfHidden
                            MsgBox("This block is
half hidden.")
                        Case
swAnnotationVisibilityState\_e.swAnnotationVisibilityUnknown
                            MsgBox("Failed to
