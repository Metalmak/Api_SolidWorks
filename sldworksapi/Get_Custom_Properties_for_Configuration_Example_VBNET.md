...
        lRetVal = cusPropMgr.**Add3**("ADATE", swCustomInfoType\_e.swCustomInfoDate, "4-13-59", swCustomPropertyAddOption\_e.swCustomPropertyDeleteAndAdd)
...
            Debug.Print("Name, swCustomInfoType\_e value, and resolved value:  " & vPropNames(j) & ", " & custPropType & ", " & vPropValues(j))
        Next j
