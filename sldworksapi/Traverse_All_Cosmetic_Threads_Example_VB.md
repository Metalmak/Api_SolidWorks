...
As String
    Dim swCosThread
As SldWorks.CosmeticThreadFeatureData
    Dim bRet
As Boolean
...
True, 0, Nothing, 0)
    Set swFeat = swModel.**FeatureManager**.**InsertCosmeticThread3**(swStandardType\_StandardHelicoilMetric,
...
= " & swCosThread.**BlindDepth** \* 1000# & " mm"

Debug.Print "      Diameter
= " & swCosThread.**Diameter** \* 1000# & " mm"
...
swCosmeticConfigOptions\_e = " & swCosThread.**ConfigurationOption**

Debug.Print "      EndCondition as defined in
swCosmeticEndConditions\_e = " & swCosThread.**EndCondition**

Debug.Print "      Size = " & swCosThread.**Size**

Debug.Print "      Standard as defined in
swCosmeticStandardType\_e = " & swCosThread.**Standard**
