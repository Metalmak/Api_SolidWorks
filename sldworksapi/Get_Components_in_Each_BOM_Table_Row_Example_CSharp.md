...
//-----------------------------------------------------------------------------
// Preconditions:
// 1. Open *public\_documents***\samples\tutorial\assemblyvisualize\food\_processor.sldasm.**
...
// 5. Ensure that **Display configurations of the same part
separate items**
...
//
// NOTE: Because
the assembly is used elsewhere, do not save changes.
//-----------------------------------------------------------------------------
...
            foreach (TableAnnotation vTable\_loopVariable in vTableArr)
            {
                vTable = vTable\_loopVariable;
                swTable = (TableAnnotation)vTable;
                vConfigArray = (string[])swBomFeat.**GetConfigurations**(true, ref visibility);
                foreach (object vConfig\_loopVariable in vConfigArray)
                {
                    vConfig = vConfig\_loopVariable;
