...
| DDrawingDocEvents\_DeleteItemPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DDrawingDocEvents\_DeleteItemPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See DeleteItemPreNotify Event (DrawingDoc).
...
If developing a C++ application, use swDrawingDeleteItemPreNotify to register for this notification.
