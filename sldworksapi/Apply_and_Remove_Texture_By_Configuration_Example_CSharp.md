...
"FACE",
-0.02341747645642, 0.03900188771217, -0.008053400767039,
false, 0,
null, 0);

            swSelMgr = (SelectionMgr)swModel.**SelectionManager**;
            face = (Face2)swSelMgr.**GetSelectedObject6**(1,
-1);
...
            // Examine the selected face to
verify that the specified texture was set
            //
