...
| DPartDocEvents\_LoadFromStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_LoadFromStorageNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See LoadFromStorageNotify Event (PartDoc).
...
If developing a C++ application, use swPartLoadFromStorageNotify to register for this notification.
