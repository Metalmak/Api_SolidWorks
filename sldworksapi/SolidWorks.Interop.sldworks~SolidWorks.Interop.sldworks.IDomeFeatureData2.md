<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDomeFeatureData2.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDomeFeatureData2_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : IDomeFeatureData2 Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IDomeFeatureData2 ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IDomeFeatureData2 ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See DomeFeatureData2.
...
[DomeFeatureData2](SWObjectModel.pdf#DomeFeatureData2)
