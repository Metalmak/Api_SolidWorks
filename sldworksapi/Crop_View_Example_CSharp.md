...
false, 0,
null, 0);
            myView = (View)((SelectionMgr)Part.**SelectionManager**).**GetSelectedObject6**(1,
-1);

            drawingDoc = (DrawingDoc)Part;
            boolstatus = drawingDoc.**ActivateView**("Drawing
View1");
            object
vSkLines = null;
            vSkLines = Part.SketchManager.**CreateCornerRectangle**(-0.0574722079408937,
0.0331536511827661, 0, 0.0371399698368841, -0.0373161088172339, 0);
