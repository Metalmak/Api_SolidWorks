<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchedBendFeatureData.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchedBendFeatureData_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : ISketchedBendFeatureData Interface |
...
Allows access to a sketched bend feature.
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISketchedBendFeatureData ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class ISketchedBendFeatureData ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See SketchedBendFeatureData.
...
[SketchedBendFeatureData](SWObjectModel.pdf#SketchedBendFeatureData)
