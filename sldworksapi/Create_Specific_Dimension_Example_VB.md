...
' Preconditions: Open *public\_documents***\samples\tutorial\api\box.sldprt.**
'
' Postconditions:
' 1. Edits **Sketch1**.
...
"SKETCHSEGMENT", -5.09671483361161E-02, -1.09842011554073E-02,
2.96211826739789E-02, False, 0, Nothing, 0)
    boolstatus = Part.**Extension**.**SelectByID2**("Line2",
"SKETCHSEGMENT", -7.70411440149667E-02, 4.96030150977761E-03,
3.25476150359756E-02, True, 0, Nothing, 0)

    Set myDisplayDim = Part.**Extension**.**AddSpecificDimension**(-4.56250220540824E-02,
0, 1.50965590938767E-03, swAngularDimension, error)
