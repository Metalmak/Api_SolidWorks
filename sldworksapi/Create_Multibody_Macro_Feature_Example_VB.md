...
' Preconditions:
' 1. Open *public\_documents***\samples\tutorial\multibody\multi\_local.sldprt**.
' 2. Copy [main module](#main) to the macro code window.
' 3. Right-click the project name and click **Insert > Module**.
' 4. Type **mMacroFeature** in **(Name)** in the module's Properties
window
'    (if necessary, right-click **Module1** to display the
Properties window).
' 5. Copy [macro feature](#macro feature) to the mMacroFeature code
window.
'
' Postconditions:
...
    swModel.FeatureManager.**InsertMacroFeature3** "MacroFeature",
"", strMacroMethods, \_
        Nothing, Nothing, Nothing, Nothing,
Nothing, vBodies, Nothing, **swMacroFeatureByDefault**
End Sub
...
Function swmRebuild(app As Variant, model As Variant, feat As
Variant) As Variant
...
Function swmEditDefinition(app As Variant, model As Variant,
feat As Variant) As Variant

End Function

Function swmSecurity(app As Variant, model As Variant, feat
