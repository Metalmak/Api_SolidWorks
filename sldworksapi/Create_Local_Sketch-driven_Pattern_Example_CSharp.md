...
swLocalSketchPatternFeat = (LocalSketchPatternFeatureData)swFeatMgr.**CreateDefinition**((int)swLocalSketchPatternReferencePoint\_e.swFmLocalSketchPattern);

swLocalSketchPatternFeat.**ReferencePoint** = 1;
//Bounding box center
