...
| DAssemblyDocEvents\_AddCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DAssemblyDocEvents\_AddCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See AddCustomPropertyNotify Event (AssemblyDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAssemblyAddCustomPropertyNotify to register for this notification.
