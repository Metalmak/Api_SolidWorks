...
> Set swModelDoc = swApp.**OpenDoc6**(openFile, swDocASSEMBLY, swOpenDocOptions\_Silent, "", errors, warnings)
...
>
> ' Include any drawings, SOLIDWORKS Simulation results,
> and SOLIDWORKS Toolbox components
> swPackAndGo.**IncludeDrawings** = True
> Debug.Print "  Include drawings: " & swPackAndGo.**IncludeDrawings**swPackAndGo.**IncludeSimulationResults** = True
> Debug.Print "  Include SOLIDWORKS Simulation results: " & swPackAndGo.**IncludeSimulationResults**swPackAndGo.**IncludeToolboxComponents** = True
