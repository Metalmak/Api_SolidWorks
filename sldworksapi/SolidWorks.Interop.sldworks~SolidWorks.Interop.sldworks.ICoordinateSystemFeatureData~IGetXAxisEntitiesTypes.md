...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ICoordinateSystemFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICoordinateSystemFeatureData.html) : IGetXAxisEntitiesTypes Method (ICoordinateSystemFeatureData) |
...
* in-process, unmanaged C++: Pointer to an array of longs representing the x-axis type of entities as defined by [swSelectType\_e](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ICoordinateSystemFeatureData~GetXAxisEntitiesTypes.html)* VBA, VB.NET, C#, and C++/CLI: Not supported
