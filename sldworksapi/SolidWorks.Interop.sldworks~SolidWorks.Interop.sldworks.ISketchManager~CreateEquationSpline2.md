...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISketchManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager.html) : CreateEquationSpline2 Method (ISketchManager) |
...
See SketchManager::CreateEquationSpline2.
...
* an explicit curve (only in 2D) of the form y=f(x), then this input should be "".* a parametric curve given in terms of the parameter t, then this input is the value of x given in terms of the parameter. For example:
