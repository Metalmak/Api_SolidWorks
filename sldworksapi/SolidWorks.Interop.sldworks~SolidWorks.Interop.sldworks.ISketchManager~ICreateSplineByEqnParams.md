...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISketchManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager.html) : ICreateSplineByEqnParams Method (ISketchManager) |
...
*Knots*
:   * in-process, unmanaged C++: Pointer to an array of knots (e.g., knot1, knot2, and so on)* VBA, VB.NET, C#, and C++/CLI: Not supported
