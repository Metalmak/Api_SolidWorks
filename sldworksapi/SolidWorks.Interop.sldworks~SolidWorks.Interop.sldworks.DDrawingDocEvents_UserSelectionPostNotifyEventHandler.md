...
| DDrawingDocEvents\_UserSelectionPostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DDrawingDocEvents\_UserSelectionPostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See UserSelectionPostNotify Event (DrawingDoc).
...
If developing a C++ application, use swDrawingUserSelectionPostNotify to register for this notification.
