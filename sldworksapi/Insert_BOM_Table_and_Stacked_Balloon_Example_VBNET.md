...
        ' Select a face on which to attach
the stacked balloons
...
swStackedBalloonDirection\_e.swStackedBalloonDir\_Right
        StackedBalloonParams.**Style** = swBalloonStyle\_e.swBS\_Circular
        StackedBalloonParams.**Size** = swBalloonFit\_e.swBF\_5Chars
...
= swBalloonQuantityPlacement\_e.swBalloonQuantityPlacement\_Top
        StackedBalloonParams.**QuantityDenotationText** =
"PLACES"
        StackedBalloonParams.**QuantityOverride**
= False
        StackedBalloonParams.**ItemNumberStart**
= 1
