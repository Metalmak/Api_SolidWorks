...
"View: " & swView.Name
            Debug.Print
("  Number of broken-out sections in this view: " & swView.**GetBreakOutSectionCount**)
            varBS =
swView.**GetBreakOutSections**
...
Debug.Print ("
Depth of exposure in meters: " & swFeatData.**Depth**)
...
        Debug.Print ("
Number of sketch segments: " & swFeatData.**GetSketchSegmentCount**)
    End If
End Sub
...
    Debug.Print ("
Iterating on broken-out section: " & inFeat.Name)
...
        If (Not (IsEmpty(varskSeg))) Then
            For segCtr =
LBound(varskSeg) To UBound(varskSeg)
