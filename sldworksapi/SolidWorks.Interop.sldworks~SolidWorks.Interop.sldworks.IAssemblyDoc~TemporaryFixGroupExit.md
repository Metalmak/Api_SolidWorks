...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IAssemblyDoc Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc.html) : TemporaryFixGroupExit Method (IAssemblyDoc) |
...
See AssemblyDoc::TemporaryFixGroupExit.
...
To temporarily change floating or ungrouped components to fixed or grouped, call [IAssemblyDoc::TemporaryFixGroup](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IAssemblyDoc~TemporaryFixGroup.html).
