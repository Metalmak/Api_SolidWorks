...
**NOTE:** Replace *public\_documents*
withthe path where the header files for the general helper
functions are installed on your
computer. This path is typically **C:\Users\Public\Documents\SOLIDWORKS\SOLIDWORKS 20***nn,* where *nn*
is the 2-digit release year of the version of SOLIDWORKS that you are running.
...
#include <*public\_documents/*appcomm/amapp.h>
...
 LPPARTDOC m\_PartDoc = NULL;

 hres = m\_ModelDoc->QueryInterface(
IID\_IPartDoc, (LPVOID \*)&m\_PartDoc);
