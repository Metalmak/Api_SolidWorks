...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ISketch Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketch.html) : GetSketchPictureCount Method (ISketch) |
...
See Sketch::GetSketchPictureCount.

# ![](dotnetimages/collapse.gif)Remarks

Call this method before calling [ISketch::IGetSketchPcitures](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISketch~IGetSketchPictures.html) to get the size of the array for that method.
