...
            boolstatus = Part.Extension.SelectByID2("Line3@Sketch2",
"EXTSKETCHSEGMENT",
-0.01022262320328, 0.01646364019604, 0,
false, 0,
null, 0);
            sketchSegment = (SketchSegment)SelMgr.GetSelectedObject6(1,
-1);
            boolstatus = sketchSegment.**SelectChain**(true,
SelData);
