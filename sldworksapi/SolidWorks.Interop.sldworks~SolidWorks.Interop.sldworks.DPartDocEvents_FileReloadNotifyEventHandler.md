...
| DPartDocEvents\_FileReloadNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_FileReloadNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See FileReloadNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartFileReloadNotify to register for this notification.
