...
| DPartDocEvents\_ActiveConfigChangePostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_ActiveConfigChangePostNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ActiveConfigChangePostNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartConfigChangePostNotify to register for this notification.
