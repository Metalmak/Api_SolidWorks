...
tab,
'    navigate to the *install\_dir***\api\redist** folder and
'    select **SolidWorks.Interop.sustainability.dll**).
' 2. Open:
'    *public\_documents***\samples\tutorial\api\ZZM7005 End Plate.sldprt**
...
        MaterialClass =
"Plastics"
        materialInfo.**MaterialClass** =
MaterialClass
        Debug.Print(" Material class: "
& MaterialClass)
...
        Debug.Print(" % recycled: "
& materialInfo.**RecycledContent**)
        Debug.Print(" Weight: "
& materialInfo.**Weight**)
...
        Dim
manufacturingInfo As
SustainabilityManufacturing
        manufacturingInfo = sustain.**GetSustainabilityManufacturing**

        Debug.Print(" Region: "
& manufacturingInfo.**ManufacturingRegion**)
        Debug.Print(" Built to last: "
& manufacturingInfo.**BuiltToLast**)
        Debug.Print(" Process: "
& manufacturingInfo.**ManufacturingProcess**)
        Debug.Print(" Primary
electricity: " & manufacturingInfo.**PrimaryElectricity**)
        Debug.Print(" Primary natural
gas: " & manufacturingInfo.**PrimaryNaturalGas**)
        Debug.Print(" Primary scrap rate:
" & manufacturingInfo.**PrimaryScrapRate**)
        Debug.Print(" Paint: "
& manufacturingInfo.**Paint**)
        Debug.Print(" Surface area: "
& manufacturingInfo.**SurfaceArea**)
...
        Debug.Print(" By train: "
& transInfo.**Train**)
        Debug.Print(" By truck: "
& transInfo.**Truck**)
        Debug.Print(" By boat: "
& transInfo.**Boat**)
        Debug.Print(" By plane: "
& transInfo.**Plane**)
...
        Debug.Print(" % recycled: "
& eofInfo.**Recycled**)
        Debug.Print(" % incinerated: "
& eofInfo.**Incinerated**)
        Debug.Print(" % landfill: "
& eofInfo.**Landfill**)
...
Nothing
        CarbonValues =
environmentalImpactInfo.**GetCurrentCarbonFootPrint**(CarbonContent)
...
Nothing
        WaterValues =
environmentalImpactInfo.**GetWaterEutrophication**(WaterContent)
        Debug.Print(" Water
eutrophication")
        Debug.Print("  Material: "
& WaterContent(0))
...
Nothing
        AirValues =
environmentalImpactInfo.**GetAirAcidification**(AirContent)
...
Nothing
        EnergyValues =
environmentalImpactInfo.**GetEnergyConsumption**(EnergyContent)
