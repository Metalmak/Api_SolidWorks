<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMateReference.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMateReference_members.html)   [Example](#ExampleBookmark) | |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IMateReference ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IMateReference ``` | |
...
[MateReference](SWObjectModel.pdf#MateReference)
