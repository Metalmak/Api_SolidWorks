...
| DPartDocEvents\_SensorAlertPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_SensorAlertPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See SensorAlertPreNotify Event (PartDoc).
