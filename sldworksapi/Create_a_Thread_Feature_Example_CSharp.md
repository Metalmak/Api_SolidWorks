...
namespace ThreadFeature\_CSharp
{
...
            swThreadFeatData = (ThreadFeatureData)FeatMgr.**CreateDefinition**((int)swFeatureNameID\_e.swFmSweepThread);
...
            swThreadFeatData.**EndCondition** = (int)swThreadEndCondition\_e.swThreadEndCondition\_UpToSelection;
