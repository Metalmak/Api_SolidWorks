...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IShellFeatureData Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IShellFeatureData.html) : GetMultipleThicknessAtIndex Method (IShellFeatureData) |
...
See ShellFeatureData::GetMultipleThicknessAtIndex.
