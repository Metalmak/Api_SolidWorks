...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IFeatureManager Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager.html) : InsertFeatureChamfer Method (IFeatureManager) |
...
*Options*
:   Options as defined by swFeatureChamferOption\_e

*ChamferType*
:   Chamfer type as defined by swChamferType\_e
...
See FeatureManager::InsertFeatureChamfer.

# ![](dotnetimages/collapse.gif)Example

See the [IChamferFeatureData2](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IChamferFeatureData2.html) examples.
