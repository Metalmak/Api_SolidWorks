<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICoEdge~GetPartner.html -->
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [ICoEdge Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICoEdge.html) : GetPartner Method (ICoEdge) |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Function GetPartner() As System.Object ``` | |

| Visual Basic (Usage) | ![](dotnetimages/copycode.gif)Copy Code |
| --- | --- |
| ``` Dim instance As ICoEdge Dim value As System.Object   value = instance.GetPartner() ``` | |

| C# |  |
| --- | --- |
| ``` System.object GetPartner() ``` | |
...
[ICoEdge::IGetPartner Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICoEdge~IGetPartner.html)