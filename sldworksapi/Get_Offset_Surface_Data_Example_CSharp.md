...
namespace
AnalyzeOffsetSurface\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
swOffset = default(SurfaceOffsetFeatureData);
            Feature
...
            comp = (Component2)swSelMgr.**GetSelectedObjectsComponent3**(1,
-1);

            Debug.Print("File
= " + swModel.**GetPathName**());
            Debug.Print("CompFeature
= " + comp.**Name2**);
            Debug.Print("  "
+ swFeat.**Name**);
            Debug.Print("    Distance
= " + swOffset.**Distance** \* 1000.0 +
" mm");
            Debug.Print("    Flip
= " + swOffset.**Flip**);
...
            for
(i = 0; i <= vFace.GetUpperBound(0); i++)
            {
                swEnt = (Entity)vFace[i];
 Debug.Print("
Entity selected = " + swEnt.**Select4**(true,
null));

                swCompFace = (Component2)swEnt.**GetComponent**();
                Debug.Print("    Component
face = " + swCompFace.**Name2**);
