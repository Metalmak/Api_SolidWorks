...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IModelDocExtension Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension.html) : AddAngularRunningDim Method (IModelDocExtension) |
...
*Retval*
:   Error as defined by swCreateAngRunDimError\_e
...
See ModelDocExtension::AddAngularRunningDim.
