...
Private Function swPart\_SensorAlertPreNotify(ByVal
SensorIn As Object, ByVal SensorAlertType As Long) As Long

    MsgBox
"The value of the sensor deviates from its limits."
