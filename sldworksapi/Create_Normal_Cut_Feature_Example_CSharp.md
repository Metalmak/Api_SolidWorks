...
namespace CreateNormalCut\_CSharp
{
...
            swNormalCutFeatData = (SMNormalCutFeatureData2)swFeatMgr.**CreateDefinition**((int)swFeatureNameID\_e.swFmNormalCut);
            swNormalCutFeatData.**AutoPropagation** = true;
            swNormalCutFeatData.**OptimizeGeometry** = true;
            swNormalCutFeatData.**NormalCutParameters** = (int)swNormalCutParameters\_e.swNormalCutExtent;
