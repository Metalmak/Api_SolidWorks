<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IHemFeatureData.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IHemFeatureData_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : IHemFeatureData Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface IHemFeatureData ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class IHemFeatureData ``` | |
...
[HemFeatureData](SWObjectModel.pdf#HemFeatureData)
