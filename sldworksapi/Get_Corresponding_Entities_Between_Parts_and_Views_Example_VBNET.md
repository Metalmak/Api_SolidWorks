...
        swApp.**ActivateDoc3**(swModelPart.**GetTitle**, True, swRebuildOnActivation\_e.swUserDecision, lErr)
...
            Case swSelectType\_e.swSelFACES, swSelectType\_e.swSelEDGES, swSelectType\_e.swSelVERTICES
...
                    swApp.**ActivateDoc3**(swModelDrawing.**GetTitle**, False, swRebuildOnActivation\_e.swDontRebuildActiveDoc, lErr)
                    bSelected = outputEntity.**Select4**(False, Nothing)
                End If

            Case swSelectType\_e.swSelNOTHING
...
                    swApp.**ActivateDoc3**(swModelPart.**GetTitle**, False, swRebuildOnActivation\_e.swDontRebuildActiveDoc, lErr)
                    bSelected = outputEntity.**Select4**(False, Nothing)
                End If
