...
            Debug.Print "
Arc count = " & swDispData.**GetArcCount**
            polygonCount
= swDispData.**GetPolygonCount**
            Debug.Print "
...
= " & polyLineType & ", point count = " & polyNumPts & ", " & strFilled
