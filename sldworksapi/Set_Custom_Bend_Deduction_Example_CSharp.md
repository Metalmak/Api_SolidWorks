...
//
// Postconditions:
Sets the selected miter flange's custom
...
namespace
CustomBendAllowanceType\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            Feature = (Feature)selMgr.**GetSelectedObject6**(1,
-1);
...
            // Get whether to use default
bend allowance to determine the current state
            bool
useCustom = false;
...
bType = 0;
            bType = bData.**Type**;
            // Set the bend allowance type
to deduction
            bData.**Type** = (int)swBendAllowanceTypes\_e.swBendAllowanceDeduction;

            // Set the value of the bend
deduction
            bData.**BendDeduction** =
0.001;
