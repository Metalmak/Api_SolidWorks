...
Dim swRadiate
As SldWorks.SurfaceRadiateFeatureData
Dim swPlane
As SldWorks.SurfacePlanarFeatureData
Dim swFeat
As SldWorks.Feature
Dim swEnt
As SldWorks.Entity
...
    boolStatus =
Part.**Extension**.**SelectByID2**("Front Plane", "PLANE", -4.48901407839529E-02,
2.79954694016864E-02, 4.66820674117181E-03, False, 0, Nothing, 0)
    Part.**SketchManager**.**InsertSketch** True
    Part.**ClearSelection2** True
    boolStatus =
Part.**Extension**.**SetUserPreferenceToggle**(swUserPreferenceToggle\_e.swSketchAddConstToRectEntity,
swUserPreferenceOption\_e.swDetailingNoOptionSpecified, False)
    boolStatus =
Part.**Extension**.**SetUserPreferenceToggle**(swUserPreferenceToggle\_e.swSketchAddConstLineDiagonalType,
swUserPreferenceOption\_e.swDetailingNoOptionSpecified, True)
    Dim vSkLines As Variant
    vSkLines = Part.**SketchManager**.**CreateCornerRectangle**(-5.55749908365768E-02,
3.29075527136081E-02, 0, 4.78203409524033E-02, -3.17145296545045E-02, 0)
    Part.**ClearSelection2** True
    Part.**SketchManager**.**InsertSketch** True
...
    boolStatus =
Part.**Extension**.**SelectByID2**("", "EDGE", -4.47337592343047E-02,
3.28467250718631E-02, 2.58132540182032E-03, False, 2, Nothing, 0)
...
    Part.**InsertRadiateSurface** 0.0254, False,
False

    Set swSelMgr = Part.**SelectionManager**
    Set swSelData = swSelMgr.**CreateSelectData**
    boolStatus = Part.**Extension**.**SelectByID2**("Surface-Radiate1", "REFSURFACE",
...
    Debug.Print "Type of radiated entities as
defined in swSelectType\_e:"
...
    boolStatus =
Part.**Extension**.**SelectByID2**("Surface-Plane1", "REFSURFACE", 0, 0, 0, False, 0,
Nothing, 0)

    ' Roll back to get the planar surface
bounding edges
    Set swFeat = swSelMgr.**GetSelectedObject6**(1, -1)
    Set swPlane = swFeat.**GetDefinition**

    boolStatus = swPlane.**AccessSelections**(Part,
Nothing)
    vBoundEnt = swPlane.**BoundingEntities**

    Debug.Print "Types of planar surface
bounding entities as defined in swSelectType\_e:"
