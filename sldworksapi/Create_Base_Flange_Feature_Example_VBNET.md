...
swBaseFlangeFeat = swModel.FeatureManager.**CreateDefinition**(swFeatureNameID\_e.swFmBaseFlange)

cba = swBaseFlangeFeat.**GetCustomBendAllowance**()

cba.**Type** =

swBendAllowanceTypes\_e.swBendAllowanceDirect
...
swSheetMetalReliefTypes\_e.swSheetMetalReliefRectangular,
...
Debug.Print("Result
code for override of AutoRelief as defined by swSheetMetalModifierError\_e: " & smFeatData.**SetOverrideDefaultParameter2**(swSheetMetalOverrideDefaultParameters\_e.swSheetMetalOverrideDefaultParameters\_AutoRelief,
