...
//---------------------------------------------------------------------------
// Preconditions:
// 1. Open *public\_documents***\samples\tutorial\api\clamp2.sldprt**.
...
            retVal = modelDocExt.**ReorderFeature**("Fillet5",
"", (int)swMoveLocation\_e.swMoveToEnd);
            Debug.Print("Fillet5
moved to the end of the FeatureManager design tree? "
+ retVal);
