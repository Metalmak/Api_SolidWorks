...
namespace
ReferenceAxisFeatDataType\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
            RefAxis
swRefAxis = default(RefAxis);
            RefAxisFeatureData
swRefAxisData = default(RefAxisFeatureData);
            double[]
swMathAxis = null;
...
+ swFeat.**Name**);
            Debug.Print("    Start
point = (" + swMathAxis[0] \* 1000.0 +
", " +
swMathAxis[1] \* 1000.0 + ", "
+ swMathAxis[2] \* 1000.0 + ") mm");
            Debug.Print("    End
point = (" + swMathAxis[3] \* 1000.0 +
", " +
swMathAxis[4] \* 1000.0 + ", "
+ swMathAxis[5] \* 1000.0 + ") mm");
