...
namespace
SplitClosedSegment\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
swApp.**SetUserPreferenceToggle**(int
swUserPreferenceToggle\_e.swSketchInference,
false);
...
            skSegmentArray =
(object[])swModel.**SketchManager**.**SplitClosedSegment**(-0.0243607314462504,
0.0404155099449417, 0.0, -0.023219392599761, 0.0295727909032925, 0.0);

            // Close the sketch and rebuild
            swModel.**SketchManager**.**Insert3DSketch**(true);

Debug.Print("Number of
segments in sketch = " + skSegmentArray.Length);
