...
namespace
MirrorComponent\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
swMirrorComponentOrientation2\_e[2];
...
swMirroCompFeatData = (MirrorComponentFeatureData)FeatMgr.**CreateDefinition**((int)swFeatureNameID\_e.swFmMirrorComponent);
...
myRefPlane = (RefPlane)swModel.FeatureManager.InsertRefPlane(8,
0.01, 0, 0, 0, 0);
...
swCompInst = swAssem.GetComponentByName("gear-
caddy-1");
...
swCompInst = swAssem.GetComponentByName("shaft
gear-1");
...
swCompInst = swAssem.GetComponentByName("middle-gear
plate-1");
...
swCompInst = swAssem.GetComponentByName("base
plate-1");
...
importOptions = (int)swMirrorPartOptions\_e.swMirrorPartOptions\_ImportSolids;

swMirroCompFeatData.**MirrorPlane** = mirrorPlane;

swMirroCompFeatData.**MirrorType** = (int)swMirrorComponentMirrorType\_e.swMirrorType\_ComponentOrigin;
...
      swMirroCompFeatData.**FlipDirections**
= flipDirVar;
...
swMirroCompFeatData.**NameModifierType** = (int)swMirrorComponentNameModifier\_e.swMirrorComponentName\_Custom;
...
modifyFeatdef.**MirrorType** = (int)swMirrorComponentMirrorType\_e.swMirrorType\_CenterOfMass;
