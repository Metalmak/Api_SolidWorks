...
| DPartDocEvents\_OpenDesignTableNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_OpenDesignTableNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See OpenDesignTableNotify Event (PartDoc).
