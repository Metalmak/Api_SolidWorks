...
| DPartDocEvents\_ChangeCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DPartDocEvents\_ChangeCustomPropertyNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See ChangeCustomPropertyNotify Event (PartDoc).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swPartChangeCustomPropertyNotify to register for this event.
