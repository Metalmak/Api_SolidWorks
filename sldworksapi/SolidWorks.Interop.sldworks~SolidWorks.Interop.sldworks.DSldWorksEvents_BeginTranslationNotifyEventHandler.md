...
| DSldWorksEvents\_BeginTranslationNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : DSldWorksEvents\_BeginTranslationNotifyEventHandler Delegate (SolidWorks.Interop.sldworks) |
...
See BeginTranslationNotify Event (SldWorks).

# ![](dotnetimages/collapse.gif)Remarks

If developing a C++ application, use swAppBeginTranslationNotify to register for this notification.
