...
        Debug.Print
Format(String(Indent, " ") & thisFeat.**Name**, "!" & String(40, "@"));
Format(FeatType, "!" & String(30, "@"));
...
        If Not
IsEmpty(vBodies) Then
            For i =
LBound(vBodies) To UBound(vBodies)
...
        Dim
FeatureFromBodyFolder As SldWorks.Feature
        Set FeatureFromBodyFolder =
BodyFolder.**GetFeature**

        If Not
FeatureFromBodyFolder Is thisFeat Then
            MsgBox
...
we are doing this feature traversal for
