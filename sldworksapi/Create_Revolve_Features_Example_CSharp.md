...
System;
namespace
FeatureRevolves\_CSharp.csproj
{
    partial
class
SolidWorksMacro
...
0, 0, true,
0, null,
(int)swSelectOption\_e.swSelectOptionDefault);
...
            swModel.**SketchRectangle**(-0.05668466821757,
-0.02198379306525, 0, -0.01330857427717, 0.03972855876814, 0,
true);
...
            // Create a cut-revolve
feature using a face on the revolve feature
...
0, -0.01883036471929, -0.01265654504095, 0,
true);
            swModel.**InsertSketch2**(true);
...
            // Create the second
revolve feature using a face on the first revolve feature
            swSelMgr.**EnableContourSelection**
= false;
            boolstatus = swModelDocExt.**SelectByID2**("",
"FACE",
...
            swModel.**InsertSketch2**(true);
            swModel.**ClearSelection2**(true);
            swModel.**CreateCircle2**(-0.02232361399104, 0.03354683337932,
0, -0.01445073476016, 0.02795861773112, 0);
            swModel.**InsertSketch2**(true);
