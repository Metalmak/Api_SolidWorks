...
Array of path segment types as defined by swSelectType\_e:

* swSelSKETCHES* swSelEDGES* swSelREFCURVES

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See PrimaryMemberPathSegmentFeatureData::GetPathSegmentsTypes.
