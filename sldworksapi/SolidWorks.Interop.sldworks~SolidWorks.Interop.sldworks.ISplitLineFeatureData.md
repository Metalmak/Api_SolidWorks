<!-- source: sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISplitLineFeatureData.html -->
...
| [See Also](#seealsobookmark)  [Members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISplitLineFeatureData_members.html)   [Example](#ExampleBookmark) | |
...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) : ISplitLineFeatureData Interface |
...
| Visual Basic (Declaration) |  |
| --- | --- |
| ``` Public Interface ISplitLineFeatureData ``` | |
...
| C++/CLI |  |
| --- | --- |
| ``` public interface class ISplitLineFeatureData ``` | |

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See SplitLineFeatureData.
...
[SplitLineFeatureData](SWObjectModel.pdf#SplitLineFeatureData)
