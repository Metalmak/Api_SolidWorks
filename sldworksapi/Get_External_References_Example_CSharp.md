...
assembly document
                case
(int)swSelectType\_e.swSelCOMPONENTS:
...
                case
(int)swSelectType\_e.swSelSKETCHES:
...
                    swModDocExt.**ListExternalFileReferences2**(out
vModelPathName, out
vComponentPathName, out
vFeature, out
vDataType, out
...
- 1];
                int[]
ConfigOpt = new int[nRefCount
- 1];
                object[]
ConfigName = new object[nRefCount
- 1];
