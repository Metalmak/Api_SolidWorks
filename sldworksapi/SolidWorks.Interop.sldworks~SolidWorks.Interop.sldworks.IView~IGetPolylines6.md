...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IView Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView.html) : IGetPolylines6 Method (IView) |
...
*CrossHatchOption*
:   - 0 = include crosshatch lines- 1 = exclude crosshatch lines- 2 = include only crosshatch lines
...
Obsolete. Superseded by [IView::IGetPolylines7](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IView~IGetPolylines7.html).
...
Array of modeling [edges](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IEdge.html) corresponding to the polylines in the view

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See View::IGetPolylines6.
...
| --- | --- |
| **To get...** | **Call...** |
| Size of array needed to hold this data | [IView::GetPolylineCount5](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IView~GetPolyLineCount5.html) |
