...
HRESULT hres = UserApp->getSWApp()->get\_IActiveDoc( &pModelDoc );
...
hres = pSubFeat->get\_Name( &bSubFeatName );
...
// m\_Sketch object to call the methods and
