...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [INote Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote.html) : GetTextJustificationAtIndex Method (INote) |
...
Text justification as defined in swTextJustification\_e

# ![](dotnetimages/collapse.gif)Visual Basic for Applications (VBA) Syntax

See Note::GetTextJustificationAtIndex.

# ![](dotnetimages/collapse.gif)Remarks

Before using this method, use [INote::GetCompoundTextCount](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.INote~GetCompoundTextCount.html) to get the number of text items.
