...
|  |
| --- |
| [SolidWorks.Interop.sldworks Namespace](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks_namespace.html) > [IDrawingDoc Interface](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IDrawingDoc.html) : InsertModelDimensions Method (IDrawingDoc) |
...
*Option*
:   * 0 - All dimensions in the view* 1 - All dimensions of the currently selected component (for assembly drawings)* 2 - All dimensions of the currently selected feature* 3 - All dimensions of the assembly
...
See DrawingDoc::InsertModelDimensions.
