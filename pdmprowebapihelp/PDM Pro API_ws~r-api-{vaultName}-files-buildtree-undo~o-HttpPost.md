...
|  |
| --- |
| [PDM Pro API Web Service](PDM%20Pro%20API_ws.html) > [File Resource Group](PDM%20Pro%20API_ws~g-20f0f203-5b33-4c77-baf6-4cccf91271c2.html) : api/{vaultName}/files/buildtree/undo (Post) |
...
* take an array of CheckOutItem objects. Each CheckOutItem consists of FileId and Folder Id.* return an array of FileRefOfFileInfoConfigLess objects that represent the tree of references to include in the file's undo checkout.
