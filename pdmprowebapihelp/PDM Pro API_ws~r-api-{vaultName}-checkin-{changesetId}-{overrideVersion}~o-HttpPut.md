...
|  |
| --- |
| [PDM Pro API Web Service](PDM%20Pro%20API_ws.html) > [Stage Resource Group](PDM%20Pro%20API_ws~g-31fb4871-fcc6-41c5-8856-b0faf87b89f3.html) : api/{vaultName}/checkin/{changesetId}/{overrideVersion} (Put) |
...
| Content | (Response) GUID of the check-in operation; use the GUID to query for the status of the operation (see [api/{vaultName}/progress/{guid}/status](PDM%20Pro%20API_ws~r-api-%7BvaultName%7D-progress-%7Bguid%7D-status~o-HttpGet.html))    Member of HttpResponseMessage model | HttpContent |
