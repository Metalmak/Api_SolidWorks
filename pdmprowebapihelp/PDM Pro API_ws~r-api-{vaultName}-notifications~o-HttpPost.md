...
|  |
| --- |
| [PDM Pro API Web Service](PDM%20Pro%20API_ws.html) > [Notification Resource Group](PDM%20Pro%20API_ws~g-1b401eaa-fc58-447a-9293-d44f7cf22272.html) : api/{vaultName}/notifications (Post) |
...
* takes MsgInfo body parameters.* returns a boolean status.
