...
|  |
| --- |
| [PDM Pro API Web Service](PDM%20Pro%20API_ws.html) > [File Resource Group](PDM%20Pro%20API_ws~g-20f0f203-5b33-4c77-baf6-4cccf91271c2.html) : api/{vaultName}/files/{fileId}/bominfo?folderId={folderId} (Get) |
...
| --- | --- | --- |
| vaultName | (URI parameter) | string |
| fileId | (URI parameter) | integer |
